...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/api/types/index.mdx"
---
...
| `Error` | Non-nil when the statement failed. See [`QueryError`](../errors/index.md#queryerror). |
...
|---|---|---|
| `ID` | [`*models.RecordID`](../values/record-id.md) | The relation record ID. Auto-generated by [`Relate`](../core/db.md#relate), optional for [`InsertRelation`](../core/db.md#insertrelation). |
| `In` | [`models.RecordID`](../values/record-id.md) | The source record. |
| `Out` | [`models.RecordID`](../values/record-id.md) | The target record. |
| `Relation` | [`models.Table`](../values/table.md) | The relation table name. |
...
| Field | Type | Description |
|---|---|---|
| `ID` | [`*models.UUID`](../values/uuid.md) | The live query UUID |
...
See [`Table`](../values/table.md) and [`RecordID`](../values/record-id.md) for these value types.

### `sendable` {#sendable}

A type constraint for types that can execute RPC requests. Satisfied by [`*DB`](../core/db.md), [`*Session`](../core/session.md), and [`*Transaction`](../core/transaction.md).
...
A type constraint for types that support [live queries](../../concepts/live-queries.md). Satisfied by [`*DB`](../core/db.md) and [`*Session`](../core/session.md) (not [`*Transaction`](../core/transaction.md)).
...
- [DB reference](../core/db.md) for methods that use these types
- [Errors reference](../errors/index.md) for error types
- [Values reference](../values/record-id.md) for value types like `RecordID` and `Table`
