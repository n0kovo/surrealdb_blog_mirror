...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/libraries/surqlize/code-generation-and-cli.mdx"
---
...
Applies the [schema](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/schema) definitions for the configured models through the configured executor.
...
- [Querying](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/querying) for the typed callbacks adapters support
- [Schema](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/schema) for the definitions `schema:apply` runs
