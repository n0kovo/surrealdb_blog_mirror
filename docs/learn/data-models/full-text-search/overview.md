...
- **Powerful query language**: SurrealQL blends SQL-like syntax with searching syntax (the [`@@` matching operator](../../../reference/query-language/language-primitives/operators.md#matches) for FTS queries, advanced indexing features, and so on).
