...
<table>
  ...
  <tbody>
    <tr>
      <td scope="row" data-label="Function"><a href="#not">`not()`</a></td>
...
The `not` function reverses the truthiness of a value. It is functionally identical to `!`, the [NOT](../../language-primitives/operators.md#not) operator.
