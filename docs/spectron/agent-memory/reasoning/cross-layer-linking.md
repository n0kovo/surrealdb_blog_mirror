...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/reasoning/cross-layer-linking.mdx"
---
...
Two **streams** in one store are described in [Unified substrate and authority](https://surrealdb.com/docs/spectron/mental-model/two-layer-architecture).
