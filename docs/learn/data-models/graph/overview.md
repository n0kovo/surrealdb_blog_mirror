...
- [Knowledge graph patterns](knowledge-graph-patterns.md): orienting nodes and edges for knowledge-style and industry schemas.

For statement-level reference and deeper query details, see:

* The [`RELATE` statement](../../../reference/query-language/statements/relate.md#querying-graphs)
* [Idioms](../../../reference/query-language/language-primitives/idioms.md) (including recursive paths)
