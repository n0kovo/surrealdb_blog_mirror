...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/update-promise.mdx"
---
...
**Returned by:** [`SurrealQueryable.update()`](../core/surreal-queryable.md#update)
