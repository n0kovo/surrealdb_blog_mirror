...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/self-hosted/file-backed.mdx"
---
...
A number of parameters can be used on startup such as `sync` to set when to flush the database to the file system. For more details on these parameters, see [this page](../reference/cli/surrealdb-cli/commands/start.md#supported-parameters-for-rocksdb) for the `start` command or [this page](../reference/cli/surrealdb-cli/environment-variables.md#rocksdb-environment-variables) to set the same parameters using environment variables.
