...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/mojo/installation.mdx"
---
...
- [Getting started](../../languages/mojo.md) for a complete working example.
- [Connecting to SurrealDB](concepts/connecting-to-surrealdb.md) for connection options and transports.
