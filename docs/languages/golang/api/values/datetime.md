...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/api/values/datetime.mdx"
---
...
- [Duration](duration.md) for the duration type
- [Value types](../../concepts/value-types.md) for the full type mapping
- [Data manipulation](../../concepts/data-manipulation.md) for using datetime values in CRUD operations
- [SurrealQL datetime type](../../../../reference/query-language/language-primitives/data-types/datetimes.md) for the underlying data model
