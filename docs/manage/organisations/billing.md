...
The **Billing** page also holds subscriptions for other SurrealDB products in the organisation, such as [Spectron](https://surrealdb.com/docs/spectron) context packages. Each subscription has its own plan card, with actions to change it or to cancel it. All subscriptions use the payment method of the organisation, and appear on the same invoice.
