...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/statements/define/access/bearer.mdx"
---
...
- You must be authenticated as a [root, namespace or database user](../user.md) before you can define a bearer access method.
...
Here are some examples on how to do that using the [JavaScript SDK](../../../../javascript/index.md) or a raw [HTTP request](../../../../rest-api/http-protocol.md).
