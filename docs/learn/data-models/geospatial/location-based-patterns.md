...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/data-models/geospatial/location-based-patterns.mdx"
---

# Location-based patterns

Once you can store [geometry types](geometry-types.md) and run [spatial queries](spatial-queries.md) with [distance](distance-and-proximity.md) in mind, most product features follow a small set of patterns.
...
For a single zone record, store the boundary as a [polygon geometry](../../../reference/query-language/language-primitives/data-types/geometries.md) and test whether a customer’s location falls inside it using [`CONTAINS`](../../../reference/query-language/language-primitives/operators.md#contains) (polygon on the left, point on the right):
...
- [Geospatial data types](../../../reference/query-language/language-primitives/data-types/geometries.md)
- [Geo functions](../../../reference/query-language/functions/database-functions/geo.md)
