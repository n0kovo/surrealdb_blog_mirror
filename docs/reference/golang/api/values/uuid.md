...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/golang/api/values/uuid.mdx"
---
...
- [SurrealQL UUID type](../../../query-language/language-primitives/data-types/uuids.md) for the underlying data model
