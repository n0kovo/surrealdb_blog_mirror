...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/python/concepts/value-types.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/reference/python/api/values/record-id">`RecordID(table_name, identifier)`</a></td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/reference/python/api/values/table">`Table(table_name)`</a></td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/reference/python/api/values/duration">`Duration(elapsed)`</a></td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/reference/python/api/values/datetime">`Datetime(dt)`</a></td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/reference/python/api/values/range">`Range(begin, end)`</a></td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/reference/python/api/values/geometry">`GeometryPoint(...)`</a></td>
		</tr>
	</tbody>
</table>
