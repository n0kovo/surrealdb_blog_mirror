...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/mcp-server/coding-assistants/opencode.mdx"
---
...
For integration rules your agent should follow (auth, scope, endpoints, common mistakes), see **[Agent guide (AGENTS.md)](../../../reference/agents.md)**. OpenCode reads a project `AGENTS.md` automatically.
