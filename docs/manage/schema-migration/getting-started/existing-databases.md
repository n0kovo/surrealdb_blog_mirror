...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/schema-migration/getting-started/existing-databases.mdx"
---
...
See the [Rollouts](../rollouts.md) page for the full reference.
...
- [Rollouts](../rollouts.md): full reference for the phased migration workflow
- [Sync vs Rollouts](sync-vs-rollouts.md): a side-by-side comparison
