...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/swift/concepts/connecting.mdx"
---

# Connecting to SurrealDB

The Swift SDK provides two transports: an HTTP client and a WebSocket client. Both share the same querying and CRUD API; the WebSocket client additionally supports [live queries](live-queries.md).
...
`SurrealWebSocketClient` connects over WebSocket and is required for [live queries](live-queries.md). It can also automatically reconnect when a connection is dropped.
