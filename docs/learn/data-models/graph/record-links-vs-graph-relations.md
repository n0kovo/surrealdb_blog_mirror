...
Since version `3.0.0`, a record link can be bidirectional by defining a field with the [`REFERENCE`](../../../reference/query-language/language-primitives/record-references.md) clause and using a computed back-reference:
...
* You want the schema to declare what happens when a linked record is deleted (cascade, refuse, ignore, etc.) via [`ON DELETE`](../../../reference/query-language/language-primitives/record-references.md) and related options.
...
Record links can encode rich behaviour on delete (for example, removing an id from an array while appending to a history field), via [`REFERENCE` `ON DELETE`](../../../reference/query-language/language-primitives/record-references.md).
...
For more on `ON DELETE` and references, see [Record references](../../../reference/query-language/language-primitives/record-references.md).
