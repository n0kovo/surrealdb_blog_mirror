...
| **Integration** | Available — copy-ready snippets (use `@surrealdb/spectron` / `surrealdb`; see [Integrations](../../integrations/index.md)) |
...
For **remember**, **recall**, **chat**, and **document upload**, use **API keys** with the [Hosted quickstart](https://surrealdb.com/docs/spectron/quickstarts/hosted) or an official SDK.
...
Keys are **principal-bound** on the Spectron side (created through Cloud, which calls Spectron management on your behalf). Use **`Authorization: Bearer sk-ctx-…`** on the data plane — see [REST API](../../reference/rest-api.md).
...
> [!NOTE]
> Surrealist quick-start snippets may reference placeholder packages (`@surrealdb/memory`, `surrealdb-context`, `/memories` paths). Use **`surrealdb`** (Python) and **`@surrealdb/spectron`** (TypeScript) as documented in [Integrations](../../integrations/index.md).
...
Use API keys and the [Hosted quickstart](https://surrealdb.com/docs/spectron/quickstarts/hosted) for memory and knowledge operations.

## Next steps

- **[Hosted quickstart](https://surrealdb.com/docs/spectron/quickstarts/hosted)** — first **remember** / **recall** with your context host and API key
...
- **[Eight pillars and six categories](https://surrealdb.com/docs/spectron/architecture/eight-pillars-and-categories)** — how experiential and authoritative memory relate
