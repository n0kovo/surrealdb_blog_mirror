...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/surrealist/faqs/faq-details.mdx"
---
...
There may be more complex reasons such as network issues, firewalls, or the remote database not being available. You can always try connecting via the [CLI](../../../reference/cli/surrealdb-cli/overview.md) to see if the issue is with Surrealist or the remote database.
