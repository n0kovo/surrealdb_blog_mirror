...
See [LangChain](../frameworks/langchain.md). The adapter posts to `/facts/batch` with platform-derived idempotency keys.
...
See [CLI reference](../../reference/cli.md) and [REST API](../../reference/rest-api.md).
