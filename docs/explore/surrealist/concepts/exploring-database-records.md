...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/surrealist/concepts/exploring-database-records.mdx"
---
...
![Surrealist explorer view](../../../assets/img/image/surrealist/explorer.png)
...
> [!NOTE]
> In the [Designer view](designing-the-database-schema.md) section we will explain more in-depth about what constitutes tables as normal or edge tables.
...
Pressing the ▼ button in the top right of this panel expands an input in which you can enter a [WHERE](../../../reference/query-language/statements/select.md#filter-queries-using-the-where-clause) clause to filter down the displayed records on certain conditions.
...
![Surrealist import view](../../../assets/img/image/surrealist/import.png)
