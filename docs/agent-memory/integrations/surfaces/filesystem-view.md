...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/surfaces/filesystem-view.mdx"
---
...
- [MCP server: install](../mcp-server/install.md) – connecting an MCP client to SurrealDB Agent Memory
- [MCP tools reference](../../reference/mcp-tools.md) – the full set of MCP tools and resources
- [Uploading documents](https://surrealdb.com/docs/agent-memory/ingest/authoritative/uploading-documents) – ingesting documents that appear in the filesystem view
