---
position: 2
title: Build a knowledge graph for AI
...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/tutorials/tutorials/how-to-build-a-knowledge-graph-for-ai.mdx"
---
...
![Agentic RAG](../../../assets/img/tutorials/agentic-rag-light.png)
...
![Types of knowledge graphs](../../../assets/img/tutorials/knowledge-graph-types-light.png)
...
![Vector clusters with graph relations](../../../assets/img/tutorials/vector-clusters-graph-relations-light.png)
...
The following example uses a `flow` decorator to register functions for different steps in the ETL process. An orchestrator takes care of calling this function for `document`s that lack a “stamp” in their `chunked` field:
