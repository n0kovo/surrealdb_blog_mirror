...
A parallel **trace layer** records SurrealDB Agent Memory’s own retrievals, decisions, and responses – memory **about** how memory was used. Traces feed the ranker, calibrator, and consolidator. See [Traces and memory evolution](https://surrealdb.com/docs/agent-memory/architecture/traces-and-evolution).

A practitioner-oriented tour of the six extracted categories is in [Memory categories](https://surrealdb.com/docs/agent-memory/mental-model/memory-categories).
