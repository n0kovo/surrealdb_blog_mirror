...
SurrealDB is open source (see the code [here on GitHub](https://github.com/surrealdb/surrealdb)) and is also available as a cloud managed service through [SurrealDB Cloud](manage/cloud/index.md).
