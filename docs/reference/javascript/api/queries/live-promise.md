...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/live-promise.mdx"
---
...
**Returned by:** [`SurrealQueryable.live()`](../core/surreal-queryable.md#live), [`SurrealQueryable.liveOf()`](../core/surreal-queryable.md#liveof)
...
<table>
    ...
    <tbody>
        <tr>
            <td>`field` <label label="required" /></td>
            <td>`Field&lt;T&gt;`</td>
...
**Returned by:** [`SurrealQueryable.liveOf()`](../core/surreal-queryable.md#liveof)
...
- [Live queries guide](../../../query-language/statements/live-select.md) - SurrealQL LIVE documentation
