...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/v1/methods/patch.mdx"
---
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                The table name or the specific [`RecordId`](../concepts/data-types.md#recordid) to patch.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Arguments">
