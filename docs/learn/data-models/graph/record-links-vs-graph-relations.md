...
* You want the schema to declare what happens when a linked row is deleted (cascade, refuse, ignore, etc.) via [`ON DELETE`](../../../reference/query-language/language-primitives/record-references.md) and related options.
