...
Then we can [define a module](../../../reference/query-language/statements/define/module.md) which will hold all the tests. We'll call it `mod::test` and use `AS` to connect it to the file.
