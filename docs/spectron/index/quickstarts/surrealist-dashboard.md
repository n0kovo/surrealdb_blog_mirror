...
The page includes copy-ready snippets (cURL, JavaScript, Python, Rust, and others). Some snippets label the header `Token`; the HTTP API itself expects `API-KEY` as documented in the [REST API](../../reference/rest-api.md).
