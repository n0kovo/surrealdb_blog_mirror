...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/cookbooks/migrate/from-langmem.mdx"
---
...
**Namespace vs scope**: LangMem uses a tuple namespace `("user", "alice")`. Spectron uses hierarchical slash paths like `["user/alice"]`. For single-clause scopes, org-wide queries surface org-tagged memory while hiding user-specific records — see [Contexts and scope](https://surrealdb.com/docs/spectron/mental-model/contexts-and-scope).
