...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/select-promise.mdx"
---
...
**Returned by:** [`SurrealQueryable.select()`](../core/surreal-queryable.md#select)
