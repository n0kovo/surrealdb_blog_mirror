...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/dotnet/core/data-manipulation.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                The table name or the specific [`RecordId`](../data-types.md#recordid) to merge.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="col" scope="row" data-label="Arguments">
