...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/querying/performance/performance-best-practices.mdx"
---
...
Read more about [SurrealDB architecture](../../data-models/architecture.md) and [deployment models](../../../manage/self-hosted/deployment-models.md).
...
Read more about running SurrealDB as a [single-node server](../../../running/file-backed.md) or [multi-node cluster](../../../running/multi-node.md).
...
Read more about [running SurrealDB embedded in Rust.](../../../build/embedding/by-language/rust.md)
