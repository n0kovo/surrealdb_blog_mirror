...
Example of `.is_empty()` being used in a [`DEFINE FIELD`](../../statements/define/field.md#asserting-rules-on-fields) statement to disallow empty objects:
