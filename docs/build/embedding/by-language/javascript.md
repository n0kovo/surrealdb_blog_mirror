...
SurrealDB is designed to be run in many different ways and in many environments. Due to the [separation of the storage and compute](../../../learn/data-models/architecture.md) layers, SurrealDB can be run in embedded mode, from within your JavaScript environments. 
