...
> [!NOTE]
> The pasted output above predates SurrealDB 3.1.0 and so does not list [`surreal mcp`](mcp.md). For the current list of subcommands, see [CLI commands](index.md).
