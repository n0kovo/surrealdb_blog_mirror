...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/integrations/data-management/fivetran.mdx"
---
...
2. Set up the token and use it following [SurrealDB's Authentication documentation](../../../learn/security/authentication/authentication.md#token).
...
7. (Optional) If you prefer using `token`, we recommend `DEFINE ACCESS ... TYPE JWT`. Refer to the [`DEFINE ACCESS > JWT` documentation](../../../reference/query-language/statements/define/access/jwt.md) to set up JWT access.
