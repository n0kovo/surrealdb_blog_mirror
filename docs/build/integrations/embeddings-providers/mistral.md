...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/integrations/embeddings-providers/mistral.mdx"
---
...
Create a table called `document` to store documents and embeddings. The `HNSW` index is one way to [maintain performance](../../../reference/query-language/language-primitives/operators.md#hnsw-method) if the dataset becomes quite large; otherwise, it can be left out.
