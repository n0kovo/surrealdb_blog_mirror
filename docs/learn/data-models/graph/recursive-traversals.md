...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/data-models/graph/recursive-traversals.mdx"
---

# Recursive traversals

[Recursive queries](../../../reference/query-language/language-primitives/idioms.md#recursive-paths) let you follow a path to a specific depth without spelling out every hop.
