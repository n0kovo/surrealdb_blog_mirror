...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/self-hosted/backups-and-recovery.mdx"
---
...
To **restore**, use [`surreal import`](../../reference/cli/surrealdb-cli/commands/import.md) against a running instance, pointing at the correct endpoint, credentials, and target namespace or database.
