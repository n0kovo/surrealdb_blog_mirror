...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/concepts/value-types.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Type"><a href="/docs/languages/golang/api/values/record-id">`models.RecordID`</a></td>
			<td scope="row" data-label="Description">A unique record identifier with table name and ID</td>
		</tr>
		<tr>
			<td scope="row" data-label="Type"><a href="/docs/languages/golang/api/values/table">`models.Table`</a></td>
			<td scope="row" data-label="Description">A table name</td>
		</tr>
		<tr>
			<td scope="row" data-label="Type"><a href="/docs/languages/golang/api/values/uuid">`models.UUID`</a></td>
			<td scope="row" data-label="Description">A UUID v4 or v7 value</td>
		</tr>
		<tr>
			<td scope="row" data-label="Type"><a href="/docs/languages/golang/api/values/datetime">`models.CustomDateTime`</a></td>
			<td scope="row" data-label="Description">A datetime value wrapping time.Time</td>
		</tr>
		<tr>
			<td scope="row" data-label="Type"><a href="/docs/languages/golang/api/values/duration">`models.CustomDuration`</a></td>
			<td scope="row" data-label="Description">A duration value wrapping time.Duration</td>
		</tr>
		<tr>
			<td scope="row" data-label="Type"><a href="/docs/languages/golang/api/values/geometry">`models.GeometryPoint`</a></td>
			<td scope="row" data-label="Description">A geographic point with longitude and latitude</td>
		</tr>
		<tr>
			<td scope="row" data-label="Type"><a href="/docs/languages/golang/api/values/range">`models.Range`</a></td>
...
Use [`models.NewRecordID`](../api/values/record-id.md) to construct a `RecordID`, or receive them from query results. The ID can be any CBOR-serializable value (string, integer, array, etc.).
...
[`CustomDateTime`](../api/values/datetime.md) wraps Go's `time.Time` and handles CBOR encoding with nanosecond precision.
...
[`CustomDuration`](../api/values/duration.md) wraps Go's `time.Duration` with SurrealDB-compatible formatting (e.g., `1d2h30m`).
...
The SDK provides types for all SurrealDB geometry values. [`GeometryPoint`](../api/values/geometry.md) is the most common:
...
- [RecordID reference](../api/values/record-id.md) for detailed constructors and methods
- [UUID reference](../api/values/uuid.md) for UUID types
