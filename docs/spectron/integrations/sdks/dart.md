...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/sdks/dart.mdx"
---
...
The client covers the rest of the Spectron end-user surface (documents, sessions, entities, and governance) over the same REST API. See the [REST API](../surfaces/rest.md) for the full contract.
