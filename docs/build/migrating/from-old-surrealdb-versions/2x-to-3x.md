...
Once all issues have been resolved, the migration diagnostics tool will allow you to export a [V3 Compatible Export](https://surrealdb.com/docs/self-hosted/installation/upgrading/migrating-data-to-3x#using-the-v3-compatible-export) that can be imported into your updated SurrealDB `3.x` instance.
...
>[!NOTE]
> See the [complete function mapping table](https://surrealdb.com/docs/self-hosted/installation/upgrading/migrating-data-to-3x#2-function-name-changes) below for the full list of function name updates.
