...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/self-hosted/installation/windows.mdx"
---

# Install on Windows

Both the SurrealDB database server and the [command-line tool](../../reference/cli/surrealdb-cli/overview.md) are packaged as a single executable file. You can install via the [install script](#installing-surrealdb-using-the-install-script), [Chocolatey](https://chocolatey.org/), or [Scoop](https://scoop.sh/).
...
To ensure that you are using the latest stable version (*(latest)*), update SurrealDB using the following command.
