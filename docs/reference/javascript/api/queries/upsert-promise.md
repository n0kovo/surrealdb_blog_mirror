...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/upsert-promise.mdx"
---
...
> [!WARNING]
> UPSERT replaces the entire record if it exists. Use [`update().merge()`](update-promise.md#merge) for partial updates.

**Returned by:** [`SurrealQueryable.upsert()`](../core/surreal-queryable.md#upsert)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`Output`</td>
            <td>`"NONE"`, `"BEFORE"`, `"AFTER"`, `"DIFF"`, or field list.</td>
        </tr>
    </tbody>
</table>
