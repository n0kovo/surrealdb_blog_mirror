...
This matters more than it looks: the type is half an entity's identity, so an invented type silently produces a second entity. See [Entity matching](https://surrealdb.com/docs/agent-memory/reasoning/reconciliation-and-supersession#entity-matching).
...
- [Reconciliation and supersession](https://surrealdb.com/docs/agent-memory/reasoning/reconciliation-and-supersession) — exact-key entity matching, and why nicknames fragment
- [Storing memories](https://surrealdb.com/docs/agent-memory/ingest/experiential/remember) — `infer` modes, including caller-supplied triples
- [Extraction pipeline](https://surrealdb.com/docs/agent-memory/reasoning/extraction-pipeline) — where extraction sits in ingest
