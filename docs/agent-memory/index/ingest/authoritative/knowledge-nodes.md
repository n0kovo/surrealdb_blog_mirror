...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/index/ingest/authoritative/knowledge-nodes.mdx"
---
...
See [Cross-layer linking](https://surrealdb.com/docs/agent-memory/reasoning/cross-layer-linking).
