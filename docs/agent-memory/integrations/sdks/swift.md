...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/sdks/swift.mdx"
---
...
See the [Swift SDK reference](../../reference/sdk-swift.md) and [REST API](../../reference/rest-api.md) for the full contract.
