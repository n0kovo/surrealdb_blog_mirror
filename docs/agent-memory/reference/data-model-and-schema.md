...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/reference/data-model-and-schema.mdx"
---
...
Schema is bundled into the SurrealDB Agent Memory binary and applied automatically when a Context is created or upgraded. See [Migration status](management-api.md#migration-status) for the fleet-wide catch-up view.
