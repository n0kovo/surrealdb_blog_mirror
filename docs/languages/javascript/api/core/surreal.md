...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/api/core/surreal.mdx"
---

# `Surreal` {#surreal}

The `Surreal` class is the primary interface for connecting to a SurrealDB instance, managing connections, executing queries, and handling database sessions. It extends [`SurrealSession`](surreal-session.md) and inherits all session management and query execution capabilities.
...
**Extends:** [`SurrealSession`](surreal-session.md) → [`SurrealQueryable`](surreal-queryable.md)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`<a href="/docs/languages/javascript/api/types/#driveroptions">DriverOptions</a>`</td>
...
**Type:** [`ConnectionStatus`](../types/index.md#connectionstatus)
...
<table>
    ...
    <tbody>
        <tr>
            <td>`url` <label label="required" /></td>
            <td>`string | URL`</td>
            <td>The endpoint URL to connect to (e.g., `"ws://localhost:8000"`, `"http://localhost:8000/rpc"`).</td>
        </tr>
        <tr>
            <td>`opts` <label label="optional" /></td>
            <td>`<a href="/docs/languages/javascript/api/types/#connectoptions">ConnectOptions</a>`</td>
...
#### Returns
[`Promise<VersionInfo>`](../types/index.md#versioninfo) - An object containing version information
...
<table>
    ...
    <tbody>
        <tr>
            <td>`feature` <label label="required" /></td>
            <td>`Feature`</td>
            <td>A feature from the `Features` object (e.g. `Features.LiveQueries`, `Features.Api`).</td>
        </tr>
    </tbody>
</table>
...
#### Returns
`Promise<SurrealSession>` - A new [`SurrealSession`](surreal-session.md) instance
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`keyof <a href="/docs/languages/javascript/api/types/#surrealevents">SurrealEvents</a>`</td>
