...
![Diagram of a multi-node deployment: SurrealDB compute nodes each connect to a shared storage cluster such as TiKV or FoundationDB.](../assets/img/image/light/storage-cluster.png)
