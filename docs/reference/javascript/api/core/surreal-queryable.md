...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/core/surreal-queryable.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`string | <a href="/docs/reference/javascript/api/utilities/bound-query">BoundQuery</a>`</td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`<a href="/docs/reference/javascript/api/types/#anyrecordid">AnyRecordId</a>`</td>
            <td>A specific record ID to select.</td>
        </tr>
        <tr>
            <td>`range` <label label="required" /></td>
            <td>`<a href="/docs/reference/javascript/api/values/record-id">RecordIdRange</a>`</td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`<a href="/docs/reference/javascript/api/types/#anyrecordid">AnyRecordId</a> | AnyRecordId[]`</td>
            <td>The source record(s) for the relationship.</td>
        </tr>
        <tr>
            <td>`edge` <label label="required" /></td>
            <td>`Table | <a href="/docs/reference/javascript/api/types/#anyrecordid">AnyRecordId</a>`</td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`<a href="/docs/reference/javascript/api/types/#liveresource">LiveResource</a>`</td>
