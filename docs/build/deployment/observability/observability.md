...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/deployment/observability/observability.mdx"
---
...
SurrealDB contains a large number of flags for the [surreal start](../../../reference/cli/surrealdb-cli/commands/start.md) command and [environment variables](../../../reference/cli/surrealdb-cli/environment-variables.md) to modify the output from the database server. A quick overview of some of these flags is as follows:
