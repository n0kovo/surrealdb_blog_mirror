...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/data-models/geospatial/spatial-queries.mdx"
---
...
SurrealDB exposes these ideas through geometry values and the [`geo::`](../../../reference/query-language/functions/database-functions/geo.md) function family.
...
Exact operators available to your version are documented alongside geometry types and index definitions. You can also use [`EXPLAIN`](../../../reference/query-language/clauses/explain.md) to confirm your query plan when tuning performance.
