...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/data-models/time-series/aggregation-queries.mdx"
---
...
For raw event storage and complex record ID patterns, see [IoT and telemetry patterns](iot-and-telemetry-patterns.md).
