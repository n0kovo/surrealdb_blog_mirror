...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/self-hosting/observability/live-queries-and-dashboards.mdx"
---
...
[SurrealDB Studio](https://app.surrealdb.com) is the SurrealDB Cloud dashboard. For **Spectron on Cloud**, use SurrealDB Studio to create contexts and mint **API keys** — see [Spectron on SurrealDB Cloud](https://surrealdb.com/docs/spectron/quickstarts/surrealdb-cloud). That is separate from this operator-focused observability page.
