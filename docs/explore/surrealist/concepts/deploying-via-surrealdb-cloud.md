...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/surrealist/concepts/deploying-via-surrealdb-cloud.mdx"
---
...
Designed to support your growth, SurrealDB Cloud scales effortlessly [from prototypes to large-scale deployments](../../../build/deployment/surrealdb-cloud/getting-started/create-an-instance.md). By leveraging centralised data, it enables departments or teams to work efficiently while maintaining consistent data integrity and reducing redundancy.

Our transparent and [predictable pricing](/pricing) ensures you only pay for what you need.

![Surrealist API Docs view](../../../assets/img/image/surrealist/surrealist-cloud.png)
