...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/dotnet/core/writing-surrealql.mdx"
---

# Run SurrealQL queries

The methods below are used to interact with the database and perform CRUD operations. You can also use the `query` method to run [SurrealQL statements](../../query-language/statements/overview.md) against the database.
