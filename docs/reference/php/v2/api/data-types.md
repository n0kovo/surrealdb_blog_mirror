...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/php/v2/api/data-types.mdx"
---
...
An uncomputed SurrealQL [future](../../../query-language/language-primitives/data-types/futures.md), such as `<future> { ... }`. The body is the SurrealQL expression to evaluate.
...
Classes for each [GeoJSON geometry type](../../../query-language/language-primitives/data-types/geometries.md). They all extend the abstract `Geometry`, which provides `toGeoJson()`, `is()`, and the static `Geometry::fromGeoJson()`.
