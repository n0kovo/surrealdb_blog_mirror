...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/php/v1/concepts/authentication.mdx"
---
...
Authenticate using a specific [Scope](../../../query-language/statements/define/scope.md) within a database.
		```php
		$token = $db->signin([
			"email" => "user@email.com",
			"pass" => "secret",
...
Authenticate using a specific [access method](../../../query-language/statements/define/access/index.md) within a database.
		```php
		$token = $db->signin([
			"email" => "user@email.com",
			"pass" => "secret",
