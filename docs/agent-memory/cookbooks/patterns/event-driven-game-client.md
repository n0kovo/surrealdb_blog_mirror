...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/cookbooks/patterns/event-driven-game-client.mdx"
---
...
Long prior-campaign notes and world books should go through [Documents (upload)](../../reference/rest-api.md#documents-upload).
