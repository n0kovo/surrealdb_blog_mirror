...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/self-hosting/operations/contexts.mdx"
---
...
The secret is returned once in the response. Store it securely – it cannot be retrieved again. See [API keys and delegation](../security/api-keys-and-delegation.md) for key types and rotation.
