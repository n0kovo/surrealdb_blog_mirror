---
title: "Make a medical chatbot using GraphRAG with SurrealDB + LangChain"
slug: "make-a-medical-chatbot-using-graphrag-with-surrealdb-langchain"
...
summary: "Build a medical chatbot with GraphRAG, SurrealDB, and LangChain using Rust."
source: "https://surrealdb.com/blog/make-a-medical-chatbot-using-graphrag-with-surrealdb-langchain"
cover: "../../assets/c6a6ebf017dd57d0.jpg"
---

# Make a medical chatbot using GraphRAG with SurrealDB + LangChain

![Make a medical chatbot using GraphRAG with SurrealDB + LangChain](../../assets/c6a6ebf017dd57d0.jpg)

## Using LangChain

This post is a follow-up to [this one](/blog/make-a-genai-chatbot-using-graphrag-with-surrealdb-langchain) from two weeks ago which detailed how to make a medical chatbot using SurrealDB and LangChain using Python.

Rust developers have an option to do the same too, thanks to a crate called [langchain_rust](https://docs.rs/langchain-rust/latest/langchain_rust/) which as of last year [includes support for SurrealDB as a vector store](https://github.com/Abraxas-365/langchain-rust/pull/32). This implementation doesn't (yet!) include [graph queries](/blog/make-a-genai-chatbot-using-graphrag-with-surrealdb-langchain#stitching-the-graph-together), but we can still use classic vector search to find recommendations for treatment for a patient.
