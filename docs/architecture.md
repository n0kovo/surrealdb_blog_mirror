...
![Storage_Cluster](assets/img/image/light/storage-cluster.png)
...
SurrealDB can be embedded in a variety of programming languages. See [Embedding SurrealDB](build/embedding/index.md) for more information. 
