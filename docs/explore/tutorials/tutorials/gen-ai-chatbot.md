...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/tutorials/tutorials/gen-ai-chatbot.mdx"
---
...
![Communication diagram for the Graph RAG solution and the flow listed above](../../../assets/img/tutorials/gen-ai-chatbot-graphrag-flow-light.png)
...
With this taken care of, it's time to do some setup inside `main()`. First we need to start running the database, which can be run in memory or via some other path such as an address to a [Surreal Cloud](/cloud) or a [locally running instance](../../../reference/cli/surrealdb-cli/commands/start.md).
