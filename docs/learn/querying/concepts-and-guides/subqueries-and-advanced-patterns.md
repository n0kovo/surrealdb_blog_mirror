...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/querying/concepts-and-guides/subqueries-and-advanced-patterns.mdx"
---
...
Patterns such as appending a new comment id to a record are covered in [record references](../../../reference/query-language/language-primitives/record-references.md). See also [`RETURN`](../../../reference/query-language/statements/return.md).
...
More examples: [Selecting inside graph queries](../../../reference/query-language/statements/select.md#selecting-inside-graph-queries) and [graph clauses](../../../reference/query-language/statements/relate.md#graph-clauses) on the `RELATE` page.
