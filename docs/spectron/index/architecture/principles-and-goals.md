...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/index/architecture/principles-and-goals.mdx"
---
...
- **Cost is tiered and visible.** Cheap questions are answered cheaply; expensive paths are explicit, not buried in averages. See [Coherence, retrieval, and cost tiers](https://surrealdb.com/docs/spectron/architecture/coherence-retrieval-and-tiers).
...
- [Eight pillars and six categories](https://surrealdb.com/docs/spectron/architecture/eight-pillars-and-categories) – the operational model in primitives.
- [Architecture glossary](https://surrealdb.com/docs/spectron/architecture/glossary) – short definitions of key terms.
- [Unified substrate and authority](https://surrealdb.com/docs/spectron/mental-model/two-layer-architecture) – how authoritative and experiential material meet in one graph.
