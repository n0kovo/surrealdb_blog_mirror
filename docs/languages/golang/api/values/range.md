...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/api/values/range.mdx"
---
...
- [Table](table.md) for the table name type used in `RecordRangeID`
- [Value types](../../concepts/value-types.md) for the full type mapping
- [Data manipulation](../../concepts/data-manipulation.md) for using ranges in queries
- [SurrealQL ranges](../../../../reference/query-language/language-primitives/data-types/record-ids.md#record-ranges) for the underlying data model
