...
| `UUID`                                                  | `uuid`                                                                                                        | `java.util`                              |
| `byte[]`                                                | `bytes`                                                                                                       |                                          |
| `Instant`                                               | [`datetime`](../../query-language/language-primitives/data-types/datetimes.md)                         | `java.time`                              |
| `ZonedDateTime`                                         | [`datetime`](../../query-language/language-primitives/data-types/datetimes.md)                         | `java.time`                              |
| `OffsetDateTime`                                        | [`datetime`](../../query-language/language-primitives/data-types/datetimes.md)                         | `java.time`                              |
| `LocalDateTime`                                         | [`datetime`](../../query-language/language-primitives/data-types/datetimes.md)                         | `java.time`                              |
| `java.util.Date`                                        | [`datetime`](../../query-language/language-primitives/data-types/datetimes.md)                         | `java.time`                              |
| `Duration`                                              | [`duration`](../../query-language/language-primitives/data-types/datetimes.md#durations-and-datetimes) | `java.time`                              |
| [`RecordId`](../api/values/record-id.md) | [`record`](../../query-language/language-primitives/data-types/record-ids.md)                          | SDK class                                |
| [`Geometry`](../api/values/geometry.md)  | [`geometry`](../../query-language/language-primitives/data-types/geometries.md)                        | SDK class                                |
| [`FileRef`](../api/values/file-ref.md)   | [`file`](../../query-language/language-primitives/data-types/files.md)                                 | SDK class                                |
...
Graph edges created with [`.relate()`](../api/core/surreal.md#relate) or [`.insertRelation()`](../api/core/surreal.md#insert-relation) use specialized base classes that include the standard relation fields (`id`, `in`, `out`).

### Using `Relation`

Extend [`Relation`](../api/types/index.md#relation) when reading or creating edges with `.relate()`. The base class provides `id`, `in`, and `out` as `RecordId` fields.
...
Extend [`InsertRelation`](../api/types/index.md#insert-relation) when inserting edges with `.insertRelation()`. The base class provides `id` as an [`Id`](../api/values/record-id.md#id) and `in` / `out` as `RecordId` fields.
...
See [Error handling](error-handling.md) for more on the exception hierarchy.

## Learn more

- [Value types](value-types.md) for the complete SurrealDB-to-Java type mapping
- [Data manipulation](data-manipulation.md) for using converted types with CRUD operations
