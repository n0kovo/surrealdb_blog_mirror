...
- **[Connecting to SurrealDB](../reference/mojo/concepts/connecting-to-surrealdb.md)** — Learn about transports, wire formats, and TLS.
- **[Executing queries](../reference/mojo/concepts/executing-queries.md)** — Work with responses and convenience methods.
- **[Authentication](../reference/mojo/concepts/authentication.md)** — Sign in and manage credentials.
- **[API Reference](../reference/mojo/methods/index.md)** — Complete reference for all methods available in the Mojo SDK.

> [!NOTE]
> This getting-started guide covers the essentials. For the complete methods, API, and concept reference, see the [Mojo SDK reference](../reference/mojo/index.md).
