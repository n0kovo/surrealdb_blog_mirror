...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/v1/methods/insert.mdx"
---
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                The table name or [`RecordId`](../concepts/data-types.md#recordid) to insert to.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Arguments">
