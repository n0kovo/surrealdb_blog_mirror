...
![An image of a seven-pointed star created visually by relating seven records to each other and displayed inside Surrealist's graph view.](../../../../assets/img/image/recursive_star.png)
