...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/surrealist/concepts/designing-the-database-schema.mdx"
---
...
![Surrealist designer view](../../../assets/img/image/surrealist/designer.png)
...
The Designer view is built on top of the powerful [INFO FOR DB](../../../reference/query-language/statements/info.md#database-information) and [INFO FOR TABLE](../../../reference/query-language/statements/info.md#table-information) statements, which you can utilize yourself to programmatically extract schema information from the database.
