...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/surrealist/getting-started.mdx"
---

# Getting started

This page will guide you through the process of setting up and using Surrealist. At this point we assume you have already installed Surrealist on your system. If you have not done so yet, please refer to the [installation guide](installation.md).
...
Alternatively, you can select the **Cloud instance** option where you can create a new connection to a SurrealDB Cloud instance. Learn more about SurrealDB Cloud in the [SurrealDB Cloud documentation](../../manage/cloud/index.md).

![Start screen](../../assets/img/image/surrealist/surrealist-overview-page.png)
...
> [!IMPORTANT]
> In the new Surrealist redesign, the namespace and database fields are now configured per connection before you can [send queries to the database](concepts/sending-queries.md).
...
![HTTP connection](../../assets/img/image/surrealist/new-http-connection.png)
...
In addition to the different views, you can also find a button to open [Surrealist Search](advanced-topics/search-and-shortcuts.md), and a button to open the [settings](advanced-topics/settings-and-customisation.md). Within the settings
...
After reading this guide, you can watch the following video which covers some features of Surrealist that can help you get started. This includes organising connections and connection groups, [recordID](../../reference/query-language/language-primitives/data-types/record-ids.md) inspector, [editor shortcuts](advanced-topics/search-and-shortcuts.md), surrealist search and useful settings.
<iframe
	width="100%"
