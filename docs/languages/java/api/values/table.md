...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/java/api/values/table.mdx"
---
...
- [SurrealQL tables](../../../../reference/query-language/statements/define/table.md) — Table definitions in SurrealDB
