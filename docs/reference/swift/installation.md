...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/swift/installation.mdx"
---
...
See the [getting started guide](../../languages/swift.md) to connect to a database and run your first query.
