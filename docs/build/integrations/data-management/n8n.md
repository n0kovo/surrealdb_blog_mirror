...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/integrations/data-management/n8n.mdx"
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The connection string to your SurrealDB instance (must start with `http://` or `https://`). WebSocket connections (`ws://` or `wss://`) are not supported.</td>
    </tr>
    <tr>
...
- [SurrealQL Reference](../../../reference/query-language/index.md)
