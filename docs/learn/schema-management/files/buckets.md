...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/schema-management/files/buckets.mdx"
---
...
Once a bucket is defined, you can then read and write to files inside it through the [file functions](../../../reference/query-language/functions/database-functions/file.md).

Full statement detail: [`DEFINE BUCKET`](../../../reference/query-language/statements/define/bucket.md). For how pointers look in queries, see [Working with files](working-with-files.md).
...
- `$file`: The [file pointer](../../../reference/query-language/language-primitives/data-types/files.md) of the file to be accessed
- `$target`: The target [file pointer](../../../reference/query-language/language-primitives/data-types/files.md) in copy/rename operations
