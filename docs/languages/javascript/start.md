...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/start.mdx"
---
...
In addition to the `.eq()` function in the above example, we offer a comprehensive set of [expression utilities](api/utilities/expr.md) for building type-safe SurrealQL conditions.
...
- **[SurrealQL](../../reference/query-language/index.md)** — Learn how to use SurrealQL to query your database, define schemas, and build complex expressions.
- **[Connection management](concepts/connecting-to-surrealdb.md)** — Learn how to manage your database connections, including events, reconnecting, and more.
- **[Authentication](concepts/authentication.md)** — Read more about authentication and how to integrate it into your application.
- **[Executing queries](concepts/executing-queries.md)** — Learn how to execute queries against your database, use the query builders, and customise responses.
