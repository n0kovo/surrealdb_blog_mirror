...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/index/ingest/authoritative/uploading-documents.mdx"
---
...
Under **`TextOnly`**, multimodal uploads may be accepted but image/audio/video processing stages are skipped. See [Multimodal content](https://surrealdb.com/docs/agent-memory/ingest/authoritative/multimodal-content) for profile details.
...
Use the generated OpenAPI clients ([Python](../../../integrations/sdks/python.md), [TypeScript](../../../integrations/sdks/javascript-and-typescript.md)) for application code – method names follow the spec.
...
See [REST API](../../../reference/rest-api.md) for request shapes.
