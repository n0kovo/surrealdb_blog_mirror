...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/golang/concepts/live-queries.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Function"><a href="/docs/reference/golang/api/core/db#live">`surrealdb.Live(ctx, s, table, diff)`</a></td>
			<td scope="row" data-label="Description">Starts a live query on a table and returns its UUID</td>
		</tr>
		<tr>
			<td scope="row" data-label="Function"><a href="/docs/reference/golang/api/core/db#kill">`surrealdb.Kill(ctx, s, id)`</a></td>
			<td scope="row" data-label="Description">Stops a live query and closes its notification channel</td>
		</tr>
		<tr>
			<td scope="row" data-label="Function"><a href="/docs/reference/golang/api/core/db#livenotifications">`db.LiveNotifications(id)`</a></td>
			<td scope="row" data-label="Description">Returns the notification channel for a live query</td>
		</tr>
		<tr>
			<td scope="row" data-label="Function"><a href="/docs/reference/golang/api/core/db#closelivenotifications">`db.CloseLiveNotifications(id)`</a></td>
...
- [SurrealQL LIVE statement](../../query-language/statements/live-select.md) for the underlying query language syntax
