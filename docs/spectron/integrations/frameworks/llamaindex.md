...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/frameworks/llamaindex.mdx"
---

# LlamaIndex

[LlamaIndex](https://www.llamaindex.ai/) builds RAG and agent applications in Python. Spectron gives a LlamaIndex agent long-term memory that persists across sessions. There is no dedicated adapter. The [Python SDK](../sdks/python.md) (`surrealdb`) exposes the memory operations you wrap as `FunctionTool`s.
