...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/deployment/surrealdb-cloud/billing-and-support/faqs.mdx"
---
...
For details on the types of support offered for SurrealDB Cloud, see [this page](support.md).
...
Yes. You can move your current application built in SurrealDB to SurrealDB Cloud. You can find more information in the [migrate your existing data](../../../migrating/index.md) documentation.
...
You need to create a User first. Head to the [connect via SDK](../connecting/via-sdk.md) documentation for more details.
...
It is not currently possible to configure [CLI](../../../../reference/cli/surrealdb-cli/overview.md) arguments or environment variables in SurrealDB Cloud.

[GraphQL support](../../../../learn/querying/graphql/overview.md) is not yet enabled on SurrealDB Cloud instances.
...
Additionally, SurrealDB Cloud is built on top of SurrealDB, which provides powerful and flexible [security features](../../../../learn/security/authentication/summary.md#product) that are available to all SurrealDB Cloud customers. SurrealDB is developed and maintained following modern [security practices](../../../../learn/security/authentication/summary.md#process) to ensure early detection of security vulnerabilities and other security issues.
...
Anyone using the Individual (free) tier wishing to add another cluster will be alerted in their account that they must fill in their [billing information](billing.md).
