...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/insert-promise.mdx"
---
...
**Returned by:** [`SurrealQueryable.insert()`](../core/surreal-queryable.md#insert)
