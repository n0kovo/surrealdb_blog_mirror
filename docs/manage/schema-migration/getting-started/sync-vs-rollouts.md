...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/schema-migration/getting-started/sync-vs-rollouts.mdx"
---
...
- [Sync](../sync.md): full Sync reference
- [Rollouts](../rollouts.md): full Rollouts reference
