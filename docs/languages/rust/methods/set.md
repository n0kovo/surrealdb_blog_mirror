...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/rust/methods/set.mdx"
---
...
This is equivalent to using a [`LET`](../../../reference/query-language/statements/let.md) statement in SurrealQL, such as this one.
