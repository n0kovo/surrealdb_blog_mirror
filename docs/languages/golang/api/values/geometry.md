...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/api/values/geometry.mdx"
---
...
- [Data manipulation](../../concepts/data-manipulation.md) for using geometry values in CRUD operations
- [SurrealQL geometry types](../../../../reference/query-language/language-primitives/data-types/geometries.md) for the underlying data model
