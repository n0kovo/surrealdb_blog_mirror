...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/swift/methods/delete.mdx"
---
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                A [predicate](../concepts/predicates.md) selecting which records to delete.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Arguments">
            ...
            <td colspan="2" scope="row" data-label="Description">
                A [`SurrealRecordID`](../data-types.md#surrealrecordid) to delete a single record.
            </td>
        </tr>
    </tbody>
</table>
