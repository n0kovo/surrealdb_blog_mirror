...
Admin proxy routes return **403** for members. See [API keys and delegation](../../self-hosting/security/api-keys-and-delegation.md#surrealdb-cloud-surrealist).
...
For first **`remember`** / **`recall`** calls, use [Hosted quickstart](https://surrealdb.com/docs/spectron/quickstarts/hosted). For the UI tour, see [Surrealist dashboard quickstart](https://surrealdb.com/docs/spectron/quickstarts/surrealist-dashboard).
