...
This section also includes tips for writing efficient queries. For more detail, the [reference](../../reference/query-language/index.md) section of the documentation has separate pages for each statement, data type, clause and more for the entire SurrealQL query language.
