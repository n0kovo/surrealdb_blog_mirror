...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/tutorials/tutorials/auth0-integration.mdx"
---
...
To learn about other potential uses for the SurrealDB token functionality, you can read the [`DEFINE ACCESS ... TYPE JWT` documentation page](../../../reference/query-language/statements/define/access/jwt.md).
