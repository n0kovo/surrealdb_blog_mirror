...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/sdks/kotlin.mdx"
---
...
All failures throw a subclass of `SpectronException`. See the [Kotlin SDK reference](../../reference/sdk-kotlin.md#errors) for the full exception → status mapping and [Errors and retries](errors-and-retries.md).
