...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/schema-migration/template-variables.mdx"
---
...
Place `surrealkit.toml` in the root of your project. It is read automatically. The same file holds the [`[typegen]` section](/docs/manage/schema-migration/typegen) and, since 1.0, [schema modules and targets](modules-and-targets.md). See [Configuration](configuration.md) for the full key reference.
