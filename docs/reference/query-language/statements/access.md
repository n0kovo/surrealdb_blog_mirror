...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/statements/access.mdx"
---
...
The `ACCESS` statement can be used to manage access grants. It provides the ability to generate access grants using certain access methods, such as bearer keys defined with the [`DEFINE ACCESS ... TYPE BEARER`](define/access/bearer.md) statement, as well as the ability to show, revoke and purge such grants.

By default, the `ACCESS` statement will default to referencing access methods defined at the current level specified with the [`USE`](use.md) statement. As with other statements, access methods defined at any level can be referenced by using the `ON` clause.
...
```
                                   ...
                                   │             │                 │ │ │                                        │                                    │                           │     
        ╭────────╮     ┌───────┐   │    ╭────╮   │  ╭───────────╮  │ │ │                             ╭──────╮   │              ╭─────╮               │                           │     
├┼──────│ ACCESS │─────│ @name │───╯────│ ON │───┼──│ NAMESPACE │──┼─╰─┼─────────────────────────────│ SHOW │───┼──────────────│ ALL │───────────────┼───────────────────────────┼───┼┤
        ╰────────╯     └───────┘        ╰────╯   │  ╰───────────╯  │   │                             ╰──────╯   │              ╰─────╯               │                           │     
                                                 │                 │   │                                        │                                    │                           │     
                                                 │  ╭──────────╮   │   │                                        │    ╭───────╮     ┌─────────────┐   │                           │     
                                                 ╰──│ DATABASE │───╯   │                                        ╰────│ WHERE │─────│ @expression │───╯                           │     
                                                    ╰──────────╯       │                                             ╰───────╯     └─────────────┘                               │     
                                                                       ...
                                                                       │                │                  │                              │ │ │                                │ │     
                                                                       │    ╭───────╮   │    ╭─────────╮   │    ╭───╮      ╭─────────╮    │ │ │    ╭─────╮     ┌───────────┐   │ │     
                                                                       ╰────│ PURGE │───╯────│ REVOKED │───╯────│ , │───╮──│ EXPIRED │──╭─╰─╰─╯────│ FOR │─────│ @duration │───╰─╯     
                                                                            ╰───────╯        ╰─────────╯        ╰───╯   │  ╰─────────╯  │          ╰─────╯     └───────────┘           
                                                                                                                        │               │                                              
                                                                                                                        │  ╭─────────╮  │                                              
                                                                                                                        ╰──│ REVOKED │──╯                                              
...
To improve the output of an error message inside an `ACCESS` statement, a [`THROW`](throw.md) statement can be used.
...
As the `THROW` statement checks for the email address `me@me.com`, this can be tested using CURL at the [`signup`](../../rest-api/http-protocol.md#signup) endpoint via the following command.
