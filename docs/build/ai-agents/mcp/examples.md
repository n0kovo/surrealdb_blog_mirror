...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/ai-agents/mcp/examples.mdx"
---

# Example usages

These are prompts to try once you have connected the [SurrealDB MCP Server](index.md) to your AI tool. Each one explains what the assistant does behind the prompt, so you know what to expect before you ask.
