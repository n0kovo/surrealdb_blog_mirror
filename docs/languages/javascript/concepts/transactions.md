...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/concepts/transactions.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-session#begintransaction"> ` db.beginTransaction() `</a></td>
			<td scope="row" data-label="Description">Starts a new transaction</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-transaction#commit"> ` txn.commit() `</a></td>
			<td scope="row" data-label="Description">Commits the transaction, applying all changes</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-transaction#cancel"> ` txn.cancel() `</a></td>
...
Call `.beginTransaction()` on any [`Surreal`](../api/core/surreal.md) or [`SurrealSession`](../api/core/surreal-session.md) instance to start a new transaction. The returned [`SurrealTransaction`](../api/core/surreal-transaction.md) object provides all the same [query methods](executing-queries.md) as a regular session, but every operation is executed within the transaction scope.
...
- [Executing queries](executing-queries.md) for the query methods available on transactions
- [Multiple sessions](multiple-sessions.md) for running transactions on isolated sessions
