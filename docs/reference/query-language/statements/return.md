...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/statements/return.mdx"
---
...
`RETURN` is always followed by a value. As every data type in SurrealDB is a type of [value](../language-primitives/data-types/values.md), the `RETURN` statement can return anything from simple values to the result of queries.
