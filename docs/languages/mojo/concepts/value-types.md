...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/mojo/concepts/value-types.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td colspan="2" scope="row" data-label="Type">`Uuid`</td>
            <td colspan="2" scope="row" data-label="Fields">`value`</td>
            <td colspan="2" scope="row" data-label="Description">A UUID string.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Type">`DateTime`</td>
            <td colspan="2" scope="row" data-label="Fields">`seconds`, `nanos`</td>
            <td colspan="2" scope="row" data-label="Description">A point in time, split into seconds and nanoseconds.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Type">`Duration`</td>
            <td colspan="2" scope="row" data-label="Fields">`seconds`, `nanos`</td>
            <td colspan="2" scope="row" data-label="Description">A length of time.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Type">`Decimal`</td>
            <td colspan="2" scope="row" data-label="Fields">`value`</td>
            <td colspan="2" scope="row" data-label="Description">An arbitrary-precision decimal, held as a string.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Type">`FileRef`</td>
            <td colspan="2" scope="row" data-label="Fields">`bucket`, `key`</td>
            <td colspan="2" scope="row" data-label="Description">A reference to a file in a bucket.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Type">`SurrealSet`</td>
            <td colspan="2" scope="row" data-label="Fields">`items`</td>
            <td colspan="2" scope="row" data-label="Description">A set of values.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Type">`FutureValue`</td>
            <td colspan="2" scope="row" data-label="Fields">`body`</td>
