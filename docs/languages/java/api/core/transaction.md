...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/java/api/core/transaction.mdx"
---
...
- [SurrealQL BEGIN](../../../../reference/query-language/statements/begin.md) — Server-side transaction syntax
