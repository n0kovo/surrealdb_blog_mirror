...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/php/v2/installation.mdx"
---
...
- [Getting started](../versions/v2-alpha.md) to connect and run your first queries
- [Connecting to SurrealDB](concepts/connecting-to-surrealdb.md) for connection options and reconnection
- [Migration guide](migration.md) if you are coming from v1
