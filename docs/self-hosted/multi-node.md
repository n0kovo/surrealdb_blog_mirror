...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/self-hosted/multi-node.mdx"
---
...
Environment variables such as `SURREAL_TIKV_REQUEST_TIMEOUT` can be set to modify the behaviour of a TiKV instance. For more details on these, see [this section](../reference/cli/surrealdb-cli/environment-variables.md#tikv-environment-variables) of the page dedicated to environment variables.
