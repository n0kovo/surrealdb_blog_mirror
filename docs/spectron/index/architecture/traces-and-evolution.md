...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/index/architecture/traces-and-evolution.mdx"
---
...
The [REST API](../../reference/rest-api.md) and [MCP tools reference](../../integrations/mcp-server/tools-reference.md) exercise these paths.
