...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/api/values/uuid.mdx"
---
...
- [Live queries](../../concepts/live-queries.md) for live query UUIDs
- [Session](../core/session.md#id) for session UUIDs
- [Transaction](../core/transaction.md#id) for transaction UUIDs
- [Value types](../../concepts/value-types.md) for the full type mapping
- [SurrealQL UUID type](../../../../reference/query-language/language-primitives/data-types/uuids.md) for the underlying data model
