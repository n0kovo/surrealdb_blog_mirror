...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/rust/concepts/surrealvalue-attributes.mdx"
---

# SurrealValue attributes

These attributes customise the `SurrealValue` derive, which is covered in [Working with types](working-with-types.md) along with the `kind!` macro and the `Value` helpers.
