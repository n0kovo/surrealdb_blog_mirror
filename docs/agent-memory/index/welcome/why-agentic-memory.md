...
The result is a memory layer **you can trust**: correctness can be demonstrated rather than assumed. See [The accuracy promise](https://surrealdb.com/docs/agent-memory/welcome/accuracy-promise) for how that works in practice.
