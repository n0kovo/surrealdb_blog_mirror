...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/querying/concepts-and-guides/custom-functions.mdx"
---

# Custom functions

[`DEFINE FUNCTION`](../../../reference/query-language/statements/define/function.md) registers reusable SurrealQL under a name beginning with the `fn::` prefix. You need appropriate access (root / namespace / database owner or editor), and you must [`USE`](../../../reference/query-language/statements/use.md) the right namespace and database first. For more clauses and edge cases, see the reference documentation.
...
You can also return [literal union types](../../../reference/query-language/language-primitives/data-types/literals.md) for structured data or a fallback string instead of [throwing](../../../reference/query-language/statements/throw.md):
...
Handlers for [`DEFINE API`](../../../reference/query-language/statements/define/api.md) middleware are ordinary `fn::` functions with a specific signature. See [custom middleware](../../../reference/query-language/statements/define/api.md#custom-middleware) and the learn page on [middleware](../custom-apis/middleware.md) for more details.
