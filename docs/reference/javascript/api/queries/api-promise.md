...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/api-promise.mdx"
---
...
**Returned by:** Methods on [`SurrealApi`](../core/surreal-api.md)
...
- [User-Defined APIs](../../../query-language/statements/define/api.md) - Defining APIs in SurrealDB
