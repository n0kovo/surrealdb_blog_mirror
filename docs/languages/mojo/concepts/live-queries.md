...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/mojo/concepts/live-queries.mdx"
---
...
See the method reference for [`live`](../methods/live.md) and [`kill`](../methods/kill.md).
