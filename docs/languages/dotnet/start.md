...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/dotnet/start.mdx"
---
...
Now that you have learned the basics of the .NET SDK for SurrealDB, you can learn more about the SDK and its methods [in the methods section](methods/index.md) and [data types section](data-types.md).
