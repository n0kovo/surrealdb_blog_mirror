...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/mojo/concepts/connecting-to-surrealdb.mdx"
---
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">The credential placed in the `Authorization` header. See <a href="/docs/reference/mojo/concepts/authentication">Authentication</a>.</td>
        </tr>
        <tr>
