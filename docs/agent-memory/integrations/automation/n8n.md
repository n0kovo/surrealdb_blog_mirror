...
- [REST API](../surfaces/rest.md): the endpoints the HTTP Request nodes call
- [MCP server](../mcp-server/install.md): if your n8n host speaks MCP instead
