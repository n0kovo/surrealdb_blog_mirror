...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/mojo/concepts/transactions.mdx"
---
...
See the method reference for [`transaction_multi`](../methods/transaction-multi.md) and [`begin_transaction`](../methods/begin-transaction.md).
