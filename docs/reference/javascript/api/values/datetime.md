...
<table>
    ...
    <tbody>
        <tr>
            <td>`value` <label label="optional" /></td>
            <td>`DateTime | Date | string | number | bigint | [bigint, bigint]`</td>
...
#### Returns
[`Duration`](duration.md) - Duration between the two datetimes
...
- [SurrealQL datetimes](../../../query-language/language-primitives/data-types/datetimes.md) - Database datetime type
