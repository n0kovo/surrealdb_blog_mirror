...
In this section, you’ll learn how to think like a geospatial database user: represent location with geometry or geography types, query with spatial predicates, and combine SurrealDB’s [geo functions](../../../reference/query-language/functions/database-functions/geo.md) with the rest of your data.
