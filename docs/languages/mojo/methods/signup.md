...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/mojo/methods/signup.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">The signup payload, CBOR-encoded as a map, as a `List[UInt8]`. It names the access method along with the namespace, database, and any variables it expects.</td>
        </tr>
        <tr>
