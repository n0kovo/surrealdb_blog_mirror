...
> [!WARNING]
> If you use a [personal access token](../build/ai-agents/mcp/index.md#signing-in) instead, keep it in the global `~/.cursor/mcp.json`. A token in a project-level file will be committed with the repository.
