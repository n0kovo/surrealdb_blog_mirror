...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/api/values/table.mdx"
---
...
- [RecordID](record-id.md) for targeting specific records
- [Data manipulation](../../concepts/data-manipulation.md) for using tables in CRUD operations
