...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/statements/define/param.mdx"
---
...
- [You must select your namespace and database](../use.md) before you can use the `DEFINE PARAM` statement.
...
```
                                   ...
                                   │ │                                        │ │                                                      │                                  │ │                      │                                   │ │     
        ╭────────╮     ╭───────╮   │ │    ╭────╮     ╭─────╮     ╭────────╮   │ │   ╭───╮     ┌───────┐     ╭───────╮     ┌────────┐   │    ╭─────────╮     ┌─────────┐   │ │    ╭─────────────╮   │             ╭──────╮              │ │     
├┼──────│ DEFINE │─────│ PARAM │───╯─╯────│ IF │─────│ NOT │─────│ EXISTS │───╰─╰───│ $ │─────│ @name │─────│ VALUE │─────│ @value │───╯────│ COMMENT │─────│ @string │───╰─╯────│ PERMISSIONS │───┼─────────────│ FULL │──────────────┼─╰───┼┤
        ╰────────╯     ╰───────╯          ╰────╯     ╰─────╯     ╰────────╯         ╰───╯     └───────┘     ╰───────╯     └────────┘        ╰─────────╯     └─────────┘          ╰─────────────╯   │             ╰──────╯              │       
                                                                                                                                                                                                   │                                   │       
                                                                                                                                                                                                   │    ╭───────╮     ┌────────────┐   │       
                                                                                                                                                                                                   ╰────│ WHERE │─────│ @condition │───╯       
