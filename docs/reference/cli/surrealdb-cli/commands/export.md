...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/cli/surrealdb-cli/commands/export.mdx"
---
...
To export from a SurrealDB Cloud instance by name, [`surrealctl`](../../surrealctl/overview.md) resolves the endpoint and credentials for you and then runs this command. The flags and file-format notes on this page still apply.
