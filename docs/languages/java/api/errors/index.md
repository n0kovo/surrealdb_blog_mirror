...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/java/api/errors/index.mdx"
---
...
Thrown when a SurrealQL [`THROW`](../../../../reference/query-language/statements/throw.md) statement is executed. Extends `ServerException`. No additional methods.
...
- [SurrealQL THROW](../../../../reference/query-language/statements/throw.md) — Throwing custom errors from queries
