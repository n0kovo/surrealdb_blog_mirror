...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/language-primitives/data-types/geometries.mdx"
---
...
This can be shown by calling the [`type::is_geometry()`](../../functions/database-functions/type.md#typeis_geometry) function on some sample objects.
...
* [SurrealQL operators](../operators.md)
* [geo functions](../../functions/database-functions/geo.md)
