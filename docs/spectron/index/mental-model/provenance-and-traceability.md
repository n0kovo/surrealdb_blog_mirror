...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/index/mental-model/provenance-and-traceability.mdx"
---
...
- CLI: `spectron inspect trace:…`, `spectron entities history …` ([Surface, models, and security](https://surrealdb.com/docs/spectron/architecture/surface-security-and-models)).
