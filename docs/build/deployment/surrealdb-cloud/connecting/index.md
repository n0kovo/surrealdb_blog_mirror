...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/deployment/surrealdb-cloud/connecting/index.mdx"
---
...
- [a SurrealDB Cloud account](../../../../manage/cloud/index.md).
- [an Instance to connect to](../getting-started/create-an-instance.md).
