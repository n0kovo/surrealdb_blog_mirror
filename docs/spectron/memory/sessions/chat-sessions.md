...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/memory/sessions/chat-sessions.mdx"
---
...
The `session.context()` method retrieves the formatted context string that Spectron would have injected, so you can replicate the retrieval step in the manual pattern. See [Retrieving context](../operations/recall.md) for details.
