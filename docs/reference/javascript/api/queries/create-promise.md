...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/create-promise.mdx"
---
...
**Returned by:** [`SurrealQueryable.create()`](../core/surreal-queryable.md#create)
...
<table>
    ...
    <tbody>
        <tr>
            <td>`fields` <label label="required" /></td>
            <td>`Output`</td>
            <td>Output specification: `"NONE"`, `"BEFORE"`, `"AFTER"`, `"DIFF"`, or field list.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`duration` <label label="required" /></td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`Partial&lt;<a href="/docs/reference/javascript/api/types/#retryoptions">RetryOptions</a>&gt;`</td>
