...
Runs a set of [SurrealQL](../../../../reference/query-language/index.md) statements against the database. Returns an awaitable (async) or lazy (sync) builder.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>`args` *[optional]*</td>
            <td>`list[<a href="/docs/languages/python/api/types/#value">Value</a>] | None`</td>
