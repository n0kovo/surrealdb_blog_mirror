...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/reference/rest-api.mdx"
---
...
See [Contexts and scope](https://surrealdb.com/docs/spectron/mental-model/contexts-and-scope).
...
**`POST /forget`** accepts a natural-language **`query`**, optional **`purge: true`** for permanent erasure, and optional **`dryRun: true`** to return a match count without expiring anything (see [Forgetting memories](../agent-memory/operations/forget.md)).
