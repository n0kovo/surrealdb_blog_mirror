...
Follow the [installation guide](../reference/javascript/installation.md) to install the SDK as a dependency in your project. Once installed, you can import and instantiate the SDK to start using it.
...
In addition to the `.eq()` function in the above example, the SDK provides a full set of [expression utilities](../reference/javascript/api/utilities/expr.md) for building type-safe SurrealQL conditions.
