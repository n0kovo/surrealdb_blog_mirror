...
`RecordIdRange` targets a contiguous range of records within a table by their IDs. Pass it to the [CRUD builders](../../concepts/data-manipulation.md) to operate on a [range of records](../../../query-language/language-primitives/data-types/record-ids.md#record-ranges).
...
- [Record ranges](../../../query-language/language-primitives/data-types/record-ids.md#record-ranges) in SurrealQL
