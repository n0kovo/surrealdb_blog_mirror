...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/self-hosting/observability/tracing.mdx"
---
...
See [Traces and memory evolution](https://surrealdb.com/docs/spectron/architecture/traces-and-evolution) for how traces feed back into ranking and consolidation.
...
For compliance exports, combine trace listing, SurrealDB export of trace tables, and your log pipeline’s capture of audit events. See [Profiles and audit trails](profiles-and-audit-trails.md).
