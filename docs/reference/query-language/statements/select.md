...
```
                     ...
                     │                               │ │                            │ │                                   │              │            │                  │               │                                     │ │ │                                    │ │ │                │  │          │                     │ │ │ │                │          │ │                                                                        │ │ │                │          │                │ │                │          │                │ │                                    │ │                                    │ │                 │ │                  │            │ │               
        ╭────────╮   │          ┌─────────┐          │ │    ╭────╮     ┌────────┐   │ │    ╭──────╮     ┌─────────────┐   │   ╭──────╮   │  ╭──────╮  │   ┌──────────┐   │    ╭──────╮   │    ╭───────╮     ┌──────────────┐   │ │ │    ╭───────╮     ┌─────────────┐   │ │ │    ╭───────╮   │  │  ╭────╮  │   ┌─────────────┐   │ │ │ │    ╭───────╮   │  ╭────╮  │ │                               ╭────────╮                               │ │ │    ╭───────╮   │  ╭────╮  │   ┌────────┐   │ │    ╭───────╮   │  ╭────╮  │   ┌────────┐   │ │    ╭───────╮     ┌─────────────┐   │ │    ╭─────────╮     ┌───────────┐   │ │  ╭───────────╮  │ │    ╭─────────╮   │  ╭──────╮  │ │   ╭───╮       
├┼──────│ SELECT │───╯──────────│ @fields │──────────╰─╯────│ AS │─────│ @alias │───╰─╯────│ OMIT │─────│ @fields ... │───╰───│ FROM │───╯──│ ONLY │──╰───│ @targets │───╯────│ WITH │───╯────│ INDEX │─────│ @indexes ... │───╰─╰─╯────│ WHERE │─────│ @conditions │───╰─╯─╯────│ GROUP │───╯──╯──│ BY │──╰───│ @field, ... │───╰─╰─╰─╯────│ ORDER │───╯──│ BY │──╰─╯───────────────────────────────│ RAND() │───────────────────────────────╰─╰─╯────│ LIMIT │───╯──│ BY │──╰───│ @limit │───╰─╯────│ START │───╯──│ AT │──╰───│ @start │───╰─╯────│ FETCH │─────│ @fields ... │───╰─╯────│ TIMEOUT │─────│ @duration │───╰─╯──│ TEMPFILES │──╰─╯────│ EXPLAIN │───╯──│ FULL │──╰─╰───│ ; │─────┼┤
        ╰────────╯              └─────────┘                 ╰────╯     └────────┘          ╰──────╯     └─────────────┘       ╰──────╯      ╰──────╯      └──────────┘        ╰──────╯        ╰───────╯     └──────────────┘            ╰───────╯     └─────────────┘            ╰───────╯         ╰────╯      └─────────────┘              ╰───────╯      ╰────╯                                    ╰────────╯                                        ╰───────╯      ╰────╯      └────────┘          ╰───────╯      ╰────╯      └────────┘          ╰───────╯     └─────────────┘          ╰─────────╯     └───────────┘        ╰───────────╯         ╰─────────╯      ╰──────╯        ╰───╯
```
