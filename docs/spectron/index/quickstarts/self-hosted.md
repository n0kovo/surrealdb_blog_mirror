...
For **native dev** on the host (`spectrond dev start` + local SurrealDB), see the [CLI](../../reference/cli.md#development-runtime) **dev start** section and [Configuration](../../reference/configuration.md).
...
See the [MCP server install guide](../../integrations/mcp-server/install.md) for per-client setup.
