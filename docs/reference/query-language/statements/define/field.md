...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/statements/define/field.mdx"
---
...
- [You must select your namespace and database](../use.md) before you can use the `DEFINE FIELD` statement.
...
```
                                   ...
                                   │                                            │                                                                                                            │                    │                                                                 │ │                                                                                                                                                             │                                                                          │                                          
                                   │               ╭───────────╮                │                                                         ╭────────────────────────────────────────────────╮ │                    │               ╭────╮     ╭────────╮     ╭────────╮              │ │ ╭───────────────────────────────────────────────────────╮                                                                                                   │                                           ╭──────╮                       │                                          
                                   │ ╭─────────────│ OVERWRITE │──────────────╮ │                                                         │                                                │ │                    │ ╭─────────────│ ON │─────│ DELETE │─────│ REJECT │────────────╮ │ │ │                                                       │                                                                                                   │                      ╭────────────────────│ NONE │─────────────────────╮ │                                          
                                   │ │             ╰───────────╯              │ │                          ╭─────────────╮                │                             ╭────────────────╮ │ │                    │ │             ╰────╯     ╰────────╯     ╰────────╯            │ │ │ │                  ╭──────────────╮                     │ ╭────────────────╮ ╭────────────────────────────────────╮ ╭─────────────────────────────────────╮ │                      │                    ╰──────╯                     │ │ ╭──────────────────────────────────╮     
                                   │ │                                        │ │                          │             │                │                             │                │ │ │                    │ │                                                             │ │ │ │                  │              │                     │ │                │ │                                    │ │                                     │ │                      │                                                 │ │ │                                  │     
        ╭────────╮     ╭───────╮   │ │    ╭────╮     ╭─────╮     ╭────────╮   │ │   ┌───────┐     ╭────╮   │  ╭───────╮  │   ┌────────┐   │    ╭──────╮     ┌───────┐   │  ╭──────────╮  │ │ │    ╭───────────╮   │ │            ╭────╮     ╭────────╮     ╭─────────╮            │ │ │ │    ╭─────────╮   │  ╭────────╮  │   ┌─────────────┐   │ │  ╭──────────╮  │ │    ╭───────╮     ┌─────────────┐   │ │    ╭────────╮     ┌─────────────┐   │ │    ╭─────────────╮   │                    ╭──────╮                     │ │ │    ╭─────────╮     ┌─────────┐   │     
├┼──────│ DEFINE │─────│ FIELD │───╯─╯────│ IF │─────│ NOT │─────│ EXISTS │───╰─╰───│ @name │─────│ ON │───╯──│ TABLE │──╰───│ @table │───╯────│ TYPE │─────│ @type │───╯──│ FLEXIBLE │──╰─╰─╯────│ REFERENCE │───╯─┼────────────│ ON │─────│ DELETE │─────│ CASCADE │────────────┼─╰─╰─╯────│ DEFAULT │───╯──│ ALWAYS │──╰───│ @expression │───╰─╯──│ READONLY │──╰─╯────│ VALUE │─────│ @expression │───╰─╯────│ ASSERT │─────│ @expression │───╰─╯────│ PERMISSIONS │───┼────────────────────│ FULL │─────────────────────┼─╰─╯────│ COMMENT │─────│ @string │───╰───┼┤
        ╰────────╯     ╰───────╯          ╰────╯     ╰─────╯     ╰────────╯         └───────┘     ╰────╯      ╰───────╯      └────────┘        ╰──────╯     └───────┘      ╰──────────╯           ╰───────────╯     │            ╰────╯     ╰────────╯     ╰─────────╯            │          ╰─────────╯      ╰────────╯      └─────────────┘        ╰──────────╯         ╰───────╯     └─────────────┘          ╰────────╯     └─────────────┘          ╰─────────────╯   │                    ╰──────╯                     │        ╰─────────╯     └─────────┘         
                                                                                                                                                                                                                    │                                                             │                                                                                                                                                                                        │                                                 │                                            
                                                                                                                                                                                                                    │             ╭────╮     ╭────────╮     ╭────────╮            │                                                                                                                                                                                        │    ╭─────╮     ╭────────╮     ┌─────────────┐   │                                            
                                                                                                                                                                                                                    ╰─────────────│ ON │─────│ DELETE │─────│ IGNORE │────────────╯                                                                                                                                                                                        ╰────│ FOR │─────│ select │─────│ @expression │───╯                                            
                                                                                                                                                                                                                    │             ╰────╯     ╰────────╯     ╰────────╯            │                                                                                                                                                                                        │    ╰─────╯     ╰────────╯     └─────────────┘   │                                            
                                                                                                                                                                                                                    │                                                             │                                                                                                                                                                                        │                                                 │                                            
                                                                                                                                                                                                                    │             ╭────╮     ╭────────╮     ╭───────╮             │                                                                                                                                                                                        │    ╭─────╮     ╭────────╮     ┌─────────────┐   │                                            
                                                                                                                                                                                                                    ╰─────────────│ ON │─────│ DELETE │─────│ UNSET │─────────────╯                                                                                                                                                                                        ╰────│ FOR │─────│ create │─────│ @expression │───╯                                            
                                                                                                                                                                                                                    │             ╰────╯     ╰────────╯     ╰───────╯             │                                                                                                                                                                                        │    ╰─────╯     ╰────────╯     └─────────────┘   │                                            
                                                                                                                                                                                                                    │                                                             │                                                                                                                                                                                        │                                                 │                                            
                                                                                                                                                                                                                    │    ╭────╮     ╭────────╮     ╭──────╮     ┌─────────────┐   │                                                                                                                                                                                        │    ╭─────╮     ╭────────╮     ┌─────────────┐   │                                            
                                                                                                                                                                                                                    ╰────│ ON │─────│ DELETE │─────│ THEN │─────│ @expression │───╯                                                                                                                                                                                        ╰────│ FOR │─────│ update │─────│ @expression │───╯                                            
                                                                                                                                                                                                                         ╰────╯     ╰────────╯     ╰──────╯     └─────────────┘                                                                                                                                                                                                 ╰─────╯     ╰────────╯     └─────────────┘
```

  
**Railroad Diagram (Computed)**
...
```
                                   ...
                                   │ │                                        │ │                          │             │                                                     │                             │ │                      │                                                 │ │ │                                  │     
        ╭────────╮     ╭───────╮   │ │    ╭────╮     ╭─────╮     ╭────────╮   │ │   ┌───────┐     ╭────╮   │  ╭───────╮  │   ┌────────┐     ╭──────────╮     ┌─────────────┐   │    ╭──────╮     ┌───────┐   │ │    ╭─────────────╮   │                    ╭──────╮                     │ │ │    ╭─────────╮     ┌─────────┐   │     
├┼──────│ DEFINE │─────│ FIELD │───╯─╯────│ IF │─────│ NOT │─────│ EXISTS │───╰─╰───│ @name │─────│ ON │───╯──│ TABLE │──╰───│ @table │─────│ COMPUTED │─────│ @expression │───╯────│ TYPE │─────│ @type │───╰─╯────│ PERMISSIONS │───┼────────────────────│ FULL │─────────────────────┼─╰─╯────│ COMMENT │─────│ @string │───╰───┼┤
        ╰────────╯     ╰───────╯          ╰────╯     ╰─────╯     ╰────────╯         └───────┘     ╰────╯      ╰───────╯      └────────┘     ╰──────────╯     └─────────────┘        ╰──────╯     └───────┘          ╰─────────────╯   │                    ╰──────╯                     │        ╰─────────╯     └─────────┘         
                                                                                                                                                                                                                                      │                                                 │                                            
                                                                                                                                                                                                                                      │    ╭─────╮     ╭────────╮     ┌─────────────┐   │                                            
                                                                                                                                                                                                                                      ╰────│ FOR │─────│ select │─────│ @expression │───╯                                            
...
The example below shows how to define a field `user` on a `POST` table. The field is of type [record](../../language-primitives/record-links.md). This means that the field can store a `record<user>` or `NONE`.
...
In the example below, the `VALUE` clause is used to ensure that the email address is always stored in lowercase characters by using the [`string::lowercase`](../../functions/database-functions/string.md#stringlowercase) function.
...
A `COMMENT` documents how the field is meant to be used. Comments can be useful when describing how someone (or an agent) would write a query: comparison rules, units, allowed values, or invariants. The comment is stored with the definition and shown by [`INFO`](../info.md). See also [Comments on definitions](overview.md#comments-on-definitions).
...
As the `ASSERT` clause expects an expression that returns a boolean, an assertion with a custom message can be manually created by returning `true` in one case and using a [`THROW`](../throw.md) clause otherwise.
...
A `COMPUTED` body is evaluated with the reader's own authentication, narrowed so that it can never exceed the level and role of the user who defined the field. As with [`DEFINE FUNCTION`](function.md), the limit is a ceiling: it only ever removes access.
...
> [!NOTE]
> Computed fields are also populated on the records that [events](event.md), [live queries](../live-select.md), and changefeeds receive. Before 3.3.0, `$before` and `$after` reported every computed field as `NONE`.
...
While a `DEFINE TABLE` statement represents a template for any subsequent records to be created, a `DEFINE FIELD` statement pertains to concrete field data of a record. As such, a `DEFINE FIELD` statement gives access to the record's other fields through their names, as well as the current field through the [`$value`](../../language-primitives/parameters.md#value) parameter.
...
One more example of a literal containing settings for a [full text search](../../../../learn/data-models/full-text-search/overview.md) filter:
...
Values for an inlined field should also be kept small. A payload larger than `SURREAL_GRAPH_INLINE_PROPS_CAP` (64 bytes by default) is spilled, meaning the value stays on the record only and the traversal falls back to fetching it. See [environment variables](../../../cli/surrealdb-cli/environment-variables.md).
...
| A field on a [`LIGHTWEIGHT`](table.md#using-lightweight-for-relations-without-properties) relation | A lightweight relation has no edge records, so it has no fields at all |
