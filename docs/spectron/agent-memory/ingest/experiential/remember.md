...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/ingest/experiential/remember.mdx"
---
...
Extraction, reconciliation, and provenance are described in [Extraction pipeline](../../reasoning/extraction-pipeline.md) and [Provenance and traceability](https://surrealdb.com/docs/spectron/mental-model/provenance-and-traceability).
