...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/integrations/data-management/airbyte.mdx"
---
...
- A token or user credentials with [`DEFINE TABLE`](../../../reference/query-language/statements/define/table.md), [`DEFINE INDEX`](../../../reference/query-language/statements/define/indexes.md), [`UPSERT`](../../../reference/query-language/statements/upsert.md), [`SELECT`](../../../reference/query-language/statements/select.md), and [`REMOVE`](../../../reference/query-language/statements/remove.md) permissions.
