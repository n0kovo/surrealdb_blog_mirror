...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/retrieve/recall.mdx"
---
...
Register scope paths before use (`spectron scopes create org/acme/user/alice`). See [Contexts and scope](https://surrealdb.com/docs/spectron/mental-model/contexts-and-scope).
...
See [Coherence, retrieval, and cost tiers](https://surrealdb.com/docs/spectron/architecture/coherence-retrieval-and-tiers). Tiers progress from cheap structured lookup through response cache, hybrid vector + BM25 + graph, to full-context synthesis. Mode details: [Hybrid search](hybrid-search.md), [Keywords and BM25](keywords-and-bm25.md), [Graph traversal](graph-traversal.md).
