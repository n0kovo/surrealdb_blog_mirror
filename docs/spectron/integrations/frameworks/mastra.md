...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/frameworks/mastra.mdx"
---
...
- To call Spectron directly, use the [JavaScript SDK](../sdks/javascript-and-typescript.md).
