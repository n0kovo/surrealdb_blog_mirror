...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td scope="row" data-label="Name">`surrealdb_process_memory_allocated_bytes`*Since v3.3.0*</td>
            <td scope="row" data-label="Type">gauge</td>
            <td scope="row" data-label="Labels">-</td>
            <td scope="row" data-label="Notes">Tracked memory: live Rust-heap allocations, counted at the size class the allocator reserved for each, plus external memory reporters such as the RocksDB block cache. This is the value compared against `SURREAL_MEMORY_THRESHOLD`.</td>
        </tr>
        <tr>
            <td scope="row" data-label="Name">`surrealdb_process_memory_requested_bytes`*Since v3.3.0*</td>
            <td scope="row" data-label="Type">gauge</td>
            <td scope="row" data-label="Labels">-</td>
        ...
        <tr>
            <td scope="row" data-label="Name">`surrealdb_process_memory_reserved_bytes`*Since v3.3.0*</td>
            <td scope="row" data-label="Type">gauge</td>
            <td scope="row" data-label="Labels">-</td>
        ...
        <tr>
            <td scope="row" data-label="Name">`surrealdb_process_memory_threshold_bytes`*Since v3.3.0*</td>
            <td scope="row" data-label="Type">gauge</td>
            <td scope="row" data-label="Labels">-</td>
            <td scope="row" data-label="Notes">The configured `SURREAL_MEMORY_THRESHOLD` in bytes, or `0` when the memory guard is disabled. Constant for the life of the process.</td>
        </tr>
        <tr>
...
<Edition value="community" /> *Since v3.3.0*

One event is recorded per object-store operation that a [file bucket](../../reference/query-language/statements/define/bucket.md) performs, including those behind the global bucket. Bucket operations run below the session layer, so these families carry no `namespace`, `database` or `user` labels. They are not on the public allowlist, so only an authenticated scrape returns them.
...
<table>
    ...
    <tbody>
        <tr>
            <td scope="row" data-label="Name">`surrealdb_bucket_operations_total`</td>
            <td scope="row" data-label="Type">counter</td>
            <td scope="row" data-label="Labels">`backend, op, outcome`</td>
            <td scope="row" data-label="Notes">Incremented once per operation, successful or not.</td>
        </tr>
        <tr>
            <td scope="row" data-label="Name">`surrealdb_bucket_sent_bytes_total`</td>
            <td scope="row" data-label="Type">counter</td>
            <td scope="row" data-label="Labels">same as above</td>
            <td scope="row" data-label="Notes">Bytes given to a successful `put` or `put_if_not_exists`. A `put_if_not_exists` that finds the file already present still counts its bytes.</td>
        </tr>
        <tr>
            <td scope="row" data-label="Name">`surrealdb_bucket_received_bytes_total`</td>
            <td scope="row" data-label="Type">counter</td>
            <td scope="row" data-label="Labels">same as above</td>
            <td scope="row" data-label="Notes">Bytes downloaded from the backend. Recorded only for a successful `get` that found the file.</td>
        </tr>
    </tbody>
</table>
