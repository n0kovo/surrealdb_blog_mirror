...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/self-hosted/in-memory.mdx"
---
...
Since SurrealDB 3.0, in-memory storage runs on a backend called [SurrealMX](https://github.com/surrealdb/surrealmx) that also allows for [versioned queries](../reference/query-language/statements/select.md#the-version-clause) as well as [persistent storage](../reference/cli/surrealdb-cli/commands/start.md#supported-parameters-for-memory-surrealmx) as a snapshot or AOL (append-only log).
