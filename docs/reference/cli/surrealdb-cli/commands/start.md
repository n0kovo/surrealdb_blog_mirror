...
While SurrealKV supports historical/temporal querying using the `VERSION` clause when [selecting](../../../query-language/statements/select.md#the-version-clause) data, you must explicitly opt in to this using the `surrealkv+versioned://` prefix in the path argument.
