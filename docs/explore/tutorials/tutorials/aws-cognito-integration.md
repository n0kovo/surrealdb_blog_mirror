...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/tutorials/tutorials/aws-cognito-integration.mdx"
---
...
- Define user-level authorization using SurrealDB [record users](../../../learn/security/authentication/users.md#record-users).
...
To understand how revocation is handled by SurrealDB, read the [JSON Web Key Set documentation](../../../reference/query-language/statements/define/token.md#json-web-key-set-jwks) under `DEFINE TOKEN`.
