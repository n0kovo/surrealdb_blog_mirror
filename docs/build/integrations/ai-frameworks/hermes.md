...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/integrations/ai-frameworks/hermes.mdx"
---
...
> [!NOTE]
> This page covers **SurrealDB filesystem** on a SurrealDB instance you run. For hosted memory with fact extraction and semantic recall, see the [SurrealDB Agent Memory integration for Hermes](../../../agent-memory/integrations/frameworks/hermes.md), which is a separate provider.

## Requirements

- Python 3.12+
- A SurrealDB 3.x server, [installed locally](../../../running/installation/index.md) or on [SurrealDB Cloud](../../../manage/instances/index.md)
- A Hermes install
...
Start SurrealDB with a persistent backend, either [installed directly](../../../running/installation/index.md):
...
> [!WARNING]
> `hermes backup` captures none of this. It walks `HERMES_HOME`, and the memories are in SurrealDB. Use [`surreal export`](../../../reference/cli/surrealdb-cli/commands/export.md) instead.
...
Point the agents at a shared SurrealDB, a [Cloud instance](../../../manage/instances/index.md) for example, and everyone on the team can run the file browser on their own machine to see and edit the same tree the agents write to:
...
- [SurrealDB Agent Memory integration for Hermes](../../../agent-memory/integrations/frameworks/hermes.md) - hosted memory with fact extraction and semantic recall, as an alternative provider
