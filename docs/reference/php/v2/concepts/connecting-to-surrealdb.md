...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/php/v2/concepts/connecting-to-surrealdb.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/reference/php/v2/api/core#connect"> ` $db->connect($url, $options) `</a></td>
            <td scope="row" data-label="Description">Connects to a local or remote database endpoint</td>
        </tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/reference/php/v2/api/core#close"> ` $db->close() `</a></td>
            <td scope="row" data-label="Description">Closes the connection to the database</td>
        </tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/reference/php/v2/api/core#use"> ` $db->use($namespace, $database) `</a></td>
            <td scope="row" data-label="Description">Switches to a specific namespace and database</td>
        </tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/reference/php/v2/api/core#status"> ` $db->status() `</a></td>
