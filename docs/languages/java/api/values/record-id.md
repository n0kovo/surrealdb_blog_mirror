...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/java/api/values/record-id.mdx"
---

# `RecordId` {#record-id}

A `RecordId` uniquely identifies a record in SurrealDB. It consists of a table name and an ID value. The ID can be a `long`, `String`, `UUID`, or a composite key using `Array` or `Object`. See the [SurrealQL record ID documentation](../../../../reference/query-language/language-primitives/data-types/record-ids.md) for details on how record identifiers work in SurrealDB.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>`Id`</td>
            <td>The start of the range. Pass `null` for an unbounded start.</td>
        </tr>
        <tr>
            <td>`end` *[optional]*</td>
            <td>`Id`</td>
            <td>The end of the range. Pass `null` for an unbounded end.</td>
        </tr>
    </tbody>
</table>
...
- [SurrealQL record IDs](../../../../reference/query-language/language-primitives/data-types/record-ids.md) — Record identifier formats and types
