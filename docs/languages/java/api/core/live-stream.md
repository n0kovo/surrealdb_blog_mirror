...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/java/api/core/live-stream.mdx"
---
...
- [SurrealQL LIVE SELECT](../../../../reference/query-language/statements/live-select.md) — Live query syntax
