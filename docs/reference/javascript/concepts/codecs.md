...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/concepts/codecs.mdx"
---
...
The CBOR layout uses SurrealDB's tagged values. See the [CBOR protocol reference](../../rest-api/cbor-protocol.md) for the tag list.
...
- [CBOR protocol reference](../../rest-api/cbor-protocol.md) for the full CBOR tag specification
