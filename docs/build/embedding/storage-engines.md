...
How to choose: start from your hosting model (embedded, single server, cluster) and read the architecture overview for [storage layers](../../architecture.md#storage-layer). Then follow the embedding guides for your language under [embedding SurrealDB](index.md) for what your SDK supports today—capabilities vary by platform and release.
