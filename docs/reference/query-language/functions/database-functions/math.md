...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Constant"><a href="#mathinfinity">`math::infinity`</a></td>
    ...
    <tr>
      <td scope="row" data-label="Constant"><a href="#mathneg_infinity">`math::neg_infinity`</a></td>
