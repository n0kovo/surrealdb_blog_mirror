...
Let's look at some examples of how to use the `UPDATE` statement. First we'll create two `person` records with the [`CREATE`](create.md) statement so that the examples will produce a meaningful output.
