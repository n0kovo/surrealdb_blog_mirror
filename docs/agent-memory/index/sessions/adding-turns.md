...
6. **Reconciliation** – compares newly extracted facts against existing memory. Facts that contradict prior records are resolved and a correction record is produced. See [Reconciliation and supersession](https://surrealdb.com/docs/agent-memory/reasoning/reconciliation-and-supersession) for the full correction model.
