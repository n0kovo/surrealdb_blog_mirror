...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/api/errors/index.mdx"
---
...
- [SurrealSession](../core/surreal-session.md) - Session methods that may throw errors
