...
For **metrics and distributed traces**, enable OpenTelemetry as described in [Observability](../../build/deployment/observability/observability.md): set the telemetry provider to OTLP and point exporters at your collector.
