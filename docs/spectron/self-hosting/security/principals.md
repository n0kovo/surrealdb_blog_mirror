...
- Cannot append turns to a session whose scope falls outside the key's **`memory:write`** region (see [Creating sessions](../../agent-memory/sessions/creating-sessions.md#session-write-access)).
...
- [Scope as a security boundary](scope-as-security-boundary.md) – how scope floors are enforced
