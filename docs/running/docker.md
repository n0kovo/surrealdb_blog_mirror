...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/running/docker.mdx"
---
...
With the server container running and port `8000` published, connect to it with the [`surreal sql`](../reference/cli/surrealdb-cli/commands/sql.md) command from the same image. This starts a SurrealQL REPL against the server, using the credentials from the authentication step above.
