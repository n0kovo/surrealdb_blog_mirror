...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/swift/installation.mdx"
---
...
See the [getting started guide](start.md) to connect to a database and run your first query.
