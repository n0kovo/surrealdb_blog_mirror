...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/python/api/values/range.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td>`value`</td>
            <td>`<a href="/docs/languages/python/api/values/#value">Value</a>`</td>
