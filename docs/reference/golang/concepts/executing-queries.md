...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/golang/concepts/executing-queries.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Function"><a href="/docs/reference/golang/api/core/db#query">`surrealdb.Query[T](ctx, s, sql, vars)`</a></td>
			<td scope="row" data-label="Description">Executes a SurrealQL query with typed results</td>
		</tr>
		<tr>
			<td scope="row" data-label="Function"><a href="/docs/reference/golang/api/core/db#queryraw">`surrealdb.QueryRaw(ctx, s, queries)`</a></td>
			<td scope="row" data-label="Description">Executes a batch of query statements with per-statement results</td>
		</tr>
		<tr>
			<td scope="row" data-label="Function"><a href="/docs/reference/golang/api/core/db#let">`db.Let(ctx, key, val)`</a></td>
			<td scope="row" data-label="Description">Defines a variable on the connection for use in queries</td>
		</tr>
		<tr>
			<td scope="row" data-label="Function"><a href="/docs/reference/golang/api/core/db#unset">`db.Unset(ctx, key)`</a></td>
...
- [SurrealQL statements](../../query-language/statements/overview.md) for the query language syntax
