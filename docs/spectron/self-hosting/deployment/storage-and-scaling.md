...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/self-hosting/deployment/storage-and-scaling.mdx"
---
...
See [Cost and rate limits](../observability/cost-and-rate-limits.md) for monitoring and controlling LLM spend.

## Next steps

- [Architecture overview](architecture-overview.md) – component diagram
- [Kubernetes](kubernetes.md) – production deployment with HPA
- [Cost and rate limits](../observability/cost-and-rate-limits.md) – token budgets and rate limiting
