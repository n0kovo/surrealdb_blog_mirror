...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/ai-sdks/cloudflare-workers-ai.mdx"
---

# Cloudflare Workers AI

A Cloudflare Worker can run a model with [Workers AI](https://developers.cloudflare.com/workers-ai/) and back it with Spectron memory in the same request. The [JavaScript SDK](../sdks/javascript-and-typescript.md) (`@surrealdb/spectron`) uses platform `fetch` and ships no runtime dependencies, so it runs on the Workers runtime unchanged.
...
- [REST API](../surfaces/rest.md): calling Spectron over HTTP without the SDK
