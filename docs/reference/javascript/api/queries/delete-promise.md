...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/delete-promise.mdx"
---
...
**Returned by:** [`SurrealQueryable.delete()`](../core/surreal-queryable.md#delete)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`Output`</td>
            <td>`"NONE"`, `"BEFORE"`, or specific field list.</td>
        </tr>
    </tbody>
</table>
