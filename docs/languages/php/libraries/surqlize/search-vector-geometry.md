...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/libraries/surqlize/search-vector-geometry.mdx"
---
...
- [Models](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/models) for the `#[Search]`, `#[Vector]`, and `#[Geometry]` attributes
- [Schema](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/schema) to define search analysers and vector indexes
- [Querying](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/querying) for the query builder these helpers plug into
