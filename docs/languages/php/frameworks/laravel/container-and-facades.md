...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/frameworks/laravel/container-and-facades.mdx"
---
...
| `query($query, $connection?)` | Run a [`BoundQuery`](../../v2/api/utilities.md#boundquery) |
...
| `fake()` / `assertSurrealQuerySent()` / `resetFakes()` | [Testing](testing.md) helpers |
...
Resolves the underlying SDK [`Surreal`](../../v2/api/core.md) client for direct, lower-level access.
...
| `transaction($callback, $executor?, $connection?)` | Run a [transaction](queries-and-transactions.md#transactions) |
...
- [Configuration](configuration.md) for the settings these bindings read
- [Queries and transactions](queries-and-transactions.md) for using the facades
- [Testing](testing.md) for the fake executor
