...
Like table permissions, field permissions apply to [record users](../../security/authentication/users.md#record-users) (and guests when enabled), not to system users.
