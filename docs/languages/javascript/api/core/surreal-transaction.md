...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/api/core/surreal-transaction.mdx"
---
...
Transactions are created using the [`beginTransaction()`](surreal-session.md#begintransaction) method on a [`SurrealSession`](surreal-session.md) instance.
