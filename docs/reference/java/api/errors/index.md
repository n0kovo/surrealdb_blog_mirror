...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/java/api/errors/index.mdx"
---
...
Thrown when a SurrealQL [`THROW`](../../../query-language/statements/throw.md) statement is executed. Extends `ServerException`. No additional methods.
