...
In the following example, you can see the result of the `SELECT * FROM $session` query in an authenticated session for a record user using the [HTTP REST API](../../../reference/rest-api/http-protocol.md):
