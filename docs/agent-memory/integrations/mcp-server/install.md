...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/mcp-server/install.mdx"
---
...
- [Claude Desktop and Claude Code](coding-assistants/claude-desktop-and-code.md)
