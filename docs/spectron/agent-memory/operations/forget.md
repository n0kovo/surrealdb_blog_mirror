...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/operations/forget.mdx"
---
...
| Retire a scope folder in the vocabulary only | **`scope:delete`** (tombstone the scope node) | Tombstone is soft — distinct from erasing facts; see [Contexts and scope](https://surrealdb.com/docs/spectron/mental-model/contexts-and-scope#tombstone-vs-erase) |
