...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/querying/real-time/live-queries.mdx"
---
...
That fits interactive UIs, dashboards, and small collaboration features. For replaying history or catching up a batch pipeline, use [changefeeds](changefeeds.md) and `SHOW CHANGES` instead.

The full grammar and edge cases live under [`LIVE SELECT`](../../../reference/query-language/statements/live-select.md) in the reference. Below is how to think about subscriptions and what to watch for in production.

## Starting a subscription

By default, creates and updates deliver the full record; deletes return nothing unless you add a clause like `RETURN BEFORE`. You receive a UUID as soon as the live query is registered. This UUID can later be passed in to a [`KILL`](../../../reference/query-language/statements/kill.md) statement when you want to stop.
