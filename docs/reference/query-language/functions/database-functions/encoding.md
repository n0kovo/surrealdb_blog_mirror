...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/functions/database-functions/encoding.mdx"
---
  ...
  <tbody>
    <tr>
      <td scope="row" data-label="Function">
        <a href="#encodingbase64decode">`encoding::base64::decode()`</a>
      </td>
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#encodingbase64encode">`encoding::base64::encode()`</a>
      </td>
      <td scope="row" data-label="Description">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#encodingcbordecode">`encoding::cbor::decode()`</a>
      </td>
      <td scope="row" data-label="Description">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#encodingcborencode">`encoding::cbor::encode()`</a>
      </td>
      <td scope="row" data-label="Description">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#encodingjsondecode">`encoding::json::decode()`</a>
      </td>
      <td scope="row" data-label="Description">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#encodingjsonencode">`encoding::json::encode()`</a>
      </td>
      <td scope="row" data-label="Description">
