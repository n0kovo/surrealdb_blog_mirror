...
description: Initialise the SurrealDB PHP SDK, connect to an instance, and select a namespace and database.
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/php/v1/concepts/connecting.mdx"
---

# Connecting to SurrealDB

This guide shows how to initialise version 1 of the SurrealDB PHP SDK and connect to an instance. If you have not installed the SDK yet, see the [installation guide](../installation.md).
