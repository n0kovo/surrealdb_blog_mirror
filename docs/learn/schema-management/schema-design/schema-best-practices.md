...
Error types in programming languages often take the form of a long list of possible things that could go wrong. SurrealQL's [literal](../../../reference/query-language/language-primitives/data-types/literals.md) type allows you to specify a list of all possible forms it could take, making it the perfect type for error logic.
