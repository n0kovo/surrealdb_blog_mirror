...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/observability/agentops.mdx"
---

# AgentOps

[AgentOps](https://www.agentops.ai/) monitors AI agents: session replay, LLM cost tracking, and tool-call telemetry across most agent frameworks. It is complementary to Spectron: AgentOps observes the run, while Spectron gives the agent memory. This guide uses both together with the [Python SDK](../sdks/python.md) (`surrealdb`).
...
- [Agent frameworks](../frameworks/crewai.md): AgentOps also instruments CrewAI, AutoGen, and others that have first-party Spectron adapters
