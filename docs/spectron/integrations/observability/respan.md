...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/observability/respan.mdx"
---

# Respan

[Respan](https://www.respan.ai/) is an LLM engineering platform: tracing, evals, and a gateway across many model providers. It is complementary to Spectron: Respan observes and evaluates your agent, while Spectron gives it memory. This guide runs the two together with the [Python SDK](../sdks/python.md) (`surrealdb`).
...
- [Traces](../../reference/rest-api.md): Spectron's own decision traces, correlated by `traceId`
