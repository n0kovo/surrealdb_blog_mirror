...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/rest-api/errors.mdx"
---
...
A failed statement does not stop the ones after it, and does not roll back the ones before it. Statements are independent unless a [transaction](../query-language/statements/begin.md) makes them otherwise.
...
- [Rust](../rust/concepts/error-handling.md)
- [JavaScript](../javascript/concepts/error-handling.md)
- [Python](../python/concepts/error-handling.md)
- [Go](../golang/concepts/error-handling.md)
- [Java](../java/concepts/error-handling.md)
- [Kotlin](../kotlin/concepts/error-handling.md)
- [PHP](../php/v2/concepts/error-handling.md)
- [Mojo](../mojo/concepts/error-handling.md)
