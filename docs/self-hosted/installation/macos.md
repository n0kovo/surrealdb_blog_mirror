...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/self-hosted/installation/macos.mdx"
---

# Install on macOS

Both the SurrealDB database server and the [command-line tool](../../reference/cli/surrealdb-cli/overview.md) are packaged as a single executable file. You can install via the [install script](https://github.com/surrealdb/install.surrealdb.com) or the [Homebrew](https://brew.sh/) package manager.
