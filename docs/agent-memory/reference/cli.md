...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/reference/cli.mdx"
---
...
For a full provisioning walkthrough (bootstrap, scopes, principals, keys, upload, query), follow the [Hosted quickstart](https://surrealdb.com/docs/agent-memory/quickstarts/hosted) and [CLI](#connection-flags-client) reference below.
