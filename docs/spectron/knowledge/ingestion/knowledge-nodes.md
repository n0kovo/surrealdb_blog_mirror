...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/knowledge/ingestion/knowledge-nodes.mdx"
---
...
| Warehouse sync (future) | [Connectors](../connectors/overview.md) → `/documents` or `/facts/batch` |
...
See [Cross-layer linking](../retrieval/cross-layer-linking.md).
