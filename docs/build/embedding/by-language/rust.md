...
For complete documentation, installation instructions, examples, best practices, and troubleshooting, see the [Rust SDK embedding guide](../../../reference/rust/embedding.md).
