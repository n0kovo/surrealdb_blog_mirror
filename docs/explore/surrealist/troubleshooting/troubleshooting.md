...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/surrealist/troubleshooting/troubleshooting.mdx"
---
...
- **Connect using the CLI**: Since Surrealist always runs in a secure environment, localhost or LAN connections may be blocked by a variety of reasons. Try connecting to the database using the [CLI](../../../reference/cli/surrealdb-cli/overview.md) to see if the issue persists, as this is not subject to the same restrictions.
