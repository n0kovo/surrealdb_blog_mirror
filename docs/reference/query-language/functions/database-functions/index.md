	...
	<tr>
		...
		<tr>
			...
			<td scope="row" data-label="Description and Example">
				...
				Example: `encoding::cbor::encode({'foo': 'bar'})`
			</td>
		</tr>
		<tr>
			<td scope="row" data-label="Function">
...
You can also write your own functions in Rust that can be compiled to WASM modules, linked to, and called from the database. For more on how extensions are built and run, see [Extensions](../../../../learn/extensions/index.md).
