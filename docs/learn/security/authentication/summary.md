...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/security/authentication/summary.mdx"
---
...
- [Security: Capabilities](../authorization/capabilities.md)
...
- [Statement: DEFINE TABLE](../../../reference/query-language/statements/define/table.md#defining-permissions)
- [Statement: DEFINE FIELD](../../../reference/query-language/statements/define/field.md#setting-permissions-on-fields)
...
- [Tutorial: Integrate Auth0 as an authentication provider](https://surrealdb.com/docs/tutorials/integrate-auth0-as-authentication-provider)
- [Tutorial: Integrate AWS Cognito as an authentication provider](https://surrealdb.com/docs/tutorials/integrate-aws-cognito-as-authentication-provider)
- [Security Best Practices: JSON Web Tokens](../best-practices/security-best-practices.md#json-web-tokens)
- [Security Best Practices: Expiration](../best-practices/security-best-practices.md#expiration)
...
- [Security Best Practices: Expiration](../best-practices/security-best-practices.md#expiration)
- [Interfaces: RPC (Authenticate)](https://surrealdb.com/docs/reference/rest-api/rpc#authenticate)
...
- [string::html::encode() function](../../../reference/query-language/functions/database-functions/string.md#stringhtmlencode)
- [string::html::sanitize() function](../../../reference/query-language/functions/database-functions/string.md#stringhtmlsanitize)
- [Security Best Practices: Content Safety](../best-practices/security-best-practices.md#content-safety)
...
- [CLI Start command](../../../reference/cli/surrealdb-cli/commands/start.md)
- [Security Best Practices: Encryption in Transit](../best-practices/security-best-practices.md#encryption-in-transit)
