...
Generated clients are published as **`surrealdb-spectron`** (Python) and **`@surrealdb/spectron`** (TypeScript). See [Integrations](../../integrations/index.md) and the [REST API](../../reference/rest-api.md) for the full surface.
