...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/concepts/multiple-sessions.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal#newsession"> ` db.newSession() `</a></td>
			<td scope="row" data-label="Description">Creates a new isolated session on the connection</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-session#forksession"> ` session.forkSession() `</a></td>
			<td scope="row" data-label="Description">Creates a copy of a session, inheriting its state</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-session#closesession"> ` session.closeSession() `</a></td>
			<td scope="row" data-label="Description">Destroys a session and releases its resources</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-session#reset"> ` session.reset() `</a></td>
...
> [!NOTE]
> Using a session after it has been closed throws an [`InvalidSessionError`](../api/errors/index.md#invalidsessionerror).
...
Sessions that were authenticated via `.signin()` or `.signup()` rely on the [`auth`](../api/core/surreal-session.md#event-auth) event for re-authentication. See [Authentication](authentication.md#listening-to-authentication-events) for details.
...
- [SurrealSession API reference](../api/core/surreal-session.md) for the full session interface
- [Surreal.newSession()](../api/core/surreal.md#newsession) for session creation details
- [Authentication](authentication.md) for session-level authentication
- [Transactions](transactions.md) for atomic operations within sessions
