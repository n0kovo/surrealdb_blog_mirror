...
slug: "surrealdb-3-x-by-the-numbers"
date: "2026-05-29T13:45:37.000Z"
categories:
  - "engineering"
  - "company"
  - "featured"
read_time: "10 min read"
summary: "Fresh SurrealDB 3.x benchmarks: 141k ops\\/s CRUD, scans 164× faster than 2.x, and head-to-head numbers vs. Postgres, Mongo, Neo4j, and Redis."
source: "https://surrealdb.com/blog/surrealdb-3-x-by-the-numbers"
cover: "../../assets/42d5fcbd283ab06c.jpg"
---

# SurrealDB 3.x by the numbers

![SurrealDB 3.x by the numbers](../../assets/42d5fcbd283ab06c.jpg)

## One engine, multi-workloads, full durability.

You can explore the full results, methodology, and per-database breakdowns at [surrealdb.com/benchmarks](https://surrealdb.com/benchmarks).
...
1. Ran every database on the same hardware - an AMD Ryzen Threadripper 9970X (32C/64T), 128 GiB DDR5, NVMe storage, Ubuntu 24.04.
1. Used the same open-source harness - crud-bench - with each workload translated into each engine's native query language so no database is penalised for an unfamiliar dialect.
1. Configured every engine for production-grade durability - fsync on, snapshot isolation, no in-memory shortcuts (except where explicitly noted for embedded comparisons).
...
The full breakdowns - including p50, p95, and p99 latencies, batch sizes from 100 to 1,000 rows, indexed and non-indexed predicate filters, and full-text search - are on the [benchmarks page](https://surrealdb.com/benchmarks).
...
[See the full benchmarks →](https://surrealdb.com/benchmarks)
