...
| [DISKANN](https://arxiv.org/abs/1907.01668) ([`DEFINE INDEX … DISKANN`](../../../reference/query-language/statements/define/indexes.md#diskann-disk-based-approximate-nearest-neighbours)) *(SurrealDB 3.1+)* | Very large corpora where RAM cannot hold the full graph — optimises for **disk-resident** graphs and quantisation-friendly types | On-disk graph with caching (not on **WASM** targets) |
