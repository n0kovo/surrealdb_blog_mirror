...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/tutorials/demos/blink.mdx"
---
...
If you want more guided walkthroughs in the same spirit, browse the [tutorials](../tutorials/overview.md) and [demos](overview.md) sections.
