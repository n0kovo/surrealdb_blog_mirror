...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/frameworks/camel-ai.mdx"
---

# Camel AI

[Camel AI](https://www.camel-ai.org/) is a multi-agent framework for Python. Spectron gives its `ChatAgent`s shared long-term memory across runs and agents. There is no dedicated adapter. The [Python SDK](../sdks/python.md) (`surrealdb`) supplies the memory operations, either as tools or wrapped around each step.
