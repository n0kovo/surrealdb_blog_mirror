...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/sdks/go.mdx"
---
...
`GET` requests and idempotent writes retry on connection errors and 5xx responses (default 3 attempts); other writes do not. See the [REST API](../../reference/rest-api.md) for the full contract.
