...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/surrealctl/install.mdx"
---
...
For what the two credential kinds are and how to use a token in CI, see [Authentication](authentication.md).
...
`instance sql`, `instance import`, and `instance export` hand off to the `surreal` binary. Install it the [usual way](../../running/installation/index.md) and `surrealctl` finds it on your `PATH`.
...
- [Authentication](authentication.md) — login sessions, personal access tokens, and CI credentials.
- [Instances](instances.md) — your first real workflow.
- [`surrealctl` reference](../../reference/cli/surrealctl/overview.md) — every command and flag.
