...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/integrations/ai-frameworks/langchain.mdx"
---

# Langchain

[LangChain](https://python.langchain.com/docs/introduction/) is a framework for developing applications powered by large language models (LLMs). SurrealDB is an excellent database choice for [LangChain](https://python.langchain.com/docs/introduction/) projects primarily because of its [multi-model capabilities](../../../learn/data-models/index.md), which streamline data management by requiring only a single database.

This unified system adeptly handles structured and unstructured data, incorporating vector search, [graph traversal](../../../learn/data-models/graph/overview.md), [relational queries](../../../learn/data-models/index.md), [full-text search](../../../learn/data-models/full-text-search/overview.md), [document storage](../../../learn/data-models/document/overview.md), and [time-series data](../../../learn/data-models/time-series/overview.md) all within one ACID-compliant engine. 
...
* Explore the [SurrealDB vector-search reference](../../../learn/data-models/vector-search/overview.md) for detailed technical information
