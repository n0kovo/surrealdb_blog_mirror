...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/self-hosted/installation/linux.mdx"
---

# Install on Linux

Both the SurrealDB database server and the [command-line tool](../../reference/cli/surrealdb-cli/overview.md) are packaged as a single executable file.
