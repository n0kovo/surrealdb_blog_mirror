...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/rust/concepts/transaction.mdx"
---
...
While every query in SurrealDB is run [inside its own transaction](../../../reference/query-language/language-primitives/transactions.md), manual transactions made up of multiple statements can be used via the [BEGIN](../../../reference/query-language/statements/begin.md) and [COMMIT](../../../reference/query-language/statements/commit.md) keywords.
...
To avoid the possibility of typos, the [`.set()`](../methods/set.md) method can be used to set the amount to transfer.
