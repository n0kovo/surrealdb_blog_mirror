...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/instances/connect/via-sdk.mdx"
---
...
> [!NOTE]
> This step applies when the SDK calls `signin` on connection. Skip it if the application authenticates some other way. See [access methods](../../../reference/query-language/statements/define/access/index.md) and [system users](../../../reference/query-language/statements/define/user.md).
