...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/rust/embedding.mdx"
---
...
Open `src/main.rs` and replace everything in there with the following code to try out some basic operations using the SurrealDB SDK with an embedded database. Look at [integrations to connect to a database](overview.md).
...
<table>
    ...
    <tbody>
        <tr>
            <td scope="row" data-label="Function"><a href="#init">`Surreal::init()`</a></td>
            <td scope="row" data-label="Description">Initialises a static database engine</td>
        </tr>
        <tr>
            <td scope="row" data-label="Function"><a href="#connect">`db.connect(endpoint)`</a></td>
