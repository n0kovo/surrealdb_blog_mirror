...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/statements/define/table.mdx"
---
...
> [!NOTE]
> The fields of a table are not defined using `DEFINE TABLE`, but via individual [`DEFINE FIELD`](field.md) statements.
...
- [You must select your namespace and database](../use.md) before you can use the `DEFINE TABLE` statement.
...
```
                                   ...
                                   │                                            │                              │                      │ │                                                                                                                                                   │ │                                                                                                                    │                                                │ │                                                                                                                                                                                          │                                                                          │                                                                                                                                     
                                   │               ╭───────────╮                │                              │    ╭────────────╮    │ │                                                                             ╭─────╮                                                               │ │                                                                                                                    │                     ╭────╮     ┌─────────┐     │ │ ╭─────────────────────────────────────────────────────────────────────────────╮                                                                                                          │                                           ╭──────╮                       │                                                                                                                                     
                                   │ ╭─────────────│ OVERWRITE │──────────────╮ │                              │ ╭──│ SCHEMAFULL │──╮ │ │               ╭─────────────────────────────────────────────────────────────│ ANY │─────────────────────────────────────────────────────────────╮ │ │                                                                                                                    │                ╭────│ BY │─────│ @groups │───╮ │ │ │                                                                             │                                                                                                          │                      ╭────────────────────│ NONE │─────────────────────╮ │                                                                                                                                     
                                   │ │             ╰───────────╯              │ │               ╭────────────╮ │ │  ╰────────────╯  │ │ │               │                                                             ╰─────╯                                                             │ │ │                                                                              ╭───────────────────────────────────╮ │                │    ╰────╯     └─────────┘   │ │ │ │                                       ╭───────────────────────────────────╮ │ ╭───────────────────────────────────────────────╮ ╭────────────────────────────────────────────────────╮ │                      │                    ╰──────╯                     │ │ ╭──────────────────────────────────╮ ╭────────────────────────────────────────╮ ╭─────────────────────────────────────────────╮     
                                   │ │                                        │ │               │            │ │ │                  │ │ │               │                                                                                                                                 │ │ │                                                                              │                                   │ │                │                             │ │ │ │                                       │                                   │ │ │                                               │ │                                                    │ │                      │                                                 │ │ │                                  │ │                                        │ │                                             │     
        ╭────────╮     ╭───────╮   │ │    ╭────╮     ╭─────╮     ╭────────╮   │ │   ┌───────┐   │  ╭──────╮  │ │ │  ╭────────────╮  │ │ │    ╭──────╮   │                                                           ╭────────╮                                                            │ │ │    ╭────╮     ╭────────╮     ┌──────────────┐     ╭──────╮     ┌─────────┐   │    ╭───────╮     ┌────────────┐   │ │    ╭───────╮   │           ╭─────╮           │ │ │ │    ╭────────────╮     ┌───────────┐   │    ╭─────────╮     ╭──────────╮   │ │ │    ╭────────╮     ╭───────╮     ┌─────────┐   │ │    ╭────────╮     ╭────────────╮     ┌─────────┐   │ │    ╭─────────────╮   │                    ╭──────╮                     │ │ │    ╭─────────╮     ┌─────────┐   │ │    ╭───────────────╮     ┌─────────┐   │ │    ╭────────────────────╮     ┌─────────┐   │     
├┼──────│ DEFINE │─────│ TABLE │───╯─╯────│ IF │─────│ NOT │─────│ EXISTS │───╰─╰───│ @name │───╯──│ DROP │──╰─╯─╯──│ SCHEMALESS │──╰─╰─╯────│ TYPE │───┼───────────────────────────────────────────────────────────│ NORMAL │────────────────────────────────────────────────────────────┼─╰─╯────│ AS │─────│ SELECT │─────│ @projections │─────│ FROM │─────│ @tables │───╯────│ WHERE │─────│ @condition │───╰─╯────│ GROUP │───╯───────────│ ALL │───────────╰─╰─╰─╯────│ CHANGEFEED │─────│ @duration │───╯────│ INCLUDE │─────│ ORIGINAL │───╰─╰─╯────│ INLINE │─────│ EDGES │─────│ @number │───╰─╯────│ INLINE │─────│ REFERENCES │─────│ @number │───╰─╯────│ PERMISSIONS │───┼────────────────────│ FULL │─────────────────────┼─╰─╯────│ COMMENT │─────│ @string │───╰─╯────│ GRAPHQL_ALIAS │─────│ @string │───╰─╯────│ GRAPHQL_DEPRECATED │─────│ @string │───╰───┼┤
        ╰────────╯     ╰───────╯          ╰────╯     ╰─────╯     ╰────────╯         └───────┘      ╰──────╯         ╰────────────╯           ╰──────╯   │                                                           ╰────────╯                                                            │        ╰────╯     ╰────────╯     └──────────────┘     ╰──────╯     └─────────┘        ╰───────╯     └────────────┘          ╰───────╯               ╰─────╯                      ╰────────────╯     └───────────┘        ╰─────────╯     ╰──────────╯            ╰────────╯     ╰───────╯     └─────────┘          ╰────────╯     ╰────────────╯     └─────────┘          ╰─────────────╯   │                    ╰──────╯                     │        ╰─────────╯     └─────────┘          ╰───────────────╯     └─────────┘          ╰────────────────────╯     └─────────┘         
                                                                                                                                                        │                                                                                                                                 │                                                                                                                                                                                                                                                                                                                                                                                             │                                                 │                                                                                                                                       
                                                                                                                                                        │                   ╭────────────────────────────────╮ ╭───────────────────────────────╮                                          │                                                                                                                                                                                                                                                                                                                                                                                             │    ╭─────╮     ╭────────╮     ┌─────────────┐   │                                                                                                                                       
                                                                                                                                                        │                   │                                │ │                               │                                          │                                                                                                                                                                                                                                                                                                                                                                                             ╰────│ FOR │─────│ select │─────│ @expression │───╯                                                                                                                                       
...
Nevertheless, [`DEFINE EVENT`](event.md) is the preferred option for this. An event is evaluated with the caller's own permissions, states the side effect where a reader expects to find it, and does not run on every access check.

The check runs where the write is reached, so it is exact however the write is arrived at - written into the clause directly, reached through a [custom function](function.md), or through `eval`, a script or a closure passed as data. Call depth and indirection make no difference to it.
...
This is the behaviour that the [unique-key pattern](../relate.md#handling-duplicate-edge-record-ids) builds by hand on a classic relation, using a composite id or a field plus a unique index. `LIGHTWEIGHT` makes it a property of the table, with no index to define and keep in step.
...
- Changing or removing a cap, with `DEFINE TABLE OVERWRITE` or [`ALTER TABLE`](../alter/table.md#inline-edges-and-inline-references), discards the table's existing caches of that kind, which are then rebuilt as edges or references are written.
- A traversal over a range of edge record IDs (`->likes:a..b`), a `VERSION` query, and a filter on an [`INLINE` field](field.md#using-inline-to-filter-a-traversal-during-the-scan) read the keys rather than the cache.
