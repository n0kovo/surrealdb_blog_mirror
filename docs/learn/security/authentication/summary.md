...
- [Statement: DEFINE TABLE](../../../reference/query-language/statements/define/table.md)
- [Statement: DEFINE FIELD](../../../reference/query-language/statements/define/field.md)
...
- [Interfaces: Rust SDK (Query Method)](https://surrealdb.com/docs/languages/rust/setup#query)
