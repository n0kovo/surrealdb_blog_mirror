...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/frameworks/agno.mdx"
---

# Agno

[Agno](https://www.agno.com/) is a high-performance Python framework for building agents. SurrealDB Agent Memory adds long-term memory that persists across sessions and agents. There is no dedicated adapter. The [Python SDK](../sdks/python.md) (`surrealdb`) exposes the memory operations you attach as Agno tools.
