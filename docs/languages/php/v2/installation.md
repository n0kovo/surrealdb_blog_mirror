...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/v2/installation.mdx"
---
...
- [Quickstart](start.md) to connect and run your first queries
