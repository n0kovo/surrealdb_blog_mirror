...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/mojo/methods/set.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">The parameter name, without the leading `$`.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Argument">`value_cbor`</td>
            <td colspan="2" scope="row" data-label="Description">The value, CBOR-encoded as a `List[UInt8]`.</td>
        </tr>
        <tr>
