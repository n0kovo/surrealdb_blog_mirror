...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/tuning/ontology-grounding.mdx"
---
...
This matters more than it looks: the type is half an entity's identity, so an invented type silently produces a second entity. See [Entity matching](../reasoning/reconciliation-and-supersession.md#entity-matching).
...
- [Reconciliation and supersession](../reasoning/reconciliation-and-supersession.md) — exact-key entity matching, and why nicknames fragment
- [Storing memories](../ingest/experiential/remember.md) — `infer` modes, including caller-supplied triples
- [Extraction pipeline](../reasoning/extraction-pipeline.md) — where extraction sits in ingest
