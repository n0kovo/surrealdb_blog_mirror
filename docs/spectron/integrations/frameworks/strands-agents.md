...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/frameworks/strands-agents.mdx"
---
...
- To call Spectron directly, use the [Python SDK](../sdks/python.md).
