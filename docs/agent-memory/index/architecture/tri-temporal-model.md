...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/index/architecture/tri-temporal-model.mdx"
---
...
Together with [provenance](https://surrealdb.com/docs/agent-memory/mental-model/provenance-and-traceability) and the **single reconciler** ([Eight pillars](https://surrealdb.com/docs/agent-memory/architecture/eight-pillars-and-categories)), this supports a defensible audit story: unwind any current fact to what it replaced, to the source that produced it, and to the exact quote in that source – and rewind the database by system time while still querying belief history on known time.

Field-level detail: [Temporal validity](https://surrealdb.com/docs/agent-memory/reasoning/temporal-validity) and [Reconciliation and supersession](https://surrealdb.com/docs/agent-memory/reasoning/reconciliation-and-supersession).
