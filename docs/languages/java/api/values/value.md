...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/java/api/values/value.mdx"
---
...
| `getGeometry()` | [`Geometry`](geometry.md) |
| `getDateTime()` | `ZonedDateTime` |
| `getDuration()` | `Duration` |
| `getBytes()` | `byte[]` |
| `getRecordId()` | [`RecordId`](record-id.md) |
| `getFile()` | [`FileRef`](file-ref.md) |
