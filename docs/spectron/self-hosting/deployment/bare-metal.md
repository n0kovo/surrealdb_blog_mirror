...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/self-hosting/deployment/bare-metal.mdx"
---
...
Pull the new container image, extract `spectrond` again (same steps as above), replace `/usr/local/bin/spectrond`, and restart the service. Pending per-Context schema migrations are applied asynchronously by the scheduler and workers — see [Migrations and upgrades](../operations/migrations-and-upgrades.md).
...
- [Storage and scaling](storage-and-scaling.md) – configuring object store backends
- [Authentication](../security/authentication.md) – key management after initial setup
