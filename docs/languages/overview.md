...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/overview.mdx"
---
...
- [JavaScript and TypeScript](javascript/start.md)
- [Python](python/start.md)
- [Rust](rust/start.md)
- [Java](java/start.md)
- [Go](golang/start.md)
