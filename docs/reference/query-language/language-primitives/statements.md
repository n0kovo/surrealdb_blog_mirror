...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/language-primitives/statements.mdx"
---
...
For a grouped catalogue of every statement and links to full reference pages, see [SurrealQL statements overview](../statements/overview.md).
