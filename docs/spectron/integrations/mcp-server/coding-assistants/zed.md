...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/mcp-server/coding-assistants/zed.mdx"
---
...
For integration rules your agent should follow (auth, scope, endpoints, common mistakes), see **[Agent guide (AGENTS.md)](../../../reference/agents.md)**. Zed reads a project `AGENTS.md` automatically.
