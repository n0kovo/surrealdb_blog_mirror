...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/deployment/surrealdb-cloud/operations/network-access.mdx"
---

## Network access

Network access is a type of [Instance capability](../getting-started/create-an-instance.md#instance-capabilities) that allows you to control and manage how your SurrealDB Cloud Instance connects to external services and networks through [HTTP functions and requests](../../../../reference/query-language/functions/database-functions/http.md). This capability enables you to make HTTP calls to external APIs and services directly from your database queries while maintaining control over which endpoints can be accessed.
...
![Configure an Instance](../../../../assets/img/image/cloud/network-access.png)
