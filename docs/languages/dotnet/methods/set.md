...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/dotnet/methods/set.mdx"
---
...
You can remove the variable from the connection using the [`Unset()` method](unset.md).
