...
Calibration stores **`attribute.confidence`** (reconciler posterior) **separately** from `source.trust`. See [Surface, models, and security](https://surrealdb.com/docs/spectron/architecture/surface-security-and-models) for the model-hook story.
