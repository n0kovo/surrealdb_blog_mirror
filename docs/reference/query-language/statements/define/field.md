...
```
                                   ...
                                   │ │                                        │ │                          │             │                │  │                │                            │ │                    │ │                                                             │ │ │ │                  │              │                     │ │                │ │                                    │ │                                     │ │                      │                                                 │ │ │                                  │     
        ╭────────╮     ╭───────╮   │ │    ╭────╮     ╭─────╮     ╭────────╮   │ │   ┌───────┐     ╭────╮   │  ╭───────╮  │   ┌────────┐   │  │  ╭──────────╮  │   ╭──────╮     ┌───────┐   │ │    ╭───────────╮   │ │            ╭────╮     ╭────────╮     ╭─────────╮            │ │ │ │    ╭─────────╮   │  ╭────────╮  │   ┌─────────────┐   │ │  ╭──────────╮  │ │    ╭───────╮     ┌─────────────┐   │ │    ╭────────╮     ┌─────────────┐   │ │    ╭─────────────╮   │                    ╭──────╮                     │ │ │    ╭─────────╮     ┌─────────┐   │     
├┼──────│ DEFINE │─────│ FIELD │───╯─╯────│ IF │─────│ NOT │─────│ EXISTS │───╰─╰───│ @name │─────│ ON │───╯──│ TABLE │──╰───│ @table │───╯──╯──│ FLEXIBLE │──╰───│ TYPE │─────│ @type │───╰─╯────│ REFERENCE │───╯─┼────────────│ ON │─────│ DELETE │─────│ CASCADE │────────────┼─╰─╰─╯────│ DEFAULT │───╯──│ ALWAYS │──╰───│ @expression │───╰─╯──│ READONLY │──╰─╯────│ VALUE │─────│ @expression │───╰─╯────│ ASSERT │─────│ @expression │───╰─╯────│ PERMISSIONS │───┼────────────────────│ FULL │─────────────────────┼─╰─╯────│ COMMENT │─────│ @string │───╰───┼┤
        ╰────────╯     ╰───────╯          ╰────╯     ╰─────╯     ╰────────╯         └───────┘     ╰────╯      ╰───────╯      └────────┘         ╰──────────╯      ╰──────╯     └───────┘          ╰───────────╯     │            ╰────╯     ╰────────╯     ╰─────────╯            │          ╰─────────╯      ╰────────╯      └─────────────┘        ╰──────────╯         ╰───────╯     └─────────────┘          ╰────────╯     └─────────────┘          ╰─────────────╯   │                    ╰──────╯                     │        ╰─────────╯     └─────────┘         
                                                                                                                                                                                                                    │                                                             │                                                                                                                                                                                        │                                                 │                                            
                                                                                                                                                                                                                    │             ╭────╮     ╭────────╮     ╭────────╮            │                                                                                                                                                                                        │    ╭─────╮     ╭────────╮     ┌─────────────┐   │                                            
