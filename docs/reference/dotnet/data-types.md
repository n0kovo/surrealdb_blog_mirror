...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/dotnet/data-types.mdx"
---
...
File references are returned when working with [file uploads](../query-language/language-primitives/data-types/files.md) and contain metadata about the stored file.
