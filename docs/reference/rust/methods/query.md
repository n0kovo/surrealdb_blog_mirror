...
The [`vars!`](../concepts/working-with-types.md#the-vars-macro) macro is the most direct way to set several parameters at once, as each pair is written in place rather than chained one call at a time.
