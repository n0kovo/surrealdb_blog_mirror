...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/sessions/state-and-diffs.mdx"
---
...
Corrections accumulate and are never deleted. The full supersession chain for any attribute is always queryable, which means the audit trail for any fact is complete and irrevocable. See [Temporal validity](../reasoning/temporal-validity.md) and [Reconciliation and supersession](../reasoning/reconciliation-and-supersession.md) for the detailed model.
