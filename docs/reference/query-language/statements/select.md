...
```
                                                                                                                                                                         ...
                                                                                                                                                                         │                                                       │                                        │ │                ╭──────────────│ ALL │──────────────╮ │ │ │                                               │               │ │               │ │ │            │ │   │                                                                                                                                                                                                                                                                                   
                          ╭───────╮     ┌────────┐                                                                                                                       │                             ╭─────────╮               │                                        │ │                │              ╰─────╯              │ │ │ │                                  ┌────────┐   │  ╭─────────╮  │ │  ╭─────────╮  │ │ │  ╭──────╮  │ │   │ ╭────────────────────────────────────────────╮ ╭────────────────────────────────────────────╮                                                                                                                                   ╭─────────────────────────────────╮               
                     ╭────│ VALUE │─────│ @field │───╮                                                                                                                   │               ╭─────────────│ NOINDEX │─────────────╮ │                                        │ │                │                                   │ │ │ │                             ╭────│ @field │───╯──│ COLLATE │──╰─╯──│ NUMERIC │──╰─╯─╯──│ DESC │──╰─╰─╮ │ │                                            │ │                                            │                                                                                                                                   │                                 │               
                     │    ╰───────╯     └────────┘   │ ╭────────────────────────────╮ ╭───────────────────────────────────╮              ╭────────────╮                  │               │             ╰─────────╯             │ │ ╭────────────────────────────────────╮ │ │                │  ╭──────────╮                     │ │ │ │                ╭──────────╮ │    └────────┘      ╰─────────╯       ╰─────────╯         ╰──────╯      │ │ │                ╭──────────╮                │ │                ╭──────────╮                │ ╭────────────────────────────────────╮ ╭────────────────────────────────────╮ ╭─────────────────────────────╮ ╭─────────────────╮ │                  ╭────────────╮ │               
                     │                               │ │                            │ │                                   │              │            │                  │               │                                     │ │ │                                    │ │ │                │  │          │                     │ │ │ │                │          │ │                                                                        │ │ │                │          │                │ │                │          │                │ │                                    │ │                                    │ │                             │ │                 │ │                  │            │ │               
        ╭────────╮   │          ┌─────────┐          │ │    ╭────╮     ┌────────┐   │ │    ╭──────╮     ┌─────────────┐   │   ╭──────╮   │  ╭──────╮  │   ┌──────────┐   │    ╭──────╮   │    ╭───────╮     ┌──────────────┐   │ │ │    ╭───────╮     ┌─────────────┐   │ │ │    ╭───────╮   │  │  ╭────╮  │   ┌─────────────┐   │ │ │ │    ╭───────╮   │  ╭────╮  │ │                               ╭────────╮                               │ │ │    ╭───────╮   │  ╭────╮  │   ┌────────┐   │ │    ╭───────╮   │  ╭────╮  │   ┌────────┐   │ │    ╭───────╮     ┌─────────────┐   │ │    ╭─────────╮     ┌───────────┐   │ │    ╭─────╮     ╭────────╮   │ │  ╭───────────╮  │ │    ╭─────────╮   │  ╭──────╮  │ │   ╭───╮       
├┼──────│ SELECT │───╯──────────│ @fields │──────────╰─╯────│ AS │─────│ @alias │───╰─╯────│ OMIT │─────│ @fields ... │───╰───│ FROM │───╯──│ ONLY │──╰───│ @targets │───╯────│ WITH │───╯────│ INDEX │─────│ @indexes ... │───╰─╰─╯────│ WHERE │─────│ @conditions │───╰─╯─╯────│ GROUP │───╯──╯──│ BY │──╰───│ @field, ... │───╰─╰─╰─╯────│ ORDER │───╯──│ BY │──╰─╯───────────────────────────────│ RAND() │───────────────────────────────╰─╰─╯────│ LIMIT │───╯──│ BY │──╰───│ @limit │───╰─╯────│ START │───╯──│ AT │──╰───│ @start │───╰─╯────│ FETCH │─────│ @fields ... │───╰─╯────│ TIMEOUT │─────│ @duration │───╰─╯────│ FOR │─────│ UPDATE │───╰─╯──│ TEMPFILES │──╰─╯────│ EXPLAIN │───╯──│ FULL │──╰─╰───│ ; │─────┼┤
        ╰────────╯              └─────────┘                 ╰────╯     └────────┘          ╰──────╯     └─────────────┘       ╰──────╯      ╰──────╯      └──────────┘        ╰──────╯        ╰───────╯     └──────────────┘            ╰───────╯     └─────────────┘            ╰───────╯         ╰────╯      └─────────────┘              ╰───────╯      ╰────╯                                    ╰────────╯                                        ╰───────╯      ╰────╯      └────────┘          ╰───────╯      ╰────╯      └────────┘          ╰───────╯     └─────────────┘          ╰─────────╯     └───────────┘          ╰─────╯     ╰────────╯        ╰───────────╯         ╰─────────╯      ╰──────╯        ╰───╯
```
...
More info on the `$parent` parameter in the second example can be seen on [the page for predefined variables](../language-primitives/parameters.md).
...
As with traditional SQL queries, a SurrealDB SELECT query supports conditional filtering using a `WHERE` clause. If the expression in the `WHERE` clause [is truthy](../language-primitives/data-types/values.md#values-and-truthiness) (is present and not an empty value), then the respective record will be returned.
...
As SurrealDB supports arrays and nested fields within arrays, it is possible to use the [`SPLIT`](../clauses/split.md) clause to split the result on a specific field name, returning each value in an array as a separate value, along with the record content itself. This is useful in data analysis contexts.
...
When every expression in the projection is a bare zero-argument [`count()`](../functions/database-functions/count.md) (with or without an alias), SurrealDB implies `GROUP ALL`. Outside an aggregation, `count()` has nothing to count and would otherwise return the constant `1` once per record.
...
For more detail on collation, numeric ordering, and random order, see the [`ORDER` clause](../clauses/order.md).
...
Two of the most powerful features in SurrealDB are [record links](../language-primitives/record-links.md) and [graph connections](relate.md).
...
To fetch and replace records with the remote record data, use the [`FETCH`](../clauses/fetch.md) clause to specify the fields and nested fields which should be fetched in-place, and returned in the final statement response output.
...
This requires the temporary directory to be set in the server configuration or when using the [`surreal start`](../../cli/surrealdb-cli/commands/start.md) command.
...
This clause can be used on startup by adding `versioned=true` to the [datastore configuration parameters](../../cli/surrealdb-cli/commands/start.md#datastore-configuration) when executing the `surreal start` command.
...
The `VERSION` clause is always followed by a [datetime](../language-primitives/data-types/datetimes.md). When the specified timestamp does not exist, an empty array is returned.
...
For more examples, see the [graph clauses](relate.md#graph-clauses) section of the page on the `RELATE` statement.
