...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/querying/surrealql/statements-and-values.mdx"
---
...
* [`USE`](../../../reference/query-language/statements/use.md) to move from one namespace or database to another,
* [`INFO`](../../../reference/query-language/statements/info.md) statements to see the definitions for resources.
...
* [`BEGIN`](../../../reference/query-language/statements/begin.md) to begin a manual transaction,
* [`COMMIT`](../../../reference/query-language/statements/commit.md) to commit a transaction,
* [`CANCEL`](../../../reference/query-language/statements/cancel.md) to cancel a transaction.

Other control flow statements are used in the same manner as in other programming languages. Some examples are:

* [`FOR`](../../../reference/query-language/statements/for.md) to begin a for loop,
* [`CONTINUE`](../../../reference/query-language/statements/continue.md) to continue to the next iteration of a loop,
* [`BREAK`](../../../reference/query-language/statements/break.md) to break out of a for loop, internal scope, function, etc.,
* [`THROW`](../../../reference/query-language/statements/throw.md) to cancel execution and return an error.
...
* [`CREATE`](../../../reference/query-language/statements/create.md) to create one or more records of one or more types of tables,
* [`INSERT`](../../../reference/query-language/statements/insert.md) to create one or more regular records or graph edges,
* [`RELATE`](../../../reference/query-language/statements/relate.md) to create a single graph edge between two records,
* [`LIVE SELECT`](../../../reference/query-language/statements/live-select.md) to stream all the changes to a table,
* [`DELETE`](../../../reference/query-language/statements/delete.md) to delete one or more records.
...
* [$before](../../../reference/query-language/language-primitives/parameters.md#before-after) and [$after](../../../reference/query-language/language-primitives/parameters.md#before-after) can be accessed in statements that mutate values to see the values before and after an update,
* [$session](../../../reference/query-language/language-primitives/parameters.md#session) provides context on the current session,
* [$parent](../../../reference/query-language/language-primitives/parameters.md#parent-this) provides access to the value in a primary query while inside a subquery.

For a full list of these automatically generated parameters, see the [parameters](../../../reference/query-language/language-primitives/parameters.md#reserved-variable-names) page.
...
As [the ! operator](../../../reference/query-language/language-primitives/operators.md) reverses the truthiness of a value, a doubling of this operator can also be used to check for truthiness.
...
The following example shows how `!!` can be conveniently used along with the [`object::entries()`](../../../reference/query-language/functions/database-functions/object.md#objectentries) and [`object::from_entries()`](../../../reference/query-language/functions/database-functions/object.md#objectfrom_entries) function to set fields from one table in another as long as they are not empty, `NULL`, or `NONE`. The filtering itself is done using the [`array::filter()`](../../../reference/query-language/functions/database-functions/array.md#arrayfilter) function which returns any values that match a pattern such as the `!!` operator.
