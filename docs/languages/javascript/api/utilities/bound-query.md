...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/api/utilities/bound-query.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td>`query` <label label="optional" /></td>
            <td>`string | BoundQuery`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`other`</td>
            <td>`BoundQuery | string | TemplateStringsArray`</td>
