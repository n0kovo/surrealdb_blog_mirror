...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/api/values/decimal.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`Decimal | string | number | bigint | [bigint, bigint, number]`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`precision` <label label="required" /></td>
            <td>`number`</td>
