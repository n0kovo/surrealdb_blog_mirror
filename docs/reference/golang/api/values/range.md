...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/golang/api/values/range.mdx"
---
...
- [SurrealQL ranges](../../../query-language/language-primitives/data-types/record-ids.md#record-ranges) for the underlying data model
