...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/migrating/from-other-databases/from-neo4j.mdx"
---
...
As Neo4j is schemaless, only the SurrealQL schemaless approach is shown below. For a schemafull option see the [`DEFINE TABLE`](../../../reference/query-language/statements/define/table.md) page.

For more SurrealQL examples, see the [`CREATE`](../../../reference/query-language/statements/create.md), [`INSERT`](../../../reference/query-language/statements/insert.md) and [`RELATE`](../../../reference/query-language/statements/relate.md) pages.
...
Graph relations via the [RELATE](../../../reference/query-language/statements/relate.md) statement:
