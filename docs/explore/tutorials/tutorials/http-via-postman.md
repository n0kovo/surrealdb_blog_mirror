...
The code above allows a user to sign up as a record user with their email and password. Then hash the password with the [`crypto::argon2::generate`](../../../reference/query-language/functions/database-functions/crypto.md#cryptoargon2generate) function 

The sign in logic gets all the users where the emails match and uses the [`crypto::argon2::compare`](../../../reference/query-language/functions/database-functions/crypto.md#cryptoargon2compare) function to check the hash value to the unhashed. 
