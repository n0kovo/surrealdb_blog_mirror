...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/php/v2/concepts/data-types.mdx"
---
...
The SDK provides classes for every [GeoJSON geometry type](../../../query-language/language-primitives/data-types/geometries.md): `GeometryPoint`, `GeometryLine`, `GeometryPolygon`, `GeometryMultiPoint`, `GeometryMultiLine`, `GeometryMultiPolygon`, and `GeometryCollection`.
