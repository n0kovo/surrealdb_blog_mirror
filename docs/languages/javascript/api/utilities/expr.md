...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/api/utilities/expr.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td>`expression` <label label="required" /></td>
            <td>`ExprLike`</td>
...
- [BoundQuery](bound-query.md) - Parameterized queries
- [SelectPromise.where()](../queries/select-promise.md#where) - Using expressions with WHERE
