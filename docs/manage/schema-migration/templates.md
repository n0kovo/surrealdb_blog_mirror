...
- [New databases](getting-started/new-databases.md): start a fresh project with SurrealKit
- [Sync](sync.md): push your scaffolded schema to a database
- [Testing](testing/index.md): run the test suites the template scaffolded
</content>
