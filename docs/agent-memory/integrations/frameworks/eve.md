...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/frameworks/eve.mdx"
---
...
- To call SurrealDB Agent Memory directly outside Eve, use the [JavaScript SDK](../sdks/javascript-and-typescript.md).
