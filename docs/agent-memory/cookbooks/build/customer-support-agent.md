...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/cookbooks/build/customer-support-agent.mdx"
---
...
This is the core guarantee: **Authoritative** content is protected from conversational drift regardless of how many users assert conflicting information. See [Eight pillars and six categories](https://surrealdb.com/docs/agent-memory/architecture/eight-pillars-and-categories) and [Authority when pillars meet](https://surrealdb.com/docs/agent-memory/reasoning/authority-hierarchy).
