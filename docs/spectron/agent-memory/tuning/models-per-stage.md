...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/tuning/models-per-stage.mdx"
---
...
Embeddings are Gemini-only at 3072 dimensions. Switching the deployment embedding model requires a reindex so stored vectors and query vectors share one space. See [Management API — force reindex](../../reference/management-api.md#force-reindex).
