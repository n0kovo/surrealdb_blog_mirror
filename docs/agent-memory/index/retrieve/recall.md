...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/index/retrieve/recall.mdx"
---
...
See [Coherence, retrieval, and cost tiers](https://surrealdb.com/docs/agent-memory/architecture/coherence-retrieval-and-tiers). Tiers progress from cheap structured lookup through response cache, hybrid vector + BM25 + graph, to full-context synthesis. Mode details: [Hybrid search](https://surrealdb.com/docs/agent-memory/retrieve/hybrid-search), [Keywords and BM25](https://surrealdb.com/docs/agent-memory/retrieve/keywords-and-bm25), [Graph traversal](https://surrealdb.com/docs/agent-memory/retrieve/graph-traversal).
