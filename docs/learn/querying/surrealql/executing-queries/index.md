...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/querying/surrealql/executing-queries/index.mdx"
---
...
To get started with SurrealQL, explore the [SurrealQL documentation](../../../../reference/query-language/index.md) to learn about the [statements](../../../../reference/query-language/statements/overview.md) available. These statements enable you to perform a wide range of database operations, from querying data to modifying records and managing database structures.

Additionally, SurrealQL provides a rich set of [database functions](../../../../reference/query-language/functions/database-functions/index.md) for data retrieval, manipulation and more complex computations.
...
To familiarise yourself with SurrealQL, explore the various [statements](../../../../reference/query-language/statements/overview.md) and their syntax. The statement pages provide examples and explanations for each statement type, helping you understand how to construct queries and interact with SurrealDB effectively.
...
- **CLI**: The SurrealDB Command Line Interface (CLI) lets you [interact with the database directly from your terminal](../../../../reference/cli/surrealdb-cli/overview.md). You can execute SurrealQL queries, manage database structures, and perform administrative tasks using the CLI.
...
- **HTTP**: You can send HTTP requests to the [`/sql` endpoint](../../../../reference/rest-api/http-protocol.md#sql) to execute SurrealQL queries. This method is useful for integrating SurrealDB with web applications and services that communicate over HTTP.
...
SurrealDB also supports GraphQL, allowing you to interact with the database using the familiar syntax. Currently, you can use the [GraphQL integration via SurrealDB Studio](../../graphql/via-studio.md), SurrealDB's own user interface, or [over HTTP](../../graphql/via-http.md) via a GraphQL Client such as [GraphiQL](https://github.com/graphql/graphiql) or [Postman](../../../../explore/tutorials/tutorials/http-via-postman.md) at the `localhost:8000/graphql` endpoint.
...
- **HTTP**: You can [send HTTP requests to the `/graphql` endpoint](../../graphql/via-http.md) to execute GraphQL queries. This method is useful for integrating SurrealDB with web applications and services that communicate over HTTP.
...
- **Python**: The [Python SDK](../../../../reference/python/index.md) integrates SurrealDB with Python applications such as web applications, data analysis tools and automation scripts.

- **.NET**: The [.NET SDK](../../../../reference/dotnet/index.md) allows you to interact with SurrealDB using the .NET framework. It provides a comprehensive set of methods to perform queries, manage records, and handle database transactions.

- **Rust**: The [Rust SDK](../../../../reference/rust/index.md) is built on the safety and performance features of the Rust programming language, and lets you interact with SurrealDB in a type-safe manner.
...
- [SurrealQL documentation](../../../../reference/query-language/index.md)
- [SurrealDB Studio documentation](../../../../explore/studio/index.md)
