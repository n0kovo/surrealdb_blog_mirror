...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/java/api/values/file-ref.mdx"
---

# `FileRef` {#file-ref}

The `FileRef` class represents a reference to a [file stored in SurrealDB](../../../query-language/language-primitives/data-types/files.md). A file reference consists of a storage bucket name and a unique file key within that bucket.
