...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/java/concepts/error-handling.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/reference/java/api/errors#surreal-exception">`SurrealException`</a></td>
			<td scope="row" data-label="Description">Base exception for all SDK errors</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/reference/java/api/errors#server-exception">`ServerException`</a></td>
			<td scope="row" data-label="Description">Base for server-returned errors</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/reference/java/api/errors#not-found-exception">`NotFoundException`</a></td>
			<td scope="row" data-label="Description">Thrown when a resource is not found</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/reference/java/api/errors#not-allowed-exception">`NotAllowedException`</a></td>
			<td scope="row" data-label="Description">Thrown when an operation is not permitted</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/reference/java/api/errors#query-exception">`QueryException`</a></td>
			<td scope="row" data-label="Description">Thrown when a query fails</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/reference/java/api/errors#already-exists-exception">`AlreadyExistsException`</a></td>
...
- [SurrealQL THROW](../../query-language/statements/throw.md) for throwing custom errors from queries
