...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/cloud/instance-management.mdx"
---
...
Give each instance a clear name so teams can find it in the organisation view. See [Cloud architecture](architecture.md) for how plans map to topology.
...
If you have not created an organisation or connected a client yet, follow **[Getting started with SurrealDB Cloud](../../build/deployment/surrealdb-cloud/getting-started/index.md)** for account setup, instance creation, and connection strings.
