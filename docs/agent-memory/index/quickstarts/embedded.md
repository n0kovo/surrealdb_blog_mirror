...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/index/quickstarts/embedded.mdx"
---
...
| Hosted SurrealDB Agent Memory | [Hosted quickstart](https://surrealdb.com/docs/agent-memory/quickstarts/hosted) |
