...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/api/values/uuid.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`Uuid | string | ArrayBuffer | Uint8Array`</td>
