...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/java/concepts/data-manipulation.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#create">`db.create(target, content)`</a></td>
			<td scope="row" data-label="Description">Creates one or more records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#select">`db.select(target)`</a></td>
			<td scope="row" data-label="Description">Selects records from a table or by ID</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#insert">`db.insert(target, content)`</a></td>
			<td scope="row" data-label="Description">Inserts one or more records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#update">`db.update(target, upType, content)`</a></td>
			<td scope="row" data-label="Description">Updates records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#upsert">`db.upsert(target, upType, content)`</a></td>
			<td scope="row" data-label="Description">Updates or creates records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#delete">`db.delete(target)`</a></td>
			<td scope="row" data-label="Description">Deletes records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#relate">`db.relate(from, table, to)`</a></td>
			<td scope="row" data-label="Description">Creates a graph relation</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#insert-relation">`db.insertRelation(target, content)`</a></td>
...
The [`.relate()`](../api/core/surreal.md#relate) method creates edges between records in SurrealDB's [graph model](../../query-language/statements/relate.md). You specify the source record, the edge table, and the target record. Optionally, you can attach content to the edge.
...
- [SurrealQL SELECT](../../query-language/statements/select.md), [CREATE](../../query-language/statements/create.md), [UPDATE](../../query-language/statements/update.md), [DELETE](../../query-language/statements/delete.md) for the underlying query statements
- [SurrealQL RELATE](../../query-language/statements/relate.md) for graph relation syntax
- [Record IDs](../../query-language/language-primitives/data-types/record-ids.md) for SurrealDB record identifier formats
