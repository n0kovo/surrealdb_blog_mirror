...
- [Monitoring & observability](monitoring-and-observability.md) — health endpoints, metrics, and tracing integration.
- [Upgrades & patching](upgrades-and-patching.md) — version upgrades, the `surreal fix` migration tool, and compatibility notes.
