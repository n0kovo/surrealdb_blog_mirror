...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/relate-promise.mdx"
---
...
**Returned by:** [`SurrealQueryable.relate()`](../core/surreal-queryable.md#relate)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`Output`</td>
            <td>`"NONE"`, `"AFTER"`, or specific field list.</td>
        </tr>
    </tbody>
</table>
