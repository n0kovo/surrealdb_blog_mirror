...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/sessions/chat-sessions.mdx"
---
...
The `session.context()` method retrieves the formatted context string that Spectron would have injected, so you can replicate the retrieval step in the manual pattern. See [Retrieving context](../retrieve/recall.md) for details.
