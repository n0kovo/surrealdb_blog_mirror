...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Protect the DB with `DEFINE ACCESS` tokens or basic auth; Agentspace inherits IAM & VPC-SC you already set in Agent Builder (<a href="[Google Cloud][5]">Google Cloud</a>).</td>
    </tr>
    <tr>
