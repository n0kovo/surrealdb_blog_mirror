...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/self-hosting/deployment/docker.mdx"
---
...
See [SurrealDB file-backed storage](../../../running/file-backed.md) for the full path rules.
...
See [Kubernetes](kubernetes.md) for a production-grade deployment guide.
