...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/dotnet/core/create-a-new-connection.mdx"
---
...
> See the [Connection Strings](connection-strings.md) section for more information.
...
Learn more about the `.Use()` method [in the methods section](../methods/use.md).
