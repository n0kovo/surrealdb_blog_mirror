...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/java/concepts/multiple-sessions.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/java/api/core/surreal#new-session">`db.newSession()`</a></td>
...
- [DEFINE NAMESPACE](../../query-language/statements/define/namespace.md) for namespace isolation in multi-tenant setups
