...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/api/values/record-id.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td>`idStr` *[required]*</td>
            <td>`string`</td>
            <td>A string in the form `"table:id"`.</td>
        </tr>
    </tbody>
</table>
...
- [Table](table.md) for the table name type
- [Value types](../../concepts/value-types.md) for the full type mapping
- [Data manipulation](../../concepts/data-manipulation.md) for using record IDs in CRUD operations
- [SurrealQL record IDs](../../../../reference/query-language/language-primitives/data-types/record-ids.md) for the underlying data model
