...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/libraries/surqlize/schema.mdx"
---
...
Apply the schema for a set of models with the `SchemaManager`. Pass an [executor](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/connections), or rely on the registered one.
...
Use `definitions()` instead of `apply()` to inspect the statements without running them. You can also apply schemas from the [CLI](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/code-generation-and-cli#schema-apply).

## Learn more

- [Models](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/models) for the `#[Schema]` attribute
- [Code generation and CLI](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/code-generation-and-cli) to apply schemas from the command line
- [DEFINE](../../../../reference/query-language/statements/define/overview.md) for the SurrealQL schema statements
