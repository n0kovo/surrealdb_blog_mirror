...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/frameworks/eve.mdx"
---
...
- To call Spectron directly outside Eve, use the [JavaScript SDK](../sdks/javascript-and-typescript.md).
