...
In SurrealDB, you can use the [brute force approach](../../../reference/query-language/statements/define/indexes.md#brute-force-method) to search through your vector embeddings and data.
