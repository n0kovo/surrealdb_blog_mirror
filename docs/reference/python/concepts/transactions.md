...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/python/concepts/transactions.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/python/api/core/surreal-session#begin-transaction">`session.begin_transaction()`</a></td>
			<td scope="row" data-label="Description">Begins a new transaction within the session</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/python/api/core/surreal-transaction#commit">`txn.commit()`</a></td>
			<td scope="row" data-label="Description">Commits all operations in the transaction, making changes permanent</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/python/api/core/surreal-transaction#cancel">`txn.cancel()`</a></td>
