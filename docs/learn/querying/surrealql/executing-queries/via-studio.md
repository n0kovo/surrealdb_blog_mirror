...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/querying/surrealql/executing-queries/via-studio.mdx"
---
...
If you are using a connection (local or remote), you need to set the [namespace and database](../../../data-models/architecture.md#namespaces-and-databases) for the connection before you can start writing queries.
...
To learn more about SurrealQL and how to write queries using SurrealDB Studio, check out the [SurrealDB Studio documentation](../../../../explore/studio/index.md).
