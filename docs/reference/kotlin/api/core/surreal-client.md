...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/kotlin/api/core/surreal-client.mdx"
---
...
Signs up against a [record access](../../../query-language/statements/define/access/record.md) method and returns a token.
...
Runs a raw [SurrealQL](../../../query-language/index.md) statement with optional bound parameters.
...
Returns a `RunQuery` that invokes a built-in or custom [function](../../../query-language/functions/database-functions/index.md).
