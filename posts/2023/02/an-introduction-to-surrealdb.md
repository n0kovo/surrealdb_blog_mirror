...
slug: "an-introduction-to-surrealdb"
...
source: "https://surrealdb.com/blog/an-introduction-to-surrealdb"
cover: "../../assets/9e73a9ded43781f9.jpg"
---

# An introduction to SurrealDB

![An introduction to SurrealDB](../../assets/9e73a9ded43781f9.jpg)
...
We can then follow the [instructions to install SurrealDB](/install).
...
![Screenshot of tmux terminal where SurrealDB is launched in top panel and surreal REPL is in the bottom panel](../../assets/7a2aa84bcbb7eaa0.jpg)
...
```json
[
    { "time": "5.448µs", "status": "OK", "result": null },
    { "time": "1.855µs", "status": "OK", "result": null },
    {
        "time": "31.966464ms",
        "status": "OK",
        "result": [
            { "id": "person:7fsqx0q0iyeoltyjsr7c", "name": "Hugh" },
            { "id": "person:2fdjz6j6luih4bn44u9c", "name": "Rushmore" }
        ]
    }
]
```
...
[
    {
        ...
        "status": "OK",
        "result": [
            { "id": "person:adfy4qj5254b8l4po7bp", "name": "Hugh" },
            { "id": "person:g5wkfgggpfayj6j453hg", "name": "Rushmore" }
        ]
    }
]
```
...
So what are these namespaces and databases? In the simplest terms, they are ways of making sure that you do not get name collisions (who here has had a table called "requests" or "versions"?). But really, there is more to this separation.
...
[
    {
        "time": "90.142µs",
        "status": "OK",
        "result": [{ "id": "person:tobie", "name": "Tobie" }]
    }
]
```
...
[
    {
        ...
        "result": [
            {
                "id": "person:1vjjz8xi2pbau1zh07ob",
                "name": "complex",
                "shoes": [
                    "red",
                    "green",
                    { "colour": "blue", "favourite": true }
                ]
            }
        ]
    }
...
[
    {
        ...
        "result": [
            { "id": "person:1vjjz8xi2pbau1zh07ob" },
            { "id": "person:adfy4qj5254b8l4po7bp" },
            { "id": "person:g5wkfgggpfayj6j453hg" },
            { "id": "person:tobie" }
        ]
    }
]
...
[
    {
        ...
        "result": [
            {
                "friends": [
                    "person:g5wkfgggpfayj6j453hg",
                    "person:adfy4qj5254b8l4po7bp"
                ],
                "id": "person:tobie",
                "name": "Tobie"
            }
...
[
    {
        "time": "185.621µs",
        "status": "OK",
        "result": [{ "friends": { "name": ["Rushmore", "Hugh"] } }]
    }
]
```
...
[
    {
        ...
        "result": [
            {
                "id": "works_with:fl9wgahk9pl4eqj33es7",
                "in": "person:tobie",
                "last_updated": "2023-02-06T18:33:41.131956605Z",
                "out": "person:g5wkfgggpfayj6j453hg"
            }
        ]
    },
    {
        ...
        "result": [
            {
                "id": "works_with:zccalviq0oj6o36wylgy",
                "in": "person:tobie",
                "last_updated": "2023-02-06T18:33:41.156103917Z",
                "out": "person:adfy4qj5254b8l4po7bp"
            }
        ]
    }
]
