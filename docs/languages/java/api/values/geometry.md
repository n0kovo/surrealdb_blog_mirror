...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/java/api/values/geometry.mdx"
---

# `Geometry` {#geometry}

The `Geometry` class represents [SurrealDB geometric data types](../../../../reference/query-language/language-primitives/data-types/geometries.md). It currently supports point geometry, mapping to Java's `Point2D.Double` from `java.awt.geom`.
...
- [SurrealQL geometries](../../../../reference/query-language/language-primitives/data-types/geometries.md) — Geometry types in SurrealDB
