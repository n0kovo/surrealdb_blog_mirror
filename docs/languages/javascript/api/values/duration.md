...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`string`</td>
            <td>Duration string (e.g., `"5h30m"`).</td>
        </tr>
    </tbody>
</table>
...
- [SurrealQL Duration](../../../../reference/query-language/language-primitives/data-types/datetimes.md#durations) - Database duration type
