...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/libraries/surqlize/edges-and-graph.mdx"
---
...
- [Models](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/models) for the `#[Edge]` attribute
- [Schema](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/schema) to define the relation table
- [RELATE](../../../../reference/query-language/statements/relate.md) for the SurrealQL statement
