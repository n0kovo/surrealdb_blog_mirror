...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/surrealctl/organisations.mdx"
---
...
For what Owner, Admin, and Member each permit, see [Members and roles](../organisations/members-and-roles.md).
...
All four verbs need a login session, so a token cannot mint its own replacement. See [Authentication](authentication.md#personal-access-tokens) for scopes, expiry, and how to capture the secret.
...
For invoices, payment methods, and how the platform bills, see [Billing](../organisations/billing.md).
