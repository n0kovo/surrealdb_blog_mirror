...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/data-models/document/common-patterns.mdx"
---
...
As MongoDB is schemaless, only the SurrealQL schemaless approach is shown below. For a schemafull option, see the [`DEFINE TABLE`](../../../reference/query-language/statements/define/table.md) page.

For more SurrealQL examples, see the [`CREATE`](../../../reference/query-language/statements/create.md) and [`INSERT`](../../../reference/query-language/statements/insert.md) pages.
...
For more SurrealQL examples, see the [`SELECT`](../../../reference/query-language/statements/select.md), [`LIVE SELECT`](../../../reference/query-language/statements/live-select.md) and [`RETURN`](../../../reference/query-language/statements/return.md) pages.
...
For more SurrealQL examples, see the [`UPDATE`](../../../reference/query-language/statements/update.md) page.
...
For more SurrealQL examples, see the [`DELETE`](../../../reference/query-language/statements/delete.md) and [`REMOVE`](../../../reference/query-language/statements/remove.md) pages.
...
- [`CREATE` statement](../../../reference/query-language/statements/create.md)
- [`SELECT` statement](../../../reference/query-language/statements/select.md)
- [`UPDATE` statement](../../../reference/query-language/statements/update.md)
- [`DELETE` statement](../../../reference/query-language/statements/delete.md)
- [`RELATE` statement](../../../reference/query-language/statements/relate.md)
