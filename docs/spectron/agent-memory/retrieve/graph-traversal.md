...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/retrieve/graph-traversal.mdx"
---
...
Optional **`graph_edges`** on **`/documents/query`** select which of these signals contribute during **`hybrid_graph`** reranking (`knowledge_has_keyword`, `section_match`, `document_link`, `document_summary`). See [Hybrid search](hybrid-search.md).
...
- [Cross-layer linking](../reasoning/cross-layer-linking.md)
