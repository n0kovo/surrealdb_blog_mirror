...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/php/v1/installation.mdx"
---
...
- [Getting started](../../../languages/php.md) to run your first queries
