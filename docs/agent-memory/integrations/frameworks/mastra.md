...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/frameworks/mastra.mdx"
---
...
- To call SurrealDB Agent Memory directly, use the [JavaScript SDK](../sdks/javascript-and-typescript.md).
