...
Together, table- and field-level `PERMISSIONS` give you flexible **authorisation** without duplicating policy in every client. For full syntax and options, see [`DEFINE TABLE`](../../../reference/query-language/statements/define/table.md) and [`DEFINE FIELD`](../../../reference/query-language/statements/define/field.md).
