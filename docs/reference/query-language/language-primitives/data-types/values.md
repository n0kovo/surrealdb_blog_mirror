...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/language-primitives/data-types/values.mdx"
---
...
As [the ! operator](../operators.md) reverses the truthiness of a value, a doubling of this operator can also be used to check for truthiness.
