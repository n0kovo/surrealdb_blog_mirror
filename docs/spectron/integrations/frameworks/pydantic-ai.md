...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/frameworks/pydantic-ai.mdx"
---
...
- To call Spectron directly outside Pydantic AI, use the [Python SDK](../sdks/python.md).
