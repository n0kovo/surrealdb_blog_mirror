...
- **Query language**: SurrealQL blends SQL-like syntax with searching syntax (the [`@@` matching operator](../../../reference/query-language/language-primitives/operators.md#matches-a-idmatchesa) for FTS queries, advanced indexing features, and so on).
