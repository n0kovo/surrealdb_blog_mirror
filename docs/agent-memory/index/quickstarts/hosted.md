...
For a click-by-click version of this step, plus the Workbench, Documents, and Lookup views, see [Create your first context](https://surrealdb.com/docs/agent-memory/quickstarts/surrealdb-cloud#create-your-first-context).
