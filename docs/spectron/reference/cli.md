...
For a full provisioning walkthrough (bootstrap, scopes, principals, keys, upload, query), follow the [Hosted quickstart](https://surrealdb.com/docs/spectron/quickstarts/hosted) and [CLI](#connection-flags-client) reference below.
