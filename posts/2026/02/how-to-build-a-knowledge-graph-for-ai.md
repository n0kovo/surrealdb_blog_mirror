...
slug: "how-to-build-a-knowledge-graph-for-ai"
...
summary: "What is a knowledge graph and how can it be used to enhance AI agents?"
source: "https://surrealdb.com/blog/how-to-build-a-knowledge-graph-for-ai"
cover: "../../assets/a8bfe7fe7f2e4da2.jpg"
---

# How to build a knowledge graph for AI

![How to build a knowledge graph for AI](../../assets/a8bfe7fe7f2e4da2.jpg)
...
![Types of knowledge graphs](../../assets/b8e436e8652a7d44.jpg)
...
![Vector clusters with graph relations](../../assets/9efa91fffdc8ed7d.jpg)
...
We now have “plain” data, which is commonly (but not necessarily) kept in Markdown format. It is very likely that the document may be too long, which is less than ideal for LLMs which have a finite context window (references: [https://arxiv.org/abs/2502.05167](https://arxiv.org/abs/2502.05167)).
...
For our example here, I use a `flow` decorator to register functions for different steps in the ETL process. An orchestrator takes care of calling this function for `document`s that lack a “stamp” in their `chunked` column:
...
- Commercial solutions: [Document AI from Tensorlake](https://tensorlake.ai/document-ingestion), [https://www.datalab.to/](https://www.datalab.to/)
