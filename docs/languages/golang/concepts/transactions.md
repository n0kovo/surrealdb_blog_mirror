...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/concepts/transactions.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/golang/api/core/db#begin">`db.Begin(ctx)`</a></td>
			<td scope="row" data-label="Description">Starts a transaction on the default session</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/golang/api/core/session#begin">`session.Begin(ctx)`</a></td>
			<td scope="row" data-label="Description">Starts a transaction within a session</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/golang/api/core/transaction#commit">`tx.Commit(ctx)`</a></td>
			<td scope="row" data-label="Description">Commits the transaction, applying all changes</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/golang/api/core/transaction#cancel">`tx.Cancel(ctx)`</a></td>
			<td scope="row" data-label="Description">Cancels the transaction, discarding all changes</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/golang/api/core/transaction#id">`tx.ID()`</a></td>
			<td scope="row" data-label="Description">Returns the transaction's UUID</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/golang/api/core/transaction#isclosed">`tx.IsClosed()`</a></td>
...
- [SurrealQL transactions](../../../reference/query-language/statements/begin.md) for text-based transaction syntax
