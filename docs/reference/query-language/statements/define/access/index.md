...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/statements/define/access/index.mdx"
---
...
Learn more about [JWT access method in the documentation](jwt.md).
...
`CONTEXT` is also available on [`ALTER ACCESS`](../../alter/access.md), and an access method without the clause behaves exactly as it did before.
