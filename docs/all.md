...
- [JavaScript](build/embedding/by-language/javascript.md)
  Embedding SurrealDB in JavaScript
- [Python](build/embedding/by-language/python.md)
...
- [n8n](build/integrations/data-management/n8n.md)
...
- [Data management integrations](build/integrations/data-management/overview.md)
...
- [OpenAI](build/integrations/embeddings-providers/openai.md)
  This section contains information about the OpenAI embeddings feature of SurrealDB.
- [Embeddings provider integrations](build/integrations/embeddings-providers/overview.md)
  This section contains information about different LLM models you can use with SurrealDB.
- [Python quickstart](build/integrations/embeddings-providers/python-quickstart.md)
...
- [Migrating from MySQL](build/migrating/from-other-databases/from-mysql.md)
  How to map existing data and concepts from PostgreSQL to SurrealDB
- [Migrating from Neo4j](build/migrating/from-other-databases/from-neo4j.md)
...
- [Build a real-time presence app](explore/tutorials/tutorials/build-a-real-time-presence-app.md)
...
- [Build an AI agent with Python](explore/tutorials/tutorials/build-an-ai-agent.md)
  In this tutorial, you will learn three ways to build an AI agent in Python that uses SurrealDB.
- [Connect to SurrealDB via ngrok](explore/tutorials/tutorials/connect-via-ngrok.md)
  Expose a local SurrealDB instance to the internet with ngrok for remote development and testing.
- [Define a schema in SurrealDB](explore/tutorials/tutorials/define-a-schema.md)
...
- [Build a GenAI chatbot with Graph RAG](explore/tutorials/tutorials/gen-ai-chatbot.md)
  In this guide, you'll learn how to use LangChain Python components, Ollama, and SurrealDB to make a GenAI chatbot.
- [Use SurrealDB in GitHub Actions](explore/tutorials/tutorials/github-actions.md)
  This guide will show you how to set up and use the official GitHub Action for SurrealDB in your CI/CD pipeline.
- [Build a knowledge graph for AI](explore/tutorials/tutorials/how-to-build-a-knowledge-graph-for-ai.md)
  Build a knowledge graph for AI agents and RAG: graphs, embeddings and SurrealQL retrieval patterns in one tutorial.
- [Query SurrealDB from Postman](explore/tutorials/tutorials/http-via-postman.md)
...
- [AspNetCore.HealthChecks.SurrealDb](labs/aspnet-healthchecks-package.md)
  ASP.NET Core health check package for monitoring SurrealDB connectivity.
- [Beyond Surreal? A closer look at NewSQL Relational Data - Beyond Fireship.](labs/beyond-surreal-a-closer-look-at-newsql-relational-data-beyond-fireship.md)
- [labs/build-a-realtime-presence-web-application-using-surrealdb-live-queries.md](labs/build-a-realtime-presence-web-application-using-surrealdb-live-queries.md)
- [Building an App with Graph Relations, Live Queries and Authentication](labs/building-an-app-with-graph-relations-live-queries-authentication.md)
...
- [How I built a SaaS powered by SurrealDB](labs/how-i-built-a-saas-powered-by-surrealdb.md)
- [How to Build A Full Stack Rust Dashboard App with Leptos, Actix Web and SurrealDB](labs/how-to-build-a-full-stack-rust-dashboard-app-with-leptos-actix-web-surreall.md)
- [How to Build A Rust Backend with Actix Web and SurrealDB (Full Tutorial)](labs/how-to-build-a-rust-backend-with-actix-web-and-surrealdb-full-tutorial.md)
- [How to do a Full-Text Search Query in SurrealQL](labs/how-to-do-a-full-text-search-query-in-surrealql.md)
- [How to Simplify Your Tech Stack with SurrealDB](labs/how-to-simplify-your-tech-stack-with-surrealdb.md)
- [How to Use SurrealDB with the Fresh Framework and Deno.](labs/how-to-use-surrealdb-with-the-fresh-framework-and-deno.md)
- [Improve database management with SurrealDB](labs/improve-database-management-with-surrealdb.md)
- [IoT telemetry example](labs/iot-telemetry-example.md)
  Reference IoT telemetry ingest and queries with SurrealDB.
- [Livestream series documenting learning SurrealDB.](labs/livestream-series-documenting-learning-surrealdb.md)
- [Network capabilities in Surreal Cloud](labs/network-capabilities-in-surreal-cloud.md)
- [Relational-Style Relationships in SurrealDB](labs/relational-style-relationships-in-surrealdb.md)
- [Run SurrealDB in your browser using our WASM engine](labs/run-surrealdb-in-your-browser-using-our-wasm-engine.md)
- [Run SurrealDB inside NodeJS using our NodeJS engine](labs/run-surrealdb-inside-nodejs-using-our-nodejs-engine.md)
- [Rust Powered Database SurrealDB (It's Pretty Ambitious) - Code to the Moon.](labs/rust-powered-database-surrealdb-its-pretty-ambitious-code-to-the-moon.md)
- [Schemaless vs Schemafull Databases](labs/schemaless-vs-schemafull-databases.md)
- [Setting up an invite system](labs/setting-up-an-invite-system.md)
- [Simple API with Gin/Gonic and SurrealDB (GO).](labs/simple-api-with-gingonic-and-surrealdb-go.md)
- [Surreal-4o Fine-tuned Model Datasets for SurrealQL Queries - Project to create structured datasets for OpenAI.](labs/surreal-4o-fine-tuned-model-datasets-for-surrealql-queries-project-to-create-structured-datasets-for-openai.md)
  Structured datasets for fine-tuning models on SurrealQL-style queries.
- [surreal-codegen](labs/surreal-codegen.md)
  Code generation tooling for SurrealDB-backed TypeScript projects.
- [Surreal Transfer](labs/surreal-transfer.md)
  CLI utilities for exporting and importing SurrealDB data.
- [surreal-ts](labs/surreal-ts.md)
  Generate TypeScript types from SurrealDB schema and queries.
- [SurrealDB AI Assistant](labs/surrealdb-ai-assistant.md)
  Web AI assistant that queries and explores a SurrealDB database.
- [SurrealDB AI Docs Retrieval - Project to showcase: How to build a GPT-Based question-answering system on top of SurrealDB Docs.](labs/surrealdb-ai-docs-retrieval-project-to-showcase-how-to-build-a-gpt-based-question-answering-system-on-top-of-surrealdb-docs.md)
  RAG-style demo that answers questions using SurrealDB documentation.
- [SurrealDB as a Vector Store for LangChain - A Jupyter notebook demonstrating how to use SurrealDB as a Vector Store.](labs/surrealdb-as-a-vector-store-for-langchain-a-jupyter-notebook-demonstrating-how-to-use-surrealdb-as-a-vector-store.md)
  Jupyter notebook showing SurrealDB as a LangChain vector store.
- [surrealdb.c](labs/surrealdb-c.md)
  Official C bindings and examples for embedding SurrealDB.
- [surrealdb-client-generator](labs/surrealdb-client-generator.md)
  Generate typed API clients from your SurrealDB schema and queries.
- [surrealdb-extras](labs/surrealdb-extras.md)
  Rust API reference for the surrealdb-extras helper crate.
- [surrealdb-flutter](labs/surrealdb-flutter.md)
  Dart and Flutter client for connecting to SurrealDB.
- [SurrealDB GitHub Action](labs/surrealdb-github-action.md)
  GitHub Action to run SurrealDB in CI pipelines.
- [SurrealDB + Go Driver Starter.](labs/surrealdb-go-driver-starter.md)
  Starter project wiring the official SurrealDB Go SDK into an application.
- [SurrealDB Grafana datasource](labs/surrealdb-grafana-datasource.md)
  Official Grafana data source for SurrealDB queries.
- [labs/surrealdb-in-100-seconds.md](labs/surrealdb-in-100-seconds.md)
- [SurrealDB MCP Server](labs/surrealdb-mcp-server.md)
  Model Context Protocol server that connects AI tools to SurrealDB.
- [SurrealDB ODataV4 Connector](labs/surrealdb-odatav4-connector.md)
  OData v4 tooling and connector work for SurrealDB.
- [labs/surrealdb-presence-demo-demo-project-on-how-to-create-a-realtime-presence-web-application-using-surrealdb-live-queries.md](labs/surrealdb-presence-demo-demo-project-on-how-to-create-a-realtime-presence-web-application-using-surrealdb-live-queries.md)
- [SurrealDB - Rust Embedded Database - Quick Tutorial.](labs/surrealdb-rust-embedded-database-quick-tutorial.md)
- [surrealdb/surrealdb](labs/surrealdb-surrealdb.md)
  Official SurrealDB container image on Docker Hub.
- [SurrealDB. The Kitchen Sink Document Store that might dethrone Firebase.](labs/surrealdb-the-kitchen-sink-document-store-that-might-dethrone-firebase.md)
- [surrealdb-valibot](labs/surrealdb-valibot.md)
  Validate SurrealDB records using Valibot schemas.
- [SurrealDB Vector Store for LangChain](labs/surrealdb-vector-store-for-langchain.md)
  LangChain documentation for using SurrealDB as a vector store.
- [SurrealDB + Vue Blog Starter.](labs/surrealdb-vue-blog-starter.md)
  Vue.js blog starter template backed by SurrealDB.
- [surrealdb-zod](labs/surrealdb-zod.md)
...
- [Understanding User Groups in SurrealDB](labs/understanding-user-groups-in-surrealdb.md)
- [Unlocking SurrealDB: Building a Real-World Multi-Tenant RBAC System Made Easy (4 Part Series).](labs/unlocking-surrealdb-building-a-real-world-multi-tenant-rbac-system-made-easy-4-part-series.md)
- [labs/unreal-orm.md](labs/unreal-orm.md)
...
- [Full-text search model](learn/data-models/full-text-search/overview.md)
...
- [Location-based patterns](learn/data-models/geospatial/location-based-patterns.md)
...
- [Geospatial model](learn/data-models/geospatial/overview.md)
...
- [Spatial queries](learn/data-models/geospatial/spatial-queries.md)
...
- [Record links vs graph relations](learn/data-models/graph/record-links-vs-graph-relations.md)
...
- [Recursive traversals](learn/data-models/graph/recursive-traversals.md)
...
- [Time-series model](learn/data-models/time-series/overview.md)
...
- [Time buckets and windowing](learn/data-models/time-series/time-buckets-and-windowing.md)
...
- [Using SurrealDB as a time series database](learn/data-models/time-series/using-as-time-series-database.md)
...
- [Embedding pipelines](learn/data-models/vector-search/embedding-pipelines.md)
  Store vector fields on records, size embeddings for throughput and accuracy, and trim dimensions when models allow.
- [Hybrid search](learn/data-models/vector-search/hybrid-search.md)
...
- [Vector search model](learn/data-models/vector-search/overview.md)
...
- [RAG architecture patterns](learn/data-models/vector-search/rag-architecture-patterns.md)
...
- [Surrealism attribute reference](learn/extensions/guides/surrealism-attribute-reference.md)
...
- [Error handling](learn/querying/concepts-and-guides/error-handling.md)
  Handle errors in SurrealQL with THROW, validation guards and ASSERT on fields to stop queries and return clear failures.
- [Idempotent operations](learn/querying/concepts-and-guides/idempotent-operations.md)
  Make SurrealQL idempotent with UPSERT, safe deletes and unique indexes so retries do not corrupt data.
- [Parameterised queries](learn/querying/concepts-and-guides/parameterised-queries.md)
...
- [Defining events](learn/schema-management/events-and-triggers/defining-events.md)
...
- [Record ID best practices](learn/schema-management/tables-and-fields/record-id-best-practices.md)
  How best to make a decision on what kind of record ID format to use in your database.
- [Record IDs and addressing](learn/schema-management/tables-and-fields/record-ids-and-addressing.md)
...
- [API](reference/query-language/functions/database-functions/api.md)
  These functions can be used with the DEFINE API or DEFINE CONFIG statements.
- [Array](reference/query-language/functions/database-functions/array.md)
  These functions can be used when working with, and manipulating arrays of data.
- [Bytes](reference/query-language/functions/database-functions/bytes.md)
  These functions can be used when working with bytes.
- [Count](reference/query-language/functions/database-functions/count.md)
  This function can be used when counting field values and expressions.
- [Crypto](reference/query-language/functions/database-functions/crypto.md)
  These functions can be used when hashing data, encrypting data, and for securely authenticating users into the database.
- [Duration](reference/query-language/functions/database-functions/duration.md)
...
- [Record](reference/query-language/functions/database-functions/record.md)
  These functions can be used to retrieve specific metadata from a SurrealDB Record ID.
- [Search](reference/query-language/functions/database-functions/search.md)
...
- [Sequence](reference/query-language/functions/database-functions/sequence.md)
  Functions to work with sequences.
- [Session](reference/query-language/functions/database-functions/session.md)
  These functions return information about the current SurrealDB session.
- [Set](reference/query-language/functions/database-functions/set.md)
  These functions can be used when working with, and manipulating sets of data.
- [Sleep](reference/query-language/functions/database-functions/sleep.md)
...
- [Arrays](reference/query-language/language-primitives/data-types/arrays.md)
  An array is a collection of values contained inside square brackets, each of which is stored at a certain index.
- [Booleans](reference/query-language/language-primitives/data-types/booleans.md)
  Boolean values in SurrealDB can be used to mark whether a field is true or false
- [Bytes](reference/query-language/language-primitives/data-types/bytes.md)
  A value that represents the bytes used ubiquitously in computer hardware.
- [Closures](reference/query-language/language-primitives/data-types/closures.md)
...
- [Data types](reference/query-language/language-primitives/data-types/index.md)
...
- [Ranges](reference/query-language/language-primitives/data-types/ranges.md)
  A range of possible values.
- [Record IDs](reference/query-language/language-primitives/data-types/record-ids.md)
  In SurrealDB, document record IDs store both the table name, and the record ID.
- [Regex](reference/query-language/language-primitives/data-types/regex.md)
  A reged (regular expression) can be used to specify a match pattern in text.
- [Sets](reference/query-language/language-primitives/data-types/sets.md)
  A set is a collection type of deduplicated and ordered values that can have a maximum size limit.
- [Strings](reference/query-language/language-primitives/data-types/strings.md)
...
- [UUIDs](reference/query-language/language-primitives/data-types/uuids.md)
  UUID values in SurrealQL represent UUID v4 and v7 values.
- [Values](reference/query-language/language-primitives/data-types/values.md)
  Every type in SurrealDB is a value.
- [Formatters](reference/query-language/language-primitives/formatters.md)
  Formatting functions in SurrealQL accept certain text formats for date/time formatting.
- [Idioms](reference/query-language/language-primitives/idioms.md)
  Accessing and manipulating data using idioms (paths) in SurrealQL.
- [Operators](reference/query-language/language-primitives/operators.md)
  A variety of operators in SurrealQL allow for complex manipulation of data, and advanced logic.
- [Parameters](reference/query-language/language-primitives/parameters.md)
  Parameters can be used like variables to store a value which can then be used in a subsequent query.
- [Record links](reference/query-language/language-primitives/record-links.md)
...
- [Record references](reference/query-language/language-primitives/record-references.md)
  Record references allow you to link records together, enabling you to traverse from one record to another.
- [Statements](reference/query-language/language-primitives/statements.md)
  What SurrealQL statements are and how they structure work you send to the database.
- [Transactions](reference/query-language/language-primitives/transactions.md)
...
- [Arguments](reference/query-language/scripting/arguments.md)
...
- [Built-in functions](reference/query-language/scripting/built-in-functions.md)
...
- [Function context](reference/query-language/scripting/function-context.md)
...
- [Scripting functions overview](reference/query-language/scripting/overview.md)
...
- [SurrealQL functions](reference/query-language/scripting/surrealql-functions.md)
  Embedded JavaScript functions access native SurrealQL via surrealdb.functions for richer, performant server-side logic.
- [Type conversion](reference/query-language/scripting/type-conversion.md)
...
- [BEARER](reference/query-language/statements/define/access/bearer.md)
...
- [DEFINE EVENT](reference/query-language/statements/define/event.md)
...
- [DEFINE SCOPE](reference/query-language/statements/define/scope.md)
...
- [INFO](reference/query-language/statements/info.md)
  The INFO command outputs information about the setup of the SurrealDB system.
- [INSERT](reference/query-language/statements/insert.md)
...
- [KILL](reference/query-language/statements/kill.md)
  The KILL statement is used to terminate a running live query.
- [LET](reference/query-language/statements/let.md)
  The LET statement sets and stores a value which can then be used in a subsequent query.
- [LIVE SELECT](reference/query-language/statements/live-select.md)
...
- [Statements](reference/query-language/statements/overview.md)
  Reference overview: SurrealQL statements for resources, control flow, transactions and CRUD or data operations.
- [REBUILD](reference/query-language/statements/rebuild.md)
...
- [REMOVE](reference/query-language/statements/remove.md)
...
- [UPSERT](reference/query-language/statements/upsert.md)
