...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/api/core/surreal-session.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`<a href="/docs/languages/javascript/api/types/#accessrecordauth">AccessRecordAuth</a>`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`auth` <label label="required" /></td>
            <td>`<a href="/docs/languages/javascript/api/types/#anyauth">AnyAuth</a>`</td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`keyof <a href="/docs/languages/javascript/api/types/#sessionevents">SessionEvents</a>`</td>
