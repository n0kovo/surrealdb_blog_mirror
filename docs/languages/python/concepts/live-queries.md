...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/python/concepts/live-queries.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/python/api/core/surreal#live">`db.live(table, diff?)`</a></td>
			<td scope="row" data-label="Description">Starts a live query on a table and returns a query UUID</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/python/api/core/surreal#subscribe-live">`db.subscribe_live(query_uuid)`</a></td>
			<td scope="row" data-label="Description">Subscribes to notifications from a live query</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/python/api/core/surreal#kill">`db.kill(query_uuid)`</a></td>
...
You can also initiate a live query using a [`LIVE SELECT`](../../../reference/query-language/statements/live-select.md) statement through the `.query()` method. The query returns a UUID that can be passed to `.subscribe_live()` in the same way as a UUID returned by `.live()`.
...
- [SurrealQL LIVE SELECT](../../../reference/query-language/statements/live-select.md) for the query language syntax
