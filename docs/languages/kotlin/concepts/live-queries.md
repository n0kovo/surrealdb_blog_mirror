...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/kotlin/concepts/live-queries.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/kotlin/api/core/surreal-client#live">`client.live(table)`</a></td>
			<td scope="row" data-label="Description">Starts a live query and returns a subscription</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/kotlin/api/core/live-subscription#events">`subscription.events`</a></td>
			<td scope="row" data-label="Description">A `Flow` of live notifications</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/kotlin/api/core/live-subscription#cancel">`subscription.cancel()`</a></td>
			<td scope="row" data-label="Description">Stops the subscription</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/kotlin/api/core/surreal-client#kill">`client.kill(id)`</a></td>
