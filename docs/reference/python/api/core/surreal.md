...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/python/api/core/surreal.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td>`vars` *[required]*</td>
            <td>`dict[str, <a href="/docs/reference/python/api/types/#value">Value</a>]`</td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>`<a href="/docs/reference/python/api/types/#value">Value</a>`</td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`<a href="/docs/reference/python/api/types/#recordidtype">RecordIdType</a>`</td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>`data` *[optional]*</td>
            <td>`<a href="/docs/reference/python/api/types/#value">Value</a> | None`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`name` *[required]*</td>
            <td>`str`</td>
            <td>The fully-qualified function name, e.g. `"fn::increment"`.</td>
        </tr>
        <tr>
            <td>`args` *[optional]*</td>
            <td>`list[<a href="/docs/reference/python/api/types/#value">Value</a>] | None`</td>
