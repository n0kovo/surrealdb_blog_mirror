...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/frameworks/langchain.mdx"
---
...
- If your application calls SurrealDB Agent Memory directly rather than through LangChain, use the [JavaScript SDK](../sdks/javascript-and-typescript.md).
