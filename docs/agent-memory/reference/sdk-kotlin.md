...
The SurrealDB Agent Memory client ships inside the [SurrealDB Kotlin SDK](../../reference/kotlin/index.md) — there is no separate artifact. It is independent of the SurrealDB RPC engine and speaks SurrealDB Agent Memory's HTTP API directly.
...
→ [Kotlin SDK](../integrations/sdks/kotlin.md)
