...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/java/installation.mdx"
---
...
- [Getting started](../../languages/java.md) for a complete working example
