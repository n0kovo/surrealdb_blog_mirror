...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/integrations/database-clients/beekeeper-studio.mdx"
---
...
- A running SurrealDB instance. See [installation](../../../running/installation/index.md) if you do not have one yet.
...
The screenshots here use the [Surreal Deal Store](../../../explore/tutorials/demos/surreal-deal-store.md) sample dataset.
