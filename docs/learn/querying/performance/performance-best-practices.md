...
Read more about the [architecture of SurrealDB and the supported storage engines.](../../../architecture.md)
...
Read more about running SurrealDB as a [single-node server](../../../self-hosted/file-backed.md) or [multi-node cluster](../../../self-hosted/multi-node.md).
