...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/golang/api/errors/index.mdx"
---
...
Represents a per-statement error within a query result. Returned in the `Error` field of [`QueryResult`](../types/index.md#queryresult) when an individual statement fails.
...
- [Error handling](../../concepts/error-handling.md) for error handling patterns and retry guidance
- [Types reference](../types/index.md) for [`QueryResult`](../types/index.md#queryresult) containing `QueryError`
- [DB reference](../core/db.md) for methods that return these errors
- [Session reference](../core/session.md) for `ErrSessionClosed` and `ErrSessionsNotSupported`
- [Transaction reference](../core/transaction.md) for `ErrTransactionClosed` and `ErrTransactionsNotSupported`
