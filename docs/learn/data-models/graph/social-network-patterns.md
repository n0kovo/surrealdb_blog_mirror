...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/data-models/graph/social-network-patterns.mdx"
---
...
For mutual “friend” relations where direction should not matter, combine [unique indexes on sorted endpoints](creating-relations.md#unique-index-for-relations-between-equals) with [`<->` traversal](graph-traversal.md#querying-symmetric-between-equals-relations) so you query both orientations consistently.

## Related guides

* [Record links vs graph relations](record-links-vs-graph-relations.md), when edges win for interaction metadata and scoring.
* [Graph traversal](graph-traversal.md), arrow syntax for multi-hop social feeds.
