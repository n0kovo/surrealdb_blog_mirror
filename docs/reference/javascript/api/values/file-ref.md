...
The `FileRef` class represents a reference to a file stored in SurrealDB. File references are returned when querying records that contain [file fields](../../../query-language/language-primitives/data-types/files.md) and provide access to file metadata such as the bucket, key, and media type.
...
- [File uploads](../../../query-language/language-primitives/data-types/files.md) - Working with files in SurrealDB
