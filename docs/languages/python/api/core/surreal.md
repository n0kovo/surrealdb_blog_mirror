...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/python/api/core/surreal.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td>`url` *[optional]*</td>
            <td>`str | None`</td>
            <td>An optional URL to override the one provided to the factory function. Defaults to `None`.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`vars` *[required]*</td>
            <td>`dict[str, <a href="/docs/languages/python/api/types/#value">Value</a>]`</td>
            <td>Variables used for signup, including `namespace`, `database`, `access`, and any additional fields required by the access method.</td>
        </tr>
    </tbody>
</table>

**Returns:** [`Tokens`](../types/index.md#tokens)
...
<table>
    ...
    <tbody>
        <tr>
            <td>`vars` *[required]*</td>
            <td>`dict[str, <a href="/docs/languages/python/api/types/#value">Value</a>]`</td>
            <td>Credentials for authentication. For root access, provide `username` and `password`. For scoped access, also include `namespace`, `database`, and `access`.</td>
        </tr>
    </tbody>
</table>
...
**Returns:** [`Value`](../types/index.md#value)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>`<a href="/docs/languages/python/api/types/#value">Value</a>`</td>
...
Runs a set of [SurrealQL](../../../../reference/query-language/index.md) statements against the database.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>`vars` *[optional]*</td>
            <td>`dict[str, <a href="/docs/languages/python/api/types/#value">Value</a>] | None`</td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`<a href="/docs/languages/python/api/types/#recordidtype">RecordIdType</a>`</td>
            <td>A table name (`str`) or a `RecordID` to select.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`record` *[required]*</td>
            <td>`<a href="/docs/languages/python/api/types/#recordidtype">RecordIdType</a>`</td>
            <td>The table name or `RecordID` to create.</td>
        </tr>
        <tr>
            <td>`data` *[optional]*</td>
            <td>`<a href="/docs/languages/python/api/types/#value">Value</a> | None`</td>
            <td>The record data. Defaults to `None`.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`record` *[required]*</td>
            <td>`<a href="/docs/languages/python/api/types/#recordidtype">RecordIdType</a>`</td>
            <td>The table name or `RecordID` to update.</td>
        </tr>
        <tr>
            <td>`data` *[optional]*</td>
            <td>`<a href="/docs/languages/python/api/types/#value">Value</a> | None`</td>
            <td>The new record data. Defaults to `None`.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`record` *[required]*</td>
            <td>`<a href="/docs/languages/python/api/types/#recordidtype">RecordIdType</a>`</td>
            <td>The table name or `RecordID` to upsert.</td>
        </tr>
        <tr>
            <td>`data` *[optional]*</td>
            <td>`<a href="/docs/languages/python/api/types/#value">Value</a> | None`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`record` *[required]*</td>
            <td>`<a href="/docs/languages/python/api/types/#recordidtype">RecordIdType</a>`</td>
            <td>The table name or `RecordID` to merge into.</td>
        </tr>
        <tr>
            <td>`data` *[optional]*</td>
            <td>`<a href="/docs/languages/python/api/types/#value">Value</a> | None`</td>
            <td>The data to merge. Defaults to `None`.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`record` *[required]*</td>
            <td>`<a href="/docs/languages/python/api/types/#recordidtype">RecordIdType</a>`</td>
            <td>The table name or `RecordID` to patch.</td>
        </tr>
        <tr>
            <td>`data` *[optional]*</td>
            <td>`<a href="/docs/languages/python/api/types/#value">Value</a> | None`</td>
            <td>A list of JSON Patch operations. Defaults to `None`.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`record` *[required]*</td>
            <td>`<a href="/docs/languages/python/api/types/#recordidtype">RecordIdType</a>`</td>
            <td>The table name or `RecordID` to delete.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>`data` *[required]*</td>
            <td>`<a href="/docs/languages/python/api/types/#value">Value</a>`</td>
            <td>A single relation dict or a list of relation dicts. Each must include `in` and `out` fields.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>`diff` *[optional]*</td>
            <td>`bool`</td>
            <td>If `True`, notifications include JSON Patch diffs instead of full records. Defaults to `False`.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`query_uuid` *[required]*</td>
            <td>`str | UUID`</td>
            <td>The UUID of the live query returned by <a href="#live">`.live()`</a>.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`UUID | None`</td>
            <td>The session to start the transaction in. If `None`, uses the default session. Defaults to `None`.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`txn_id` *[required]*</td>
            <td>`UUID`</td>
            <td>The transaction ID returned by <a href="#begin">`.begin()`</a>.</td>
        </tr>
        <tr>
            <td>`session_id` *[optional]*</td>
            <td>`UUID | None`</td>
            <td>The session the transaction belongs to. Defaults to `None`.</td>
        </tr>
    </tbody>
</table>
