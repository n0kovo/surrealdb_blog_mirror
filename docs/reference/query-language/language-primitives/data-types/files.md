...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/language-primitives/data-types/files.mdx"
---
...
* A [`DEFINE BUCKET`](../../statements/define/bucket.md) statement to set up the bucket to hold the files
* [Files functions](../../functions/database-functions/file.md) such as `file::put()` and `file::get()`
