...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/build/deployment/surrealdb-cloud/billing-and-support/support.mdx"
---
...
![Surreal Sidekick](../../../../assets/img/image/cloud/add-support-plan.png)
...
![Create support ticket](../../../../assets/img/image/cloud/create-support-ticket.png)
...
![Create support ticket](../../../../assets/img/image/cloud/create-support-ticket-form.png)
...
![Create support ticket](../../../../assets/img/image/cloud/create-support-ticket-page.png)
...
Surreal Sidekick is an AI copilot that can help you get started with SurrealDB, convert queries to SurrealQL, and answer general questions. Surreal Sidekick is only trained with public facing resources, such as our [SurrealDB documentation](https://surrealdb.com/docs/start), [SurrealDB University](/learn), and the [SurrealDB Book](/learn/book).

![Surreal Sidekick](../../../../assets/img/image/cloud/sidekick.png)

### Getting started
To start using Surreal Sidekick, you'll need a [SurrealDB Cloud account](../../../../manage/cloud/index.md). Once logged in, navigate to Surreal Sidekick in the sidebar and start asking questions.
