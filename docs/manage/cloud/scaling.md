...
Move to **Scale** when a single node is no longer enough — because you need **fault tolerance**, sustained query throughput across nodes, or both. Scale runs a minimum of **three nodes**; see [High availability](high-availability.md) for why that matters.
...
See [Cloud architecture](architecture.md) for how Start and Scale differ.
