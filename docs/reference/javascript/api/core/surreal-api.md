...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/core/surreal-api.mdx"
---
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>`string | null`</td>
            <td>The value to set, or `null` to remove the header.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`path` <label label="required" /></td>
            <td>`string`</td>
            <td>The API path to invoke.</td>
        </tr>
        <tr>
            <td>`request` <label label="optional" /></td>
            <td>`<a href="/docs/reference/javascript/api/types/#apirequest">ApiRequest</a>&lt;T&gt;`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`path` <label label="required" /></td>
            <td>`P extends ValidPaths&lt;TPaths, "get"&gt;`</td>
            <td>The API path to invoke.</td>
        </tr>
    </tbody>
</table>
...
#### Returns
[`ApiPromise<void, ResponseBody>`](../queries/api-promise.md) - A promise for the GET response
...
<table>
    ...
    <tbody>
        <tr>
            <td>`path` <label label="required" /></td>
            <td>`P extends ValidPaths&lt;TPaths, "post"&gt;`</td>
            <td>The API path to invoke.</td>
        </tr>
        <tr>
            <td>`body` <label label="optional" /></td>
            <td>`RequestBody&lt;TPaths, P, "post"&gt;`</td>
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](../queries/api-promise.md) - A promise for the POST response
...
<table>
    ...
    <tbody>
        <tr>
            <td>`path` <label label="required" /></td>
            <td>`P extends ValidPaths&lt;TPaths, "put"&gt;`</td>
            <td>The API path to invoke.</td>
        </tr>
        <tr>
            <td>`body` <label label="optional" /></td>
            <td>`RequestBody&lt;TPaths, P, "put"&gt;`</td>
            <td>The request body to send.</td>
        </tr>
    </tbody>
</table>
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](../queries/api-promise.md) - A promise for the PUT response
...
<table>
    ...
    <tbody>
        <tr>
            <td>`path` <label label="required" /></td>
            <td>`P extends ValidPaths&lt;TPaths, "delete"&gt;`</td>
            <td>The API path to invoke.</td>
        </tr>
        <tr>
            <td>`body` <label label="optional" /></td>
            <td>`RequestBody&lt;TPaths, P, "delete"&gt;`</td>
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](../queries/api-promise.md) - A promise for the DELETE response
...
<table>
    ...
    <tbody>
        <tr>
            <td>`path` <label label="required" /></td>
            <td>`P extends ValidPaths&lt;TPaths, "patch"&gt;`</td>
            <td>The API path to invoke.</td>
        </tr>
        <tr>
            <td>`body` <label label="optional" /></td>
            <td>`RequestBody&lt;TPaths, P, "patch"&gt;`</td>
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](../queries/api-promise.md) - A promise for the PATCH response
...
<table>
    ...
    <tbody>
        <tr>
            <td>`path` <label label="required" /></td>
            <td>`P extends ValidPaths&lt;TPaths, "trace"&gt;`</td>
            <td>The API path to invoke.</td>
        </tr>
        <tr>
            <td>`body` <label label="optional" /></td>
            <td>`RequestBody&lt;TPaths, P, "trace"&gt;`</td>
            <td>Optional request body.</td>
        </tr>
    </tbody>
</table>
...
- [User-Defined APIs Guide](../../../query-language/statements/define/api.md) - Defining APIs in SurrealDB
