...
Member-facing **self-service** key management (after a brokered or admin-minted key is held) lives on the [REST API](rest-api.md#self-service-keys-and-me) — not the management API.
