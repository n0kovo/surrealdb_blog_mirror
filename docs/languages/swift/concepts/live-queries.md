...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/swift/concepts/live-queries.mdx"
---

# Live queries

Live queries let you subscribe to changes on a table and receive events in real time. They require the [WebSocket client](connecting.md#websocket-client) and are delivered as an `AsyncStream<LiveEvent<T>>`.
...
See the [`live`](../methods/live.md) and [`kill`](../methods/kill.md) method references for more detail.
