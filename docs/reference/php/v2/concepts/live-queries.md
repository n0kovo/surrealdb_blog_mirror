...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/php/v2/concepts/live-queries.mdx"
---
...
Run a [`LIVE SELECT`](../../../query-language/statements/live-select.md) statement with `run()`. The result is the live query ID.
...
Stop a live query by running a [`KILL`](../../../query-language/statements/kill.md) statement with its ID. The loop receives a final `LiveAction::Killed` message and ends.
...
- [LIVE SELECT](../../../query-language/statements/live-select.md) for the SurrealQL syntax
