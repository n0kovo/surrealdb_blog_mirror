...
**Tool use** — Express business logic and data access in SurrealQL, including [database functions](../../reference/query-language/functions/database-functions/index.md) for reusable server-side behaviour. Where external systems are required, [HTTP functions](../../reference/query-language/functions/database-functions/http.md) let agents trigger APIs and webhooks from the database layer with clear, auditable definitions.
