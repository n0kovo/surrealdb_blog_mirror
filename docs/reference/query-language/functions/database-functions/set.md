...
When called on a set without any extra arguments, the `set::all` function checks whether all set values are [truthy](../../language-primitives/data-types/values.md#values-and-truthiness).
...
The `set::any` function checks whether any set values are [truthy](../../language-primitives/data-types/values.md#values-and-truthiness).
...
When called on a set without any extra arguments, the `set::any` function checks whether any set values are [truthy](../../language-primitives/data-types/values.md#values-and-truthiness).
...
If you want to only count [truthy](../../language-primitives/data-types/values.md#values-and-truthiness) values, then use the [count()](count.md) function.
...
The `set::map` function allows the user to call an [anonymous function](../../language-primitives/data-types/closures.md) (closure) that is performed on every item in the set before passing it on.
