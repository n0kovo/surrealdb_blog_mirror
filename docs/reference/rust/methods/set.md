...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/rust/methods/set.mdx"
---
...
This is equivalent to using a [`LET`](../../query-language/statements/let.md) statement in SurrealQL, such as this one.
