...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/kotlin/api/core/query-builder.mdx"
---

# Query builders {#query-builders}

The CRUD methods on [`SurrealClient`](surreal-client.md) return fluent builders that compile to [SurrealQL](../../../query-language/index.md). Each builder is refined with chainable methods and terminated with [`await()`](#await) (raw [`JsonElement`](../values/value.md)) or the typed [`awaitAs<T>()`](#await-as) extension.
