...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/java/concepts/error-handling.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/languages/java/api/errors#surreal-exception">`SurrealException`</a></td>
			<td scope="row" data-label="Description">Base exception for all SDK errors</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/languages/java/api/errors#server-exception">`ServerException`</a></td>
			<td scope="row" data-label="Description">Base for server-returned errors</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/languages/java/api/errors#not-found-exception">`NotFoundException`</a></td>
			<td scope="row" data-label="Description">Thrown when a resource is not found</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/languages/java/api/errors#not-allowed-exception">`NotAllowedException`</a></td>
			<td scope="row" data-label="Description">Thrown when an operation is not permitted</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/languages/java/api/errors#query-exception">`QueryException`</a></td>
			<td scope="row" data-label="Description">Thrown when a query fails</td>
		</tr>
		<tr>
			<td scope="row" data-label="Error class"><a href="/docs/languages/java/api/errors#already-exists-exception">`AlreadyExistsException`</a></td>
...
All server errors are [`ServerException`](../api/errors/index.md#server-exception) subclasses. Catch specific exceptions first for targeted handling, then fall back to `ServerException` for unexpected server errors.
...
[`NotFoundException`](../api/errors/index.md#not-found-exception) provides `.getTableName()` and `.getRecordId()` to identify the missing resource.
...
[`NotAllowedException`](../api/errors/index.md#not-allowed-exception) provides `.isTokenExpired()` and `.isInvalidAuth()` to distinguish authentication failures.
...
[`QueryException`](../api/errors/index.md#query-exception) provides `.isTimedOut()` and `.isCancelled()` to identify query lifecycle issues.
...
- [Errors API reference](../api/errors/index.md) for complete exception class documentation
- [Connecting to SurrealDB](connecting-to-surrealdb.md) for connection error scenarios
- [Authentication](authentication.md) for authentication error scenarios
- [SurrealQL THROW](../../../reference/query-language/statements/throw.md) for throwing custom errors from queries
