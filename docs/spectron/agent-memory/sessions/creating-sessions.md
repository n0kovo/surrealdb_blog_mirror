...
The ownership restriction applies to **writes** only. Reading state and retrieving context from a session may be permitted to other principals depending on the access control configuration of the context. See [Authentication and principals](../../self-hosting/security/principals.md) for details.
