...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/frameworks/llamaindex.mdx"
---

# LlamaIndex

[LlamaIndex](https://www.llamaindex.ai/) builds RAG and agent applications in Python. SurrealDB Agent Memory gives a LlamaIndex agent long-term memory that persists across sessions. There is no dedicated adapter. The [Python SDK](../sdks/python.md) (`surrealdb`) exposes the memory operations you wrap as `FunctionTool`s.
...
- [JavaScript SDK](../sdks/javascript-and-typescript.md): for LlamaIndex.TS
