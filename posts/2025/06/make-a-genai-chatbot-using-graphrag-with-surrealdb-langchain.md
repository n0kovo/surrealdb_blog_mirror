...
summary: "Build a GenAI chatbot with GraphRAG, SurrealDB, and LangChain for accurate, graph-enhanced LLM responses; code examples provided."
source: "https://surrealdb.com/blog/make-a-genai-chatbot-using-graphrag-with-surrealdb-langchain"
cover: "../../assets/f9506f883a94b616.jpg"
---

# Make a GenAI chatbot using GraphRAG with SurrealDB + LangChain

![Make a GenAI chatbot using GraphRAG with SurrealDB + LangChain](../../assets/f9506f883a94b616.jpg)
...
1. Find relevant documents in the DB by similarity
1. Execute vector search in DB
1. Invoke chain to find related common treatments
1. Chain asks the LLM to generate graph query
1. Chain executes the query
1. Query graph
1. Chain asks the LLM to summarise the results and generate an answer
1. Respond to the user

![Communication diagram for the GraphRAG solution and the flow listed above](../../assets/9b1dab4a6fae2806.jpg)
...
FROM graph_Symptom
WHERE name IN ["Nasal Congestion/Runny Nose", "Dizziness/Vertigo", "Sore Throat"];
```
