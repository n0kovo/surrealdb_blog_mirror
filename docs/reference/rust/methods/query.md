...
As the `.query()` method can be used to pass any SurrealQL query on to the database, it is a convenient choice for complex queries. However, be sure to keep [the following best practices in mind](../../../learn/security/best-practices/security-best-practices.md#query-safety) when doing so.
