...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/python/api/values/geometry.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td>`rings` *[required]*</td>
            <td>`list[GeometryLine]`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`polygons` *[required]*</td>
            <td>`list[GeometryPolygon]`</td>
