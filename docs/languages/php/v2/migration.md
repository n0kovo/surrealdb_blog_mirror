...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/v2/migration.mdx"
---
...
- [v2 overview](index.md) for the new SDK
- [Executing queries](concepts/executing-queries.md) for the builder API
- [Authentication](concepts/authentication.md) for the credential types
