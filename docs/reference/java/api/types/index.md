...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/java/api/types/index.mdx"
---
...
Implements `Credential`. Authenticates as a record user via an access method defined with [`DEFINE ACCESS`](../../../query-language/statements/define/access/index.md).
