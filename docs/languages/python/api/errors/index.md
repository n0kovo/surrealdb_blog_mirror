...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/python/api/errors/index.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td>`kind`</td>
            <td>`str`</td>
            <td>The structured error kind (e.g. `"NotAllowed"`, `"NotFound"`). Match against <a href="#errorkind">`ErrorKind`</a> constants.</td>
        </tr>
        <tr>
            <td>`code`</td>
            <td>`int`</td>
            <td>Legacy JSON-RPC error code. `0` when unavailable.</td>
        </tr>
        <tr>
            <td>`details`</td>
            <td>`dict[str, Any] | None`</td>
            <td>Kind-specific structured details. `None` when not provided.</td>
        </tr>
        <tr>
            <td>`server_cause`</td>
            <td>`ServerError | None`</td>
...
- [Error handling concept](../../concepts/error-handling.md) for patterns and best practices
- [Surreal API reference](../core/surreal.md) for methods that may throw errors
- [Python types](../types/index.md) for the `Value` and `Tokens` types
