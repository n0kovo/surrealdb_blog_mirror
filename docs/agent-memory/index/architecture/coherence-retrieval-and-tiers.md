...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/index/architecture/coherence-retrieval-and-tiers.mdx"
---
...
| **Time** | What held when, and how beliefs evolved: `valid_from` / `valid_until`, `as_of`, and time-travel queries. See [Tri-temporal model](https://surrealdb.com/docs/agent-memory/architecture/tri-temporal-model). |
...
Hands-on retrieval modes are in [Hybrid search](https://surrealdb.com/docs/agent-memory/retrieve/hybrid-search).
