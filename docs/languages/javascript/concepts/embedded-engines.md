...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/concepts/embedded-engines.mdx"
---
...
To enable [versioned storage](../../../reference/query-language/statements/select.md#version) for temporal queries, append `?versioned=true` to the connection string:
