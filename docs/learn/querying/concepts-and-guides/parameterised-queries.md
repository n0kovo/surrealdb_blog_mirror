...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/querying/concepts-and-guides/parameterised-queries.mdx"
---

Parameters are stored values which can then be used in subsequent queries. To define a parameter in SurrealQL, use the [`LET`](../../../reference/query-language/statements/let.md) statement. Parameter names must begin with a `$` (dollar sign) character.
...
For a complete list of reserved parameter names, see [this section](../../../reference/query-language/language-primitives/parameters.md#reserved-variable-names) in the API documentation.
