...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Protect the DB with `DEFINE ACCESS` tokens or basic auth; Agentspace inherits IAM & VPC-SC you already set in Agent Builder (<a href="https://cloud.google.com/agentspace/docs/overview">Google Cloud</a>).</td>
    </tr>
    <tr>
      <td><strong>Hybrid search</strong></td>
      <td>Mix Boolean filters with the `&lt;|K|&gt;` operator (`WHERE source ~ 'wiki' AND embedding &lt;|3|&gt;`).</td>
    </tr>
    <tr>
      <td><strong>Updates</strong></td>
      <td>New docs can be inserted at any time; SurrealDB's HNSW index updates incrementally, or run `REBUILD INDEX` during low-traffic windows (<a href="[SurrealDB][6]">SurrealDB</a>).</td>
    </tr>
  </tbody>
</table>
...
- [REBUILD statement](../../../reference/query-language/statements/rebuild.md)
