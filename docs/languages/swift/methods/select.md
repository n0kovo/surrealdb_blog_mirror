...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/swift/methods/select.mdx"
---
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                A [predicate](../concepts/predicates.md) restricting which records are returned.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Arguments">
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                Select a single record by its [`SurrealRecordID`](../data-types.md#surrealrecordid) instead of a table.
            </td>
        </tr>
    </tbody>
</table>
