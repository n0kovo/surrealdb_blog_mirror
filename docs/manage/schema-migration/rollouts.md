...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/schema-migration/rollouts.mdx"
---
...
- [Template Variables](template-variables.md): parameterise schema files for different environments
- [Testing](testing/index.md): validate schema and permissions before promoting a rollout
