...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/python/concepts/connecting-to-surrealdb.mdx"
---
...
<table>
	...
	<tbody>
		...
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/python/api/core/surreal#connect">`db.connect(url?)`</a></td>
			<td scope="row" data-label="Description">Opens the connection to the SurrealDB instance</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/python/api/core/surreal#close">`db.close()`</a></td>
			<td scope="row" data-label="Description">Closes the active connection and releases resources</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/python/api/core/surreal#use">`db.use(namespace, database)`</a></td>
			<td scope="row" data-label="Description">Switches to a specific namespace and database</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/python/api/core/surreal#version">`db.version()`</a></td>
...
You can configure token and session durations using the `DURATION` clause in the [`DEFINE ACCESS METHOD`](../../query-language/statements/define/access/index.md) or [`DEFINE USER`](../../query-language/statements/define/user.md) statements.
