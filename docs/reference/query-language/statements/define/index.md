...
_Auto-generated index — 18 pages and 1 sub-section._

## Sub-sections

- **[DEFINE ACCESS](access/index.md)** — Defining an access method allows SurrealDB to grant access to resources using different kinds of credentials.

## Pages

- [DEFINE ANALYZER](analyzer.md)
