...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/integrations/frameworks/langchain.mdx"
---
...
The integration is TypeScript. Python applications call Spectron through the [Python SDK](../sdks/python.md) or the [REST API](../surfaces/rest.md) instead.
...
- If the host is Claude, Cursor, or another MCP-native client, prefer the [MCP server](../mcp-server/install.md), with no adapter required.
- If your application calls Spectron directly rather than through LangChain, use the [JavaScript SDK](../sdks/javascript-and-typescript.md).
