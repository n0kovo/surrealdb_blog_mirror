...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/agent-memory/reasoning/temporal-validity.mdx"
---
...
Together these fields power current-state reads, point-in-time reconstruction, and full correction history. The broader picture — system time, known time, and valid time — is in [Tri-temporal model](https://surrealdb.com/docs/spectron/architecture/tri-temporal-model).
