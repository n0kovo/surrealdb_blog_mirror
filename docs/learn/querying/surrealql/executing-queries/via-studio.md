...
If you are using a connection (local or remote), you need to set the [namespace and database](../../../../concepts.md#namespaces-and-databases) for the connection before you can start writing queries.
