...
Manage and execute WASM modules, including [Surrealism](../../../../learn/extensions/plugins/overview.md) plugin modules: scaffold a project, build it, inspect the result, and run its functions from the command line.
