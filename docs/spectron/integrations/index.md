...
The Spectron client for Kotlin is bundled in the [SurrealDB Kotlin SDK](../../languages/kotlin/index.md) (`com.surrealdb:kotlin`) under the `com.surrealdb.kotlin.spectron` package — no separate dependency. It is Kotlin Multiplatform (JVM, Android, iOS) with a `suspend`-based API.
