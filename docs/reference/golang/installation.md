...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/golang/installation.mdx"
---
...
- [Getting started](../../languages/golang.md) to build your first application
