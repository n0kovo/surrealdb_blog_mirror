...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/python/api/values/duration.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`str | int`</td>
            <td>A duration string (e.g. `"1h30m"`, `"500ms"`) or an integer in nanoseconds.</td>
        </tr>
        <tr>
            <td>`nanoseconds` *[optional]*</td>
            <td>`int`</td>
            <td>Additional nanoseconds to add. Defaults to `0`.</td>
        </tr>
    </tbody>
</table>
