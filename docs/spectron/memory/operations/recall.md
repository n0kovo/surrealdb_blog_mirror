...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/memory/operations/recall.mdx"
---
...
See [Coherence, retrieval, and cost tiers](https://surrealdb.com/docs/spectron/architecture/coherence-retrieval-and-tiers). Tiers progress from cheap structured lookup through response cache, hybrid vector + BM25 + graph, to full-context synthesis.
