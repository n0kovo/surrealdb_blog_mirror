...
Invoices and payment information for a Marketplace subscription are in the **AWS Billing and Cost Management** console. They do not appear in SurrealDB Studio, so the [Billing](billing.md) page shows no invoices for an organisation billed through the Marketplace.

Usage figures stay in Studio under **Usage**. Read them to reconcile what the AWS charge covers. See [Usage and spend](billing.md#usage-and-spend).
