...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/dotnet/index.mdx"
---
...
- **[Getting started guide](../../languages/dotnet.md)** — Connect to SurrealDB and run your first queries.
