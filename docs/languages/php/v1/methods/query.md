...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/v1/methods/query.mdx"
---

# `->query()` {#query}

Runs a set of [SurrealQL statements](../../../../reference/query-language/index.md) against the database.
