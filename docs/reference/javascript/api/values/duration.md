...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/values/duration.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`Duration | string | [bigint, bigint]`</td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>`string`</td>
            <td>A float string with a unit suffix (e.g., `"1.5s"`).</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`factor` <label label="required" /></td>
            <td>`number | bigint`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`divisor` <label label="required" /></td>
            <td>`Duration | number | bigint`</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>`mod` <label label="required" /></td>
            <td>`Duration`</td>
...
- [SurrealQL durations](../../../query-language/language-primitives/data-types/durations.md) - Database duration type
