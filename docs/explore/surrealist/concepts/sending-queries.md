...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/explore/surrealist/concepts/sending-queries.mdx"
---
...
- **Live mode**: will display incoming messages received by any [LIVE SELECT](../../../reference/query-language/statements/live-select.md) queries sent in your request. You can also terminate active live queries here as well.
