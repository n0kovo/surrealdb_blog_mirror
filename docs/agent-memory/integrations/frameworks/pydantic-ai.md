...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/agent-memory/integrations/frameworks/pydantic-ai.mdx"
---
...
- To call SurrealDB Agent Memory directly outside Pydantic AI, use the [Python SDK](../sdks/python.md).
