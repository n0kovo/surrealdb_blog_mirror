...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/golang/concepts/authentication.mdx"
---
...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/golang/api/core/db#signin">`db.SignIn(ctx, authData)`</a></td>
			<td scope="row" data-label="Description">Signs in an existing user and returns a JWT token</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/golang/api/core/db#signinwithrefresh">`db.SignInWithRefresh(ctx, authData)`</a></td>
			<td scope="row" data-label="Description">Signs in and returns both an access token and a refresh token</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/golang/api/core/db#signup">`db.SignUp(ctx, authData)`</a></td>
			<td scope="row" data-label="Description">Signs up a new record user and returns a JWT token</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/golang/api/core/db#signupwithrefresh">`db.SignUpWithRefresh(ctx, authData)`</a></td>
			<td scope="row" data-label="Description">Signs up a new record user and returns both tokens</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/golang/api/core/db#authenticate">`db.Authenticate(ctx, token)`</a></td>
			<td scope="row" data-label="Description">Authenticates the connection with a JWT token</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/golang/api/core/db#invalidate">`db.Invalidate(ctx)`</a></td>
			<td scope="row" data-label="Description">Invalidates the current authentication</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/reference/golang/api/core/db#info">`db.Info(ctx)`</a></td>
...
Record-level authentication requires the `Access` field, which specifies which [`DEFINE ACCESS`](../../query-language/statements/define/access/index.md) method to use.
...
- [DEFINE ACCESS statement](../../query-language/statements/define/access/index.md) for configuring access methods
