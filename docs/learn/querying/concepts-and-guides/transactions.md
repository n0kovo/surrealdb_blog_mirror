...
Implicit transactions also roll back on errors, whether that is a [`THROW`](../../../reference/query-language/statements/throw.md) or a statement that simply fails, such as a schema violation. Nothing inside survives:
