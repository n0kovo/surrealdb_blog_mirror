...
In SurrealDB, you can perform a vector search using a [Hierarchical Navigable Small World](https://en.wikipedia.org/wiki/Hierarchical_navigable_small_world) (HNSW) index, a state-of-the-art algorithm for approximate nearest neighbour search in high-dimensional spaces. It is a [proximity graph-based index](../../../reference/query-language/statements/define/indexes.md#hnsw-hierarchical-navigable-small-world) that offers a balance between search efficiency and accuracy.
...
- Verify index utilization in queries using the [`EXPLAIN FULL` clause](../../../reference/query-language/statements/select.md#the-explain-clause). E.g: `SELECT id FROM pts WHERE point <|10|> [2,3,4,5] EXPLAIN FULL;`
