...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/query-language/language-primitives/data-types/durations.mdx"
---
...
The maximum possible duration can be accessed via the const [`duration::max`](../../functions/database-functions/duration.md#durationmax), above which a duration cannot be formed.
