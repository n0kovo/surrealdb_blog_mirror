...
- **Point in time** — entity reads accept **`asOf`**, **`atInstant`**, **`validFrom`**, and **`validUntil`** query parameters. See [Tri-temporal model](https://surrealdb.com/docs/agent-memory/architecture/tri-temporal-model) and the [REST API](../../reference/rest-api.md).
...
See [Forgetting memories](https://surrealdb.com/docs/agent-memory/operations/forget) for request shapes and CLI equivalents.
