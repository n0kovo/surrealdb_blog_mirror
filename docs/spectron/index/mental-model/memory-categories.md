...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/spectron/index/mental-model/memory-categories.mdx"
---

# Memory categories

Spectron splits the **experiential** side of memory into **six** typed areas. Each has its own lifecycle, decay posture, and retrieval weighting. A parallel **[trace layer](https://surrealdb.com/docs/spectron/architecture/traces-and-evolution)** records how memory was *used*.

The eight **pillars** are summarised in [Eight pillars and six categories](https://surrealdb.com/docs/spectron/architecture/eight-pillars-and-categories).
...
- Browsed with [Sessions and turns](https://surrealdb.com/docs/spectron/mental-model/sessions-and-turns) tooling.
