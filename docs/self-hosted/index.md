...
_Auto-generated index — 7 pages and 1 sub-section._

## Sub-sections

- **[Installation](installation/index.md)** — Install the SurrealDB server on your machine: macOS, Windows, Linux, and nightly builds.

## Pages

- [SurrealDB Cloud](cloud.md)
