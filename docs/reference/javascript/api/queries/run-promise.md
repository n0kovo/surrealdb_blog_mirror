...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/javascript/api/queries/run-promise.mdx"
---
...
**Returned by:** [`SurrealQueryable.run()`](../core/surreal-queryable.md#run)
...
- [Functions](../../../query-language/statements/define/function.md) - SurrealQL function definitions
