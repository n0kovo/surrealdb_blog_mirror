...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/javascript/concepts/diagnostics.mdx"
---
...
- [Connecting to SurrealDB](connecting-to-surrealdb.md) for engine configuration
- [Error handling](error-handling.md) for handling SDK errors
