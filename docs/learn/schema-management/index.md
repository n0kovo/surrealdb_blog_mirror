...
Schema covers behaviour as well as data. For example, statements like [`DEFINE EVENT`](../../reference/query-language/statements/define/event.md) set up effects that take place after a statement is executed.
