...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/php/frameworks/laravel/schema-commands.mdx"
---

# Schema commands

The integration adds two Artisan commands for managing your [Surqlize schema](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/schema). Both read the model list from `config('surqlize.models')`.
...
- [Schema](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/schema) for defining tables and fields
- [Configuration](configuration.md#orm-configuration) for the model list
- [Surqlize CLI](https://surrealdb.com/docs/languages/php/ecosystem/surqlize/code-generation-and-cli) for the framework-agnostic commands
