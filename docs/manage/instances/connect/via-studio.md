...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/manage/instances/connect/via-studio.mdx"
---
...
- **[SurrealDB Studio](../../../explore/studio/index.md):** the rest of the interface, including the schema designer, the explorer, and keyboard shortcuts.
- **[SurrealQL](../../../reference/query-language/index.md):** the query language reference.
- **[Connect via SDK](via-sdk.md):** moving from exploration to application code.
