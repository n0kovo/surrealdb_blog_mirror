...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/mojo/concepts/authentication.mdx"
---
...
See the method reference for [`signin`](../methods/signin.md), [`signup`](../methods/signup.md), [`authenticate`](../methods/authenticate.md), and [`invalidate`](../methods/invalidate.md).
