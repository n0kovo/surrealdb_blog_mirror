...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/index/languages/mojo/concepts/connecting-to-surrealdb.mdx"
---
...
<table>
    ...
    <tbody>
        <tr>
            <td colspan="2" scope="row" data-label="Field">`namespace`</td>
            <td colspan="2" scope="row" data-label="Description">The namespace to use. Sent as the `Surreal-NS` header.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Field">`database`</td>
            <td colspan="2" scope="row" data-label="Description">The database to use. Sent as the `Surreal-DB` header.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Field">`access_token`</td>
            <td colspan="2" scope="row" data-label="Description">The credential placed in the `Authorization` header. See <a href="/docs/languages/mojo/concepts/authentication">Authentication</a>.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Field">`tls_insecure`</td>
            <td colspan="2" scope="row" data-label="Description">Disables TLS certificate verification. Dev fixtures only. Defaults to `False`.</td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Field">`format`</td>
            <td colspan="2" scope="row" data-label="Description">`RpcFormat.CBOR` (default) or `RpcFormat.JSON`.</td>
        </tr>
    </tbody>
</table>
...
For the build flags required to connect over `https://` or `wss://`, see [Build with HTTPS](../installation.md#build-with-https).
