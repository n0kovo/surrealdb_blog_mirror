...
Start a Codex session and approve the SurrealDB connection when it prompts you. For an unattended run, create a [personal access token](../build/ai-agents/mcp/index.md#signing-in) and point Codex at it through an environment variable rather than writing the value into the file:
