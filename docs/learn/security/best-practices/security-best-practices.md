...
When defining [users](../../../reference/query-language/statements/define/user.md) and [access methods](../../../reference/query-language/statements/define/access/index.md), ensure that you set a specific [session and token duration](../authentication/users.md#expiration) whenever possible using the `DURATION` clause.
