...
source: "https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/reference/kotlin/installation.mdx"
---
...
- [Getting started](../../languages/kotlin.md) for a complete working example
